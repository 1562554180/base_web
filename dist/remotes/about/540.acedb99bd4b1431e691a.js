/*! For license information please see 540.acedb99bd4b1431e691a.js.LICENSE.txt */
'use strict';
(self.webpackChunkpage_about = self.webpackChunkpage_about || []).push([
  [159, 540],
  {
      ...
      e.exports = (function() {
        ...
        : function(e, o) {
            for (
              ...
              for (var f in (u = Object(arguments[c]))) r.call(u, f) && (i[f] = u[f]);
              if (t) {
                a = t(u);
                for (var l = 0; l < a.length; l++) n.call(u, a[l]) && (i[a[l]] = u[a[l]]);
              }
            }
            return i;
          };
    ...
    287: (e, t, r) => {
      ...
      (m.constructor = b), n(m, v.prototype), (m.isPureReactComponent = !0);
      var g = { current: null },
      ...
      function k(e, t, r) {
        var n,
          ...
          i = null;
        if (null != t)
          for (n in (void 0 !== t.ref && (i = t.ref), void 0 !== t.key && (a = '' + t.key), t))
        ...
        return { $$typeof: o, type: e, key: a, ref: i, props: u, _owner: g.current };
      }
      function O(e) {
      ...
      function $(e, t, r, n, a) {
        ...
        if (((c = 0), (n = '' === n ? '.' : n + ':'), Array.isArray(e)))
          ...
          for (e = l.call(e), f = 0; !(i = e.next()).done; )
            c += $((i = i.value), t, r, (l = n + C(i, f++)), a);
        else if ('object' === i)
          throw ((t = '' + e),
          Error(
            y(
      ...
      (t.Children = {
        ...
        (t.cloneElement = function(e, t, r) {
          ...
          if (null != t) {
            if (
              (void 0 !== t.ref && ((i = t.ref), (c = g.current)),
          ...
          return { $$typeof: o, type: e.type, key: a, ref: i, props: u, _owner: c };
        }),
