  ...
  return (
    (n = {
        ...
        var r = (() => {
          function l(t, e) {
            ...
            var c = this,
              ...
              i = ((e.className = 'jsoneditor-contextmenu-root'),
              (n.root = e),
              document.createElement('div')),
              e = ((i.className = 'jsoneditor-contextmenu'),
              (n.menu = i),
              e.appendChild(i),
              document.createElement('ul')),
              i = ((e.className = 'jsoneditor-menu'),
              i.appendChild(e),
              (n.list = e),
              (n.items = []),
              document.createElement('button')),
              n = ((i.type = 'button'), (n.focusButton = i), document.createElement('li'));
            (n.style.overflow = 'hidden'),
              ...
              (function a(l, d, e) {
                e.forEach(function(t) {
                  var n, e, i, o, r, s;
                  'separator' === t.type
                    ? (((r = document.createElement('div')).className = 'jsoneditor-separator'),
                      (e = document.createElement('li')).appendChild(r),
                      l.appendChild(e))
                    : ((n = {}),
                      ...
                      t.click &&
                        (e.onclick = function(e) {
                          e.preventDefault(), c.hide(), t.click();
                        }),
                      r.appendChild(e),
                      t.submenu
                        ? (((o = document.createElement('div')).className = 'jsoneditor-icon'),
                          e.appendChild(o),
                          ((o = document.createElement('div')).className =
                            'jsoneditor-text' + (t.click ? '' : ' jsoneditor-right-margin')),
                          o.appendChild(document.createTextNode(t.text)),
                          e.appendChild(o),
                          ((i = t.click
                            ? ((e.className += ' jsoneditor-default'),
                              ((o = document.createElement('button')).type = 'button'),
                              ((n.buttonExpand = o).className = 'jsoneditor-expand'),
                              ((s = document.createElement('div')).className = 'jsoneditor-expand'),
                              o.appendChild(s),
                              r.appendChild(o),
                              t.submenuTitle && (o.title = t.submenuTitle),
                              o)
                            : (((s = document.createElement('div')).className =
                                'jsoneditor-expand'),
                              e.appendChild(s),
                              e)).onclick = function(e) {
                            e.preventDefault(), c._onExpandItem(n), i.focus();
                          }),
                          (n.subItems = o = []),
                          ...
                          r.appendChild(s),
                          a(s, o, t.submenu))
                        : (((r = document.createElement('div')).className = 'jsoneditor-icon'),
                          e.appendChild(r),
                          ((s = document.createElement('div')).className = 'jsoneditor-text'),
                          s.appendChild(document.createTextNode((0, h.Tl)(t.text))),
                          e.appendChild(s)),
                      d.push(n));
                });
              })(e, this.dom.items, t),
              ...
              t.forEach(function(e) {
                ...
                c.maxHeight = Math.max(c.maxHeight, e);
              });
          }
          return (
            (e = l),
              ...
              },
              {
                ...
                value: function(e, t, n) {
                  ...
                  var i = !0,
                    ...
                    a = this,
                    t = ((this.dom.absoluteAnchor = (0, d.p)(e, t, function() {
                      a.hide();
                    })),
                    r.bottom + this.maxHeight < s.bottom ||
                      (r.top - this.maxHeight > s.top && (i = !1)),
                    n ? 0 : r.top - o.top);
                  i
                    ? ((n = e.offsetHeight),
                      (this.dom.menu.style.left = '0'),
                      (this.dom.menu.style.top = t + n + 'px'),
                      (this.dom.menu.style.bottom = ''))
                    : ((this.dom.menu.style.left = '0'),
                      (this.dom.menu.style.top = ''),
                      (this.dom.menu.style.bottom = '0px')),
                    this.limitHeight &&
                      ((o = i ? s.bottom - r.bottom - 10 : r.top - s.top - 10),
              ...
              },
              {
                ...
                value: function() {
                  this.dom.absoluteAnchor &&
                    (this.dom.absoluteAnchor.destroy(), delete this.dom.absoluteAnchor),
                    this.dom.root.parentNode &&
                      (this.dom.root.parentNode.removeChild(this.dom.root), this.onClose) &&
                      this.onClose(),
              ...
              },
              {
                ...
                value: function(e) {
                  ...
                  27 === s
                    ...
                    : 9 === s
                      ? e.shiftKey
                        ? 0 === (n = (t = this._getVisibleButtons()).indexOf(r)) &&
                          (t[t.length - 1].focus(), (a = !0))
                        : (n = (t = this._getVisibleButtons()).indexOf(r)) === t.length - 1 &&
                          (t[0].focus(), (a = !0))
                      : 37 === s
                        ? ('jsoneditor-expand' === r.className &&
                            ((n = (t = this._getVisibleButtons()).indexOf(r)), (i = t[n - 1])) &&
                            i.focus(),
                          (a = !0))
                        : 38 === s
                          ...
                          : 39 === s
                            ? ((n = (t = this._getVisibleButtons()).indexOf(r)),
                              (o = t[n + 1]) && 'jsoneditor-expand' === o.className && o.focus(),
                              (a = !0))
                            : 40 === s &&
                              ((n = (t = this._getVisibleButtons()).indexOf(r)),
                              (o =
        ...
        var i = (() => {
          function n(e) {
            ...
            var e = document.createElement('div'),
              t = ((e.className = 'jsoneditor-validation-errors-container'),
              (this.dom.validationErrorsContainer = e),
              document.createElement('div')),
              e = ((t.style.display = 'none'),
              (t.className = 'jsoneditor-additional-errors fadein'),
              (t.textContent = 'Scroll for more ▿'),
              (this.dom.additionalErrorsIndication = t),
              e.appendChild(t),
              document.createElement('span')),
              t = ((e.className = 'jsoneditor-validation-error-icon'),
              (e.style.display = 'none'),
              (this.dom.validationErrorIcon = e),
              document.createElement('span'));
            (t.className = 'jsoneditor-validation-error-count'),
              (t.style.display = 'none'),
              (this.dom.validationErrorCount = t),
                      ...
                      ? (((n = document.createElement('div')).className =
                        ...
                        e.forEach(function(t) {
                          ...
                          var e,
                            ...
                            i = ((n.className = isNaN(e) ? '' : 'jump-to-line'),
                            'error' === t.type
                              ? (n.className += ' parse-error')
                              : (n.className += ' validation-error'),
                            document.createElement('td')),
                            o = document.createElement('button'),
                            o = ((o.className = 'jsoneditor-schema-error'),
                            i.appendChild(o),
                            n.appendChild(i),
                            document.createElement('td'));
                          (o.style = 'white-space: nowrap;'),
                            (o.textContent = isNaN(e) ? '' : 'Ln ' + e),
                            n.appendChild(o),
                            'string' == typeof t
                              ? (((i = document.createElement('td')).colSpan = 2),
                                (o = document.createElement('pre')).appendChild(
                                  document.createTextNode(t)
                                ),
                                i.appendChild(o),
                                n.appendChild(i))
                              : ((o = document.createElement('td')).appendChild(
                                  document.createTextNode(t.dataPath || '')
                                ),
                                n.appendChild(o),
                                (i = document.createElement('td')),
                                (o = document.createElement('pre')).appendChild(
                                  document.createTextNode(t.message.replace(/<br>/gi, '\n'))
                                ),
                                i.appendChild(o),
                                n.appendChild(i)),
                            (n.onclick = function() {
                        ...
                        (this.dom.additionalErrorsIndication.title = e.length + ' errors total'),
                        ...
                        this.dom.validationErrorsContainer.scrollHeight
                          ? ((this.dom.additionalErrorsIndication.style.display = 'block'),
                            (this.dom.validationErrorsContainer.onscroll = function() {
                              a.dom.additionalErrorsIndication.style.display =
                                0 < a.dom.validationErrorsContainer.clientHeight &&
                                0 === a.dom.validationErrorsContainer.scrollTop
                                  ? 'block'
                                  : 'none';
                            }))
                  ...
                  0 < n
                    ...
                    e.some(function(e) {
                      ...
                      ? ((t = e[0].line),
                        ...
                        (this.dom.parseErrorIndication.title = isNaN(t)
                          ? 'parse error - check that the json is valid'
                          : 'parse error on line ' + t),
              ...
              },
              {
                ...
                value: function(e) {
                  (e = e.target),
                    (e =
                      e === this.target ||
                      !(!this.target.contains(e) && !this.target.contains(document.activeElement)));
                  e
                    ? this.focusFlag ||
                      (this.onFocus && this.onFocus({ type: 'focus', target: this.target }),
                      (this.focusFlag = !0))
                    : (this.focusFlag || this.firstEventFlag) &&
                      (this.onBlur && this.onBlur({ type: 'blur', target: this.target }),
                      (this.focusFlag = !1),
                      this.firstEventFlag) &&
                      (this.firstEventFlag = !1);
                },
              },
            ]) && r(e.prototype, n),
            i && r(e, i),
      ...
      346: function(e, t, o) {
        var n = o(413),
          i = o(746),
          r = o(633).treeModeMixins,
          s = o(948).textModeMixins,
          a = o(483).previewModeMixins,
          l = o(237),
          d = l.clear,
          c = l.extend,
          h = l.getInnerText,
          ...
          p = l.parse,
          l = o(870).tryRequireAjv,
          m = o(609).showTransformModal,
          f = o(915).showSortModal,
          g = l();
        function v(e, t, n) {
          ...
          t &&
            ...
            t.onChangeJSON &&
              ('text' === t.mode ||
                'code' === t.mode ||
                (t.modes && (-1 !== t.modes.indexOf('text') || -1 !== t.modes.indexOf('code')))) &&
              console.warn(
            ...
            Object.keys(t).forEach(function(e) {
              -1 === v.VALID_OPTIONS.indexOf(e) &&
                console.warn('Unknown option "' + e + '". This option will be ignored');
            }),
        ...
        'undefined' == typeof Promise &&
          ...
          (v.prototype._create = function(e, t, n) {
            ...
            e = this.options.mode || (this.options.modes && this.options.modes[0]) || 'tree';
            this.setMode(e);
          }),
          ...
          (v.prototype._onError = function(e) {
            this.options && 'function' == typeof this.options.onError
          ...
          (v.prototype.setSchema = function(e, t) {
            if (e) {
              ...
              (this.validateSchema = null),
                ...
                this.validate();
            this.refresh(), 'function' == typeof this._onSchemaChange && this._onSchemaChange(e, t);
          }),
          (v.prototype.validate = function() {}),
          (v.prototype.refresh = function() {}),
          (v.registerMode = function(e) {
            var t;
            if (Array.isArray(e)) for (o = 0; o < e.length; o++) v.registerMode(e[o]);
            else {
        ...
        var r = (() => {
          function h(e, t, n, i) {
            ...
            for (
              var o = {
                  code: {
                    text: (0, p.Tl)('modeCodeText'),
                    title: (0, p.Tl)('modeCodeTitle'),
                    click: function() {
                      i('code');
                    },
                  },
                  form: {
                    text: (0, p.Tl)('modeFormText'),
                    title: (0, p.Tl)('modeFormTitle'),
                    click: function() {
                      i('form');
                    },
                  },
                  text: {
                    text: (0, p.Tl)('modeTextText'),
                    title: (0, p.Tl)('modeTextTitle'),
                    click: function() {
                      i('text');
                    },
                  },
                  tree: {
                    text: (0, p.Tl)('modeTreeText'),
                    title: (0, p.Tl)('modeTreeTitle'),
                    click: function() {
                      i('tree');
                    },
                  },
                  view: {
                    text: (0, p.Tl)('modeViewText'),
                    title: (0, p.Tl)('modeViewTitle'),
                    click: function() {
                      i('view');
                    },
                  },
                  preview: {
                    text: (0, p.Tl)('modePreviewText'),
                    title: (0, p.Tl)('modePreviewTitle'),
                    click: function() {
                      i('preview');
                    },
                  },
              ...
              (l.className = 'jsoneditor-type-modes' + (n === a ? ' jsoneditor-selected' : '')),
                r.push(l);
            }
            var d = o[n];
            ...
            var d = d.text,
              ...
              (c.textContent = d + ' ▾'),
              (c.title = (0, p.Tl)('modeEditorTitle')),
              (c.onclick = function() {
                new u.t(r).show(c, e);
              }),
              document.createElement('div'));
      ...
      736: function(e, t) {
        (n = {
          ...
          parse: function(e) {
            ...
            for (var u, p, m, f, g, v, y, b, x, C = {}; ; ) {
              if (
                ((m = n[n.length - 1]),
                void 0 ===
                  (f = this.defaultActions[m] || (null == u && (u = h()), r[m] && r[m][u])) ||
                  !f.length ||
                  !f[0])
              ) {
                if (!d) {
                  for (g in ((b = []), r[m]))
                    this.terminals_[g] && 2 < g && b.push("'" + this.terminals_[g] + "'");
                  var T = '',
                ...
                (p = u), (u = 2), (f = r[(m = n[n.length - 1])] && r[m][2]), (d = 3);
              }
              if (f[0] instanceof Array && 1 < f.length)
                throw new Error(
                  'Parse Error: multiple actions possible at state: ' + m + ', token: ' + u
                );
              switch (f[0]) {
                case 1:
                  n.push(u),
                ...
                case 2:
                  if (
                    ...
                    void 0 !== (y = this.performAction.call(C, s, l, a, this.yy, f[1], i, o)))
                  )
                    return y;
                  v &&
                    ((n = n.slice(0, -1 * v * 2)),
          ...
          next: function() {
            ...
            for (
              var e, t, n, i, o = this._currentRules(), r = 0;
              r < o.length &&
      ...
      772: function(e) {
        ...
        var u = {
          ...
          extend: function(e, t) {
            for (var n in t) {
              var i;
              t.hasOwnProperty(n) &&
                ((i = t[n]) && '[object Object]' === Object.prototype.toString.call(i)
                  ? ((e[n] = e[n] || {}), u.extend(e[n], i))
                  : (e[n] = i));
            }
            return e;
          },
          each: function(e, t, n) {
            ...
            else for (var o = 0, r = e.length; o < r; o++) t.call(n, o, e[o], e);
          },
          ...
          addClass: function(e, t) {
            u.hasClass(e, t) ||
              (e.classList ? e.classList.add(t) : (e.className = e.className.trim() + ' ' + t));
          },
        ...
        function o() {
          ...
          this.items.length &&
            ...
            n.childElementCount &&
              (u.removeClass(this.items[this.navIndex], 'active'),
              (this.navIndex = (
                n.querySelector('.selectr-option.selected') || n.querySelector('.selectr-option')
              ).idx),
              u.addClass(this.items[this.navIndex], 'active')),
            this.tree.appendChild(n));
        }
        function h(e, t) {
          t = t || e;
          var n = { class: 'selectr-option', role: 'treeitem', 'aria-selected': !1 };
          return (
            this.customOption
              ? (n.html = this.config.renderOption(t))
              : (n.textContent = e.textContent),
            ((t = u.createElement('li', n)).idx = e.idx),
            this.items.push(t),
            e.defaultSelected && this.defaultSelected.push(e.idx),
            e.disabled && ((t.disabled = !0), u.addClass(t, 'disabled')),
            t
          );
        }
        function r() {
        ...
        function s() {
          (this.config.searchable || this.config.taggable) &&
            ...
            (this.searching = !1),
            this.config.searchable && u.removeClass(this.inputContainer, 'active'),
            u.hasClass(this.container, 'notice') &&
              (u.removeClass(this.container, 'notice'),
              u.addClass(this.container, 'open'),
              this.input.focus()),
            u.each(
              this.items,
              function(e, t) {
        ...
        function t(e, t) {
          ...
          if (
            ('string' == typeof (this.el = e) && (this.el = document.querySelector(e)),
            null === this.el)
          )
        ...
        (t.prototype.render = function(e) {
          var t;
          this.rendered ||
            (((this.el.selectr = this).config = u.extend(
              {
                defaultSelected: !0,
                width: 'auto',
                disabled: !1,
            ...
            (this.disabled = c(this.config, 'disabled')),
            (this.opened = !1),
            ...
            function() {
              (this.requiresPagination = this.config.pagination && 0 < this.config.pagination),
                c(this.config, 'width') &&
                  (u.isInt(this.config.width)
                    ? (this.width = this.config.width + 'px')
                    : 'auto' === this.config.width
                      ? (this.width = '100%')
                      : u.includes(this.config.width, '%') && (this.width = this.config.width)),
                (this.container = u.createElement('div', { class: 'selectr-container' })),
                this.config.customClass && u.addClass(this.container, this.config.customClass),
                this.mobileDevice
                  ? u.addClass(this.container, 'selectr-mobile')
                  : u.addClass(this.container, 'selectr-desktop'),
                (this.el.tabIndex = -1),
                this.config.nativeDropdown || this.mobileDevice
                  ? u.addClass(this.el, 'selectr-visible')
                  : u.addClass(this.el, 'selectr-hidden'),
                (this.selected = u.createElement('div', {
                  class: 'selectr-selected',
                  disabled: this.disabled,
                  tabIndex: 0,
                  'aria-expanded': !1,
                })),
                (this.label = u.createElement(this.el.multiple ? 'ul' : 'span', {
                  class: 'selectr-label',
                }));
              var e = u.createElement('div', { class: 'selectr-options-container' });
              if (
                ((this.tree = u.createElement('ul', {
                  class: 'selectr-options',
                  role: 'tree',
                  'aria-hidden': !0,
                  'aria-expanded': !1,
                })),
                (this.notice = u.createElement('div', { class: 'selectr-notice' })),
                this.el.setAttribute('aria-hidden', !0),
                this.disabled && (this.el.disabled = !0),
                this.el.multiple
                  ? (u.addClass(this.label, 'selectr-tags'),
                    u.addClass(this.container, 'multiple'),
                    (this.tags = []),
                ...
                this.config.clearable &&
                  ((this.selectClear = u.createElement('button', {
                    class: 'selectr-clear',
                    type: 'button',
                  })),
                  this.container.appendChild(this.selectClear),
                  u.addClass(this.container, 'clearable')),
                this.config.taggable)
              ) {
                var t = u.createElement('li', { class: 'input-tag' });
                if (
                  ((this.input = u.createElement('input', {
                  ...
                  u.addClass(this.container, 'taggable'),
                  (this.tagSeperators = [',']),
                  this.config.tagSeperators)
                ) {
                  this.tagSeperators = this.tagSeperators.concat(this.config.tagSeperators);
                  for (var n = [], i = 0; i < this.tagSeperators.length; i++)
                    n.push(u.escapeRegExp(this.tagSeperators[i]));
                  this.tagSeperatorsRegex = new RegExp(n.join('|'), 'i');
              ...
              this.config.searchable &&
                ...
                (this.inputClear = u.createElement('button', {
                  class: 'selectr-input-clear',
                  type: 'button',
                })),
                (this.inputContainer = u.createElement('div', {
                  class: 'selectr-input-container',
                })),
                this.inputContainer.appendChild(this.input),
                this.inputContainer.appendChild(this.inputClear),
                e.appendChild(this.inputContainer)),
                e.appendChild(this.notice),
                e.appendChild(this.tree),
                (this.items = []),
                (this.options = []),
                    ...
                    'OPTGROUP' === t.nodeName
                      ? ((a = u.createElement('ul', {
                        ...
                        u.each(
                          t.children,
                          function(e, t) {
                            (t.idx = l), a.appendChild(h.call(this, t, a)), l++;
                          },
                          this
                        ))
                      : ((t.idx = l), h.call(this, t), l++);
                  },
                  this
                ),
                this.config.data &&
                  ...
                  u.each(
                    ...
                    function(e, t) {
                      c(t, 'children')
                        ? ((o = u.createElement('optgroup', { label: t.text })),
                          (a = u.createElement('ul', {
                            class: 'selectr-optgroup',
                            role: 'group',
              ...
              for (var d = (this.navIndex = 0); d < this.items.length; d++)
                if (((s = this.items[d]), !u.hasClass(s, 'disabled'))) {
                  u.addClass(s, 'active'), (this.navIndex = d);
                  break;
                }
              this.requiresPagination && ((this.pageIndex = 1), this.paginate()),
                this.container.appendChild(this.selected),
                this.container.appendChild(e),
                (this.placeEl = u.createElement('div', { class: 'selectr-placeholder' })),
                this.setPlaceholder(),
            ...
            this.bindEvents(),
            this.update(),
            (this.optsRect = u.rect(this.tree)),
            (this.rendered = !0),
            ...
            (this.events = {}),
              (this.events.dismiss = function(e) {
                ...
                this.container.contains(e) ||
                  (!this.opened && !u.hasClass(this.container, 'notice')) ||
                  this.close();
              }.bind(this)),
              (this.events.navigate = function(e) {
                if (
                  ((e = e || window.event),
                  this.items.length && this.opened && u.includes([13, 38, 40], e.which))
                ) {
                  if ((e.preventDefault(), 13 === e.which))
                    return (
                      !(this.noResults || (this.config.taggable && 0 < this.input.value.length)) &&
                  ...
                  for (
                    this.navigating = !0;
                    u.hasClass(this.items[this.navIndex], 'disabled') ||
                    u.hasClass(this.items[this.navIndex], 'excluded');
                  ...
                  e = u.rect(this.items[this.navIndex]);
                  t
                    ? (0 === this.navIndex
                        ? (this.tree.scrollTop = 0)
                        : e.top + e.height > this.optsRect.top + this.optsRect.height &&
                          (this.tree.scrollTop =
                            this.tree.scrollTop +
                            (e.top + e.height - (this.optsRect.top + this.optsRect.height))),
                    ...
                    : 0 === this.navIndex
                      ...
                      : e.top - this.optsRect.top < 0 &&
                        (this.tree.scrollTop = this.tree.scrollTop + (e.top - this.optsRect.top)),
                    n && u.removeClass(n, 'active'),
                    u.addClass(this.items[this.navIndex], 'active');
              ...
              (this.config.nativeDropdown || this.mobileDevice) &&
                (this.container.addEventListener(
                  ...
                  !!this.supportsEventPassiveOption && { passive: !0 }
                ),
                ...
                this.el.addEventListener('change', function(e) {
                  e.__selfTriggered ||
                    (i.el.multiple
                      ? ((e = i.getSelectedProperties('idx')),
                        (e = ((e, t) => {
                          for (var n, i = [], o = e.slice(0), r = 0; r < t.length; r++)
                            -1 < (n = o.indexOf(t[r])) ? o.splice(n, 1) : i.push(t[r]);
                          return [i, o];
                        })(i.selectedIndexes, e)),
                        u.each(
                          e[0],
              ...
              this.selected.addEventListener('click', function(e) {
                i.disabled || i.toggle(), e.preventDefault();
              }),
              this.config.nativeKeyboard &&
                ...
                this.selected.addEventListener('keydown', function(e) {
                  ...
                  i.disabled ||
                    ...
                    e.metaKey ||
                    (' ' === e.key ||
                    (!i.opened && -1 < ['Enter', 'ArrowUp', 'ArrowDown'].indexOf(e.key))
                      ? (i.toggle(), e.preventDefault(), e.stopPropagation())
                      : e.key.length <= 2 &&
                        ...
                        (i.config.multiple
                          ? (i.open(),
                            i.config.searchable &&
                              ((i.input.value = e.key), i.input.focus(), i.search(null, !0)))
                          : ((n += e.key),
                            (t = i.search(n, !0)) &&
                              t.length &&
                              (i.clear(), i.setValue(t[0].value)),
                            setTimeout(function() {
                              n = '';
                            }, 1e3)),
                        e.preventDefault(),
                ...
                this.container.addEventListener('keyup', function(e) {
                  i.opened &&
                    'Escape' === e.key &&
                    (i.close(), e.stopPropagation(), i.selected.focus());
                })),
              this.label.addEventListener('click', function(e) {
                u.hasClass(e.target, 'selectr-tag-remove') && i.deselect(e.target.parentNode.idx);
              }),
              ...
              this.tree.addEventListener('click', function(e) {
                var t = u.closest(e.target, function(e) {
                  return e && u.hasClass(e, 'selectr-option');
                });
                t &&
                  !u.hasClass(t, 'disabled') &&
                  (u.hasClass(t, 'selected')
                    ? (i.el.multiple || (!i.el.multiple && i.config.allowDeselect)) &&
                      i.deselect(t.idx)
                    : i.select(t.idx),
                  i.opened && !i.el.multiple) &&
                  i.close(),
                  e.preventDefault(),
                  e.stopPropagation();
              }),
              this.tree.addEventListener('mouseover', function(e) {
                !u.hasClass(e.target, 'selectr-option') ||
                  u.hasClass(e.target, 'disabled') ||
                  (u.removeClass(i.items[i.navIndex], 'active'),
              ...
              this.config.searchable &&
                ...
                this.input.addEventListener('keyup', function(e) {
                  i.search(),
                    i.config.taggable ||
                      (this.value.length
                        ? u.addClass(this.parentNode, 'active')
                        : u.removeClass(this.parentNode, 'active'));
                }),
                this.inputClear.addEventListener('click', function(e) {
                  (i.input.value = null), s.call(i), i.tree.childElementCount || o.call(i);
                })),
              this.config.taggable &&
                this.input.addEventListener('keyup', function(e) {
                  var t, n;
                  i.search(),
                    i.config.taggable &&
                      this.value.length &&
                      (t = this.value.trim()).length &&
                      (13 === e.which || i.tagSeperatorsRegex.test(t)) &&
                      ((e = t.replace(i.tagSeperatorsRegex, '')),
                      (n = (e = (e = u.escapeRegExp(e)).trim()).length
                        ? i.add({ value: e, textContent: e, selected: !0 }, !0)
                        : n)
                        ? (i.close(), s.call(i))
                        : ((this.value = ''), i.setMessage(i.config.messages.tagDuplicate)));
                }),
              ...
              this.requiresPagination &&
                ((this.paginateItems = u.debounce(function() {
                  r.call(this);
                }, 50)),
                  ...
                  function(e, t) {
                    c(t, 'children')
                      ? u.each(
                          t.children,
                          function(e, t) {
                            t.hasOwnProperty('selected') && !0 === t.selected && this.select(n),
                              n++;
                          },
                          this
                        )
          ...
          (t.prototype.destroy = function() {
            this.rendered &&
              ...
              u.removeClass(this.el, 'selectr-hidden'),
          ...
          (t.prototype.change = function(e) {
            var t = this.items[e],
              n = this.options[e];
            n.disabled ||
              (n.selected && u.hasClass(t, 'selected') ? this.deselect(e) : this.select(e),
          ...
          (t.prototype.select = function(i) {
            var e = this.items[i],
              ...
              n = this.options[i];
            if (this.el.multiple) {
              if (u.includes(this.selectedIndexes, i)) return !1;
              ...
              this.selectedValues.push(n.value),
                ...
                !function(e) {
                  var l,
                    ...
                    o = { class: 'selectr-tag' },
                    i = (this.customSelected
                      ? (o.html = this.config.renderSelection(i))
                      : (o.textContent = t.textContent),
                    u.createElement('li', o)),
                    o = u.createElement('button', { class: 'selectr-tag-remove', type: 'button' });
                  i.appendChild(o),
                    (i.idx = e.idx),
                    (i.tag = t.value),
                    this.tags.push(i),
                      ...
                      ? ((o = this.tags.slice()),
                        ...
                        o.sort(function(e, t) {
                          ...
                          for (
                            ...
                            var s = o.shift(),
                              a = r.shift(),
                              s = s[0] - a[0] || s[1].localeCompare(a[1]);
                            if (s) return s;
                          }
              ...
              this.customSelected
                ? (this.label.innerHTML = this.config.renderSelection(o))
                : (this.label.textContent = n.textContent),
            ...
            u.includes(t, n) || this.el.add(n),
              e.setAttribute('aria-selected', !0),
              u.addClass(e, 'selected'),
              u.addClass(this.container, 'has-selected'),
              (n.selected = !0),
              n.setAttribute('selected', ''),
              this.emit('selectr.change', n),
              this.emit('selectr.select', n),
              'createEvent' in document
                ? ((o = document.createEvent('HTMLEvents')).initEvent('change', !0, !0),
                  (o.__selfTriggered = !0),
          ...
          (t.prototype.deselect = function(e, t) {
            ...
            if (this.el.multiple) {
              var o = this.selectedIndexes.indexOf(e),
                o = (this.selectedIndexes.splice(o, 1), this.selectedValues.indexOf(i.value));
              this.selectedValues.splice(o, 1),
                !function(n) {
                  ...
                  u.each(
                    ...
                    i && (this.label.removeChild(i), this.tags.splice(this.tags.indexOf(i), 1));
                }.call(this, n),
                this.tags.length || u.removeClass(this.container, 'has-selected');
            } else {
              if (!t && !this.config.clearable && !this.config.allowDeselect) return !1;
              (this.label.innerHTML = ''),
                (this.selectedValue = null),
                (this.el.selectedIndex = this.selectedIndex = -1),
                u.removeClass(this.container, 'has-selected');
            }
            this.items[e].setAttribute('aria-selected', !1),
              u.removeClass(this.items[e], 'selected'),
              (i.selected = !1),
          ...
          (t.prototype.setValue = function(n) {
            ...
            u.each(
              this.options,
              function(e, t) {
                ((i && -1 < n.indexOf(t.value)) || t.value === n) && this.change(t.idx);
              },
              this
            );
          }),
          (t.prototype.getValue = function(e, t) {
            ...
            return (
              this.el.multiple
                ...
                : (i = e
                    ? { value: (n = this.options[this.selectedIndex]).value, text: n.textContent }
                    : this.selectedValue),
              (i = e && t ? JSON.stringify(i) : i)
            );
          }),
          (t.prototype.add = function(n, i) {
            if (n) {
              if (
                ((this.data = this.data || []),
                ...
                var e = u.createElement('option', n);
                return (
                  this.data.push(n),
                  this.mobileDevice && this.el.add(e),
                  this.options.push(e),
                  (e.idx = 0 < this.options.length ? this.options.length - 1 : 0),
                  h.call(this, e),
          ...
          (t.prototype.remove = function(e) {
            ...
            Array.isArray(e)
              ? u.each(
                  ...
                  function(e, t) {
                    u.isInt(t)
                      ? i.push(this.getOptionByIndex(t))
                      : 'string' == typeof t && i.push(this.getOptionByValue(t));
                  },
                  this
                )
              : u.isInt(e)
                ? i.push(this.getOptionByIndex(e))
                : 'string' == typeof e && i.push(this.getOptionByValue(e)),
              i.length &&
                (u.each(
                  i,
                  function(e, t) {
          ...
          (t.prototype.search = function(a, e) {
            ...
            if (!this.navigating)
              return (
                (l = !1),
                a ||
                  ((a = this.input.value), (l = !0), this.removeMessage(), u.truncate(this.tree)),
                (d = []),
                (c = document.createDocumentFragment()),
                0 < (a = a.trim().toLowerCase()).length
                  ? ((h = e ? u.startsWith : u.includes),
                    u.each(
                      this.options,
                      function(e, t) {
                        var n,
                          ...
                          r,
                          s = this.items[t.idx];
                        h(t.textContent.trim().toLowerCase(), a) && !t.disabled
                          ? (d.push({ text: t.textContent, value: t.value }),
                            l &&
                              (p(s, c, this.customOption),
                              u.removeClass(s, 'excluded'),
                              !this.customOption) &&
                              ((n = a),
                              (o = (t = t).textContent),
                              (n = new RegExp(n, 'ig')),
                              (r = n.exec(o))) &&
                              ((t.innerHTML = ''),
                              (i = document.createElement('span')).classList.add('selectr-match'),
                              (i.textContent = r[0]),
                              t.appendChild(document.createTextNode(o.substring(0, r.index))),
                              t.appendChild(i),
                              t.appendChild(document.createTextNode(o.substring(n.lastIndex)))))
                          : l && u.addClass(s, 'excluded');
                      },
                      this
                    ),
                    l &&
                      (c.childElementCount
                        ? ((e = this.items[this.navIndex]),
                          (t = c.querySelector('.selectr-option:not(.excluded)')),
                          (this.noResults = !1),
                          u.removeClass(e, 'active'),
                          (this.navIndex = t.idx),
                          u.addClass(t, 'active'))
                        : this.config.taggable ||
                          ((this.noResults = !0), this.setMessage(this.config.messages.noResults)),
                      this.tree.appendChild(c)))
                  : o.call(this),
                d
              );
          }),
          ...
          (t.prototype.open = function() {
            ...
            this.opened || this.emit('selectr.open'),
              ...
              this.mobileDevice || this.config.nativeDropdown
                ? (u.addClass(this.container, 'native-open'),
                  this.config.data &&
                    u.each(
                      this.options,
                      function(e, t) {
          ...
          (t.prototype.close = function() {
            ...
            this.opened && this.emit('selectr.close'),
              ...
              (this.navigating = !1),
              this.mobileDevice || this.config.nativeDropdown
                ? u.removeClass(this.container, 'native-open')
                : ((e = u.hasClass(this.container, 'notice')),
                  this.config.searchable &&
                    !e &&
                    (this.input.blur(), (this.input.tabIndex = -1), (this.searching = !1)),
                  e && (u.removeClass(this.container, 'notice'), (this.notice.textContent = '')),
                  u.removeClass(this.container, 'open'),
                  u.removeClass(this.container, 'native-open'),
          ...
          (t.prototype.disable = function(e) {
            e || (this.el.disabled = !0),
              ...
              (this.disabled = !0),
              u.addClass(this.container, 'selectr-disabled');
          }),
          ...
          (t.prototype.clear = function(e, t) {
            ...
            this.el.multiple
              ? this.selectedIndexes.length &&
                ((n = this.selectedIndexes.slice()),
                t
                  ? this.deselect(n.slice(-1)[0])
                  : u.each(
                      n,
                      function(e, t) {
                        this.deselect(t);
          ...
          (t.prototype.setPlaceholder = function(e) {
            (e = e || this.config.placeholder || this.el.getAttribute('placeholder')),
              this.options.length || (e = this.config.messages.noOptions),
          ...
          (t.prototype.invert = function() {
            var e = u.rect(this.selected),
              t = this.tree.parentNode.offsetHeight,
              n = window.innerHeight;
            e.top + e.height + t > n
              ? (u.addClass(this.container, 'inverted'), (this.isInverted = !0))
              : (u.removeClass(this.container, 'inverted'), (this.isInverted = !1)),
              (this.optsRect = u.rect(this.tree));
          }),
      ...
      925: function(e, t, n) {
        ...
        function i(n, e, i) {
          var t,
            ...
            r = 'function' == typeof (a = n).getRootNode ? a.getRootNode() : window,
            s = {},
              ...
              for (var e in (d.parentNode.removeChild(d), s))
                (t = e),
                  Object.prototype.hasOwnProperty.call(s, t) &&
                    ((t = s[e]) && (0, u.removeEventListener)(r, e, t), delete s[e]);
      ...
      57: function(e, t, n) {
        ...
        var r = {
            ...
            es: {
              ...
              autoType:
                'Tipo de campo "auto". El tipo de campo se determina automáticamente a partir del valor y puede ser una cadena, un número, un booleano o un valor nulo.',
              objectType:
          ...
          s = 'en',
          o =
            'undefined' != typeof navigator ? navigator.language || navigator.userLanguage : void 0,
          a =
            i.find(function(e) {
              return e === o;
            }) || s;
      ...
      359: function(e, t, n) {
        ...
        function o(e, t) {
          ...
          return (
            o
              ? ((n = '@' !== o.field ? ['0'].concat((0, s.parsePath)('.' + o.field)) : ['0']),
                (n = 'string' == typeof (0, s.get)(e, n) ? o.value : (0, s.parseString)(o.value)),
                (r += '[? ' + o.field + ' ' + o.relation + ' `' + JSON.stringify(n) + '`]'))
              : (r += Array.isArray(e) ? '[*]' : '@'),
            i &&
              ('desc' === i.direction
                ? (r += ' | reverse(sort_by(@, &' + i.field + '))')
                : (r += ' | sort_by(@, &' + i.field + ')')),
            t &&
              (']' !== r[r.length - 1] && (r += ' | [*]'),
              1 === t.fields.length
      ...
      81: function() {
        ...
        'undefined' != typeof Element &&
          ...
          void 0 !== window.DocumentType) &&
          e(window.DocumentType.prototype),
      ...
      483: function(e, t, n) {
              ...
              Object.defineProperty(
                ...
                (e => (
                  (e = ((e, t) => {
                    ...
                    var n = e[Symbol.toPrimitive];
                    if (void 0 === n) return ('string' === t ? String : Number)(e);
                    if ('object' != a((n = n.call(e, t || 'default')))) return n;
                    throw new TypeError('@@toPrimitive must return a primitive value.');
                  })(e, 'string')),
                  'symbol' == a(e) ? e : e + ''
                ))(i.key),
        ...
        var d = (() => {
          ...
          t = {
            create: function(e) {
              var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
                n = (void 0 === t.statusBar && (t.statusBar = !0),
                (t.mainMenuBar = !1 !== t.mainMenuBar),
                (t.enableSort = !1 !== t.enableSort),
                (t.enableTransform = !1 !== t.enableTransform),
                (t.createQuery = t.createQuery || h.V),
                (t.executeQuery = t.executeQuery || h.e),
                (this.options = t),
                (this.indentation = 'number' == typeof t.indentation ? Number(t.indentation) : 2),
                (0, c.AI)(this.options.languages),
                (0, c.xC)(this.options.language),
                (this.mode = 'preview'),
                this),
                e = ((this.container = e),
                (this.dom = {}),
                (this.json = void 0),
                (this.text = ''),
                (this._debouncedValidate = (0, f.debounce)(
                ...
                e = ((this.frameFocusTracker = new r.$(e)),
                ...
                this.options.mainMenuBar &&
                  ((0, f.addClassName)(this.content, 'has-main-menu-bar'),
                  (this.menu = document.createElement('div')),
                  (this.menu.className = 'jsoneditor-menu'),
                  this.frame.appendChild(this.menu),
                  ((e = document.createElement('button')).type = 'button'),
                  (e.className = 'jsoneditor-format'),
                  (e.title = (0, c.Tl)('formatTitle')),
                  ...
                  this.options.enableTransform &&
                    (((e = document.createElement('button')).type = 'button'),
                    (e.title = (0, c.Tl)('transformTitleShort')),
                    (e.className = 'jsoneditor-transform'),
                    (e.onclick = function() {
                      n._showTransformModal();
                    }),
                    (this.dom.transform = e),
                    this.menu.appendChild(e)),
                  ((e = document.createElement('button')).type = 'button'),
                  (e.className = 'jsoneditor-repair'),
                  (e.title = (0, c.Tl)('repairTitle')),
                  this.menu.appendChild(e),
                  !(e.onclick = function() {
                    void 0 === n.json &&
                      n.executeWithBusyMessage(function() {
                    ...
                    ((e = document.createElement('button')).type = 'button'),
                    (e.className = 'jsoneditor-undo jsoneditor-separator'),
                    (e.title = (0, c.Tl)('undo')),
                    (e.onclick = function() {
                ...
                Array.isArray(this.options.showErrorTable)
                  ? this.options.showErrorTable.includes(this.mode)
                  : !0 === this.options.showErrorTable);
              (this.errorTable = new o.N({
                errorTableVisible: e,
                ...
                t.statusBar &&
                  ((0, f.addClassName)(this.content, 'has-status-bar'),
                  (e = document.createElement('div')),
                  ((this.dom.statusBar = e).className = 'jsoneditor-statusbar'),
                  ...
                  e.appendChild(this.dom.fileSizeInfo),
                  ...
                  e.appendChild(this.dom.arrayInfo),
                  e.appendChild(this.errorTable.getErrorCounter()),
                  e.appendChild(this.errorTable.getWarningIcon()),
                  e.appendChild(this.errorTable.getErrorIcon())),
                this._renderPreview(),
                this.setSchema(this.options.schema, this.options.schemaRefs);
            },
            _renderPreview: function() {
              var e = this.getText();
              (this.dom.previewText.nodeValue = (0, f.limitCharacters)(e, s.hJ)),
                this.dom.fileSizeInfo &&
                  (this.dom.fileSizeInfo.innerText = 'Size: ' + (0, f.formatSize)(e.length)),
                this.dom.arrayInfo &&
          ...
          g = ((t._showSortModal = function() {
            var r = this;
            this.executeWithBusyMessage(function() {
              var e = r.options.modalAnchor || s.ai,
                o = r.get();
              r._renderPreview(),
                (0, p.showSortModal)(
                  e,
                  ...
                  function(i) {
                    r.executeWithBusyMessage(function() {
                      ...
                      (e = o),
                        (t = i),
                        Array.isArray(e) &&
                          ((n = (0, f.sort)(e, t.path, t.direction)),
                          (r.sortedBy = t),
                          r._setAndFireOnChange(n)),
                        (0, f.isObject)(e) &&
                          ((n = (0, f.sortObjectKeys)(e, t.direction)),
                          (r.sortedBy = t),
                          r._setAndFireOnChange(n));
                    }, 'sorting...');
                  },
          ...
          (t.get = function() {
            var e;
            return (
              void 0 === this.json && ((e = this.getText()), (this.json = (0, f.parse)(e))),
              this.json
            );
          }),
          (t.getText = function() {
            return (
              void 0 === this.text &&
                ...
                (this.text = (0, f.escapeUnicodeChars)(this.text)),
              this.text
            );
          }),
          ...
          (t._setText = function(e, t) {
            var n;
            !0 === this.options.escapeUnicode
              ? (this.text = (0, f.escapeUnicodeChars)(e))
              : (this.text = e),
              (this.json = t),
              this._renderPreview(),
              void 0 === this.json
          ...
          (t.executeWithBusyMessage = function(e, t) {
            var n;
            this.getText().length > s.Oq
              ? ((0, f.addClassName)((n = this).frame, 'busy'),
                (n.dom.busyContent.innerText = t),
                setTimeout(function() {
                  e(), (0, f.removeClassName)(n.frame, 'busy'), (n.dom.busyContent.innerText = '');
                }, 100))
              : e();
          }),
          (t.validate = n.validate),
          (t._renderErrors = n._renderErrors),
          [{ mode: 'preview', mixin: t, data: 'json' }]);
      },
      915: function(e, t, n) {
        n.r(t),
          n.d(t, {
        ...
        function s(e, t, s, n) {
          var a = Array.isArray(t) ? (0, r.getChildPaths)(t) : [''],
            ...
            t =
              ...
              (0, o.Tl)('sortAscending') +
              '" title="' +
              (0, o.Tl)('sortAscendingTitle') +
              '" data-value="asc" class="jsoneditor-button-first jsoneditor-button-asc"/><input type="button" value="' +
              (0, o.Tl)('sortDescending') +
              '" title="' +
              (0, o.Tl)('sortDescendingTitle') +
          ...
          i()({
            ...
            .afterCreate(function(t) {
              ...
              function r(e) {
                (o.value = e),
                  (o.className =
                    'jsoneditor-button-group jsoneditor-button-group-value-' + o.value);
              }
      ...
      609: function(e, t, n) {
        ...
        function _(e, t, n, i) {
          ...
          if (Array.isArray(e)) {
            for (
              var o = e, r = t, s = n, a = i, l = r ? s + r : void 0, d = r ? '[\n' : '[', c = 0;
              c < o.length;
              c++
            ) {
              var h = o[c];
              if (
                (r && (d += l),
                (d += void 0 !== h && 'function' != typeof h ? _(h, r, l, a) : 'null'),
                c < o.length - 1 && (d += r ? ',\n' : ','),
                d.length > a)
              )
                return d + '...';
          ...
          if (e && 'object' === x(e)) {
            var u,
              ...
              v = !0,
              y = m ? '{\n' : '{';
            if ('function' == typeof p.toJSON) return _(p.toJSON(), m, s, f);
            for (u in p)
              if (((e, t) => Object.prototype.hasOwnProperty.call(e, t))(p, u)) {
                var b = p[u];
                if (
                  (v ? (v = !1) : (y += m ? ',\n' : ','),
                  (y = (y += m ? g + '"' + u + '": ' : '"' + u + '":') + _(b, m, g, f)).length > f)
                )
                  return y + '...';
              }
            return (y += m ? '\n' + s + '}' : '}');
          ...
          i()({
            ...
            .afterCreate(function(t) {
              ...
              Array.isArray(S) ||
                ...
                (n.textContent = '(wizard not available for objects, only for arrays)'));
              ...
              var n = (0, k.getChildPaths)(x, !0).filter(function(e) {
                  return '' !== e;
                }),
                n = (0 < n.length
                  ? n.forEach(function(e) {
                      var e = g(e),
                        t = document.createElement('option');
                      (t.text = e), (t.value = e), c.appendChild(t);
                    })
                  : (n = e.querySelector('#selectFieldsPart')) && (n.style.display = 'none'),
                new (w())(o, {
                  defaultSelected: !1,
                  clearable: !0,
                  allowDeselect: !0,
              ...
              var v = (0, k.debounce)(function() {
                try {
                  ...
                  (u.className = 'jsoneditor-transform-preview'),
                    ...
                    (n = _(t, o, '', i)).length > i
                      ? ((t = n), ('number' == typeof (o = i) ? t.slice(0, o) : t) + '...')
                      : n)),
                    (r.disabled = !1);
                } catch (e) {
                  (u.className = 'jsoneditor-transform-preview jsoneditor-error'),
                    (u.value = e.toString()),
                    (r.disabled = !0);
                }
                var t, n, i, o;
              ...
              function b() {
                ...
                if (
                  (o.value &&
                    s.value &&
                    a.value &&
                    (e.filter = { field: o.value, relation: s.value, value: a.value }),
                  l.value && d.value && (e.sort = { field: l.value, direction: d.value }),
                  c.value)
                ) {
                  for (var t, n = [], i = 0; i < c.options.length; i++)
                    c.options[i].selected && ((t = c.options[i].value), n.push(t));
              ...
              (h.oninput = v),
                (r.onclick = function(e) {
                  e.preventDefault(), e.stopPropagation(), t.close(), E(h.value);
                }),
                y(x, {}),
                setTimeout(function() {
      ...
      948: function(e, t, n) {
            ...
            (t = [
              {
                ...
                value: function() {
                  for (var e in (this._handleSchemaEntry('', this.schema, this.suggestions),
                  this.schemaRefs))
                    (this.suggestionsRefs[e] = {}),
              ...
              },
              {
                ...
                value: function(e, t, n) {
                  (n[e] = n[e] || {}),
                    (n[e].refs = n[e].refs || []),
                    (n[e].refs = (0, v.uniqueMergeArrays)(n[e].refs, [t]));
                },
              },
              {
                ...
                value: function(e, t, n) {
                  if (t)
                    if (t.$ref) this._handleRef(e, t.$ref, n);
                    else {
                      var i = this._checkOfConditon(t);
                      if (i) this._handleOfCondition(e, t[i], n);
                      else
                        switch (t.type) {
                          case 'object':
              ...
              },
              {
                ...
                value: function(t, n, i) {
                  var e,
                    o = this;
                  (0, v.isObject)(n.properties) &&
                    ((e = Object.keys(n.properties)),
                    (i[t] = i[t] || {}),
                    (i[t].props = i[t].props || []),
                    (i[t].props = (0, v.uniqueMergeArrays)(i[t].props, e)),
                    e.forEach(function(e) {
                      (0, v.asyncExec)(function() {
              ...
              },
              {
                ...
                value: function(e, t, n) {
                  (n[e] = n[e] || {}),
                    (0, v.isArray)(t.examples) &&
                      ((n[e].examples = n[e].examples || []),
                      (n[e].examples = (0, v.uniqueMergeArrays)(n[e].examples, t.examples))),
                    (0, v.isArray)(t.enum) &&
                      ((n[e].enum = n[e].enum || []),
                      (n[e].enum = (0, v.uniqueMergeArrays)(n[e].enum, t.enum)));
                },
              },
              {
                key: '_handleBoolean',
              ...
              },
              {
                ...
                value: function(e, t, i, n, s) {
                  var d = this;
                  try {
                    var o = g.parse(t.getValue()).pointers || {},
                      r = function(i) {
                        function e(t) {
                          var e,
                            n = {
                    ...
                    Object.keys(o).forEach(function(n) {
                      (0, v.asyncExec)(function() {
                        function l(n, e, i) {
                          var t,
                            o = Object.keys(e).reduce(function(e, t) {
                              return new RegExp('^'.concat(i).concat(t)).test(n) &&
                                (!e || e.length < t.length)
                                ? t
                                : e;
                            }, null);
                          if ('string' == typeof o) {
                            if (null != (t = e[o]) && null != (t = t.refs) && t.length) {
                              ...
                              for (r in e[o].refs) {
                                ...
                                d.suggestionsRefs[a] &&
                                  (null !=
                                    (a = l(n, d.suggestionsRefs[a], ''.concat(i).concat(o))) &&
                                    a.enum &&
                                    (s.enum = (0, v.uniqueMergeArrays)(s.enum, a.enum)),
                                  null != a &&
                                    a.examples &&
                                    (s.examples = (0, v.uniqueMergeArrays)(s.examples, a.examples)),
                                  null != a &&
                                    a.bool &&
                                    (s.bool = (0, v.uniqueMergeArrays)(s.bool, a.bool)),
                                  null != a) &&
                                  a.props &&
                                  (s.props = (0, v.uniqueMergeArrays)(s.props, a.props));
                              }
                              return s;
                            }
                        ...
                        var e, t;
                        (null == (t = o[n].key) ? void 0 : t.line) === i.row &&
                          i.column >= o[n].key.column &&
                          i.column <= o[n].keyEnd.column &&
                          (e = n.slice(0, n.lastIndexOf('/'))),
                          (e =
                            (null == (t = o[n].value) ? void 0 : t.line) === i.row &&
                            (null == (t = o[n].value) ? void 0 : t.line) ===
                              (null == (t = o[n].valueEnd) ? void 0 : t.line) &&
                            i.column >= o[n].value.column &&
                            i.column <= o[n].valueEnd.column
                              ? n
                              : e) && ((t = l(e, d.suggestions, '')), r(t));
                      });
                    });
                  } catch (e) {}
                },
        ...
        (t.create = function(e) {
          var t,
            ...
            s = (void 0 === r.statusBar && (r.statusBar = !0),
            (r.mainMenuBar = !1 !== r.mainMenuBar),
            (r.enableSort = !1 !== r.enableSort),
            (r.enableTransform = !1 !== r.enableTransform),
            (r.createQuery = r.createQuery || u.V),
            (r.executeQuery = r.executeQuery || u.e),
            (r.showErrorTable =
              void 0 !== r.showErrorTable ? r.showErrorTable : ['text', 'preview']),
            (this.options = r),
            (this.indentation = 'number' == typeof r.indentation ? Number(r.indentation) : 2),
            (0, h.AI)(this.options.languages),
            (0, h.xC)(this.options.language),
            r.ace || l()),
            a = ((this.mode = 'code' === r.mode ? 'code' : 'text'),
            'code' === this.mode &&
              void 0 === s &&
              ((this.mode = 'text'),
              console.warn(
            ...
            (this.theme = r.theme || x),
            this.theme === x && s && (0, f.J)(),
            r.onTextSelectionChange && this.onTextSelectionChange(r.onTextSelectionChange),
            this),
            e = ((this.container = e),
            (this.dom = {}),
            ...
            (this._debouncedValidate = (0, v.debounce)(
            ...
            e = ((this.frameFocusTracker = new c.$(e)),
            (this.content = document.createElement('div')),
            (this.content.className = 'jsoneditor-outer'),
            this.options.mainMenuBar &&
              ((0, v.addClassName)(this.content, 'has-main-menu-bar'),
              (this.menu = document.createElement('div')),
              (this.menu.className = 'jsoneditor-menu'),
              this.frame.appendChild(this.menu),
              ((e = document.createElement('button')).type = 'button'),
              (e.className = 'jsoneditor-format'),
              (e.title = (0, h.Tl)('formatTitle')),
              this.menu.appendChild(e),
              (e.onclick = function() {
                try {
              ...
              this.options.enableTransform &&
                (((e = document.createElement('button')).type = 'button'),
                (e.title = (0, h.Tl)('transformTitleShort')),
                (e.className = 'jsoneditor-transform'),
                (e.onclick = function() {
              ...
              'code' === this.mode) &&
              ((t = document.createElement('a')).appendChild(
                document.createTextNode('powered by ace')
              ),
              (t.href = 'https://ace.c9.io/'),
              (t.target = '_blank'),
              (t.className = 'jsoneditor-poweredBy'),
              (t.onclick = function() {
            ...
            this.options.onEditable &&
              ...
              !this.options.onEditable({})),
            s = (this.frame.appendChild(this.content),
            this.container.appendChild(this.frame),
            'code' === this.mode
              ? ((this.editorDom = document.createElement('div')),
                ...
                (i = (s = s.edit(this.editorDom)).getSession()),
                (s.$blockScrolling = 1 / 0),
                s.setTheme(this.theme),
                s.setOptions({ readOnly: e }),
                ...
                s.commands.bindKey('Ctrl-L', null),
                s.commands.bindKey('Command-L', null),
                s.commands.bindKey('Ctrl-\\', null),
                s.commands.bindKey('Command-\\', null),
                s.commands.bindKey('Ctrl-Shift-\\', null),
                s.commands.bindKey('Command-Shift-\\', null),
                (this.aceEditor = s).on('change', this._onChange.bind(this)),
                s.on('changeSelection', this._onSelect.bind(this)))
              : (((i = document.createElement('textarea')).className = 'jsoneditor-text'),
                (i.spellcheck = !1),
                ...
                (i.onselect = this._onSelect.bind(this)),
                (i.onmousedown = this._onMouseDown.bind(this)),
                (i.onblur = this._onBlur.bind(this))),
            this._updateHistoryButtons(),
            Array.isArray(this.options.showErrorTable)
              ? this.options.showErrorTable.includes(this.mode)
              : !0 === this.options.showErrorTable);
          (this.errorTable = new d.N({
            errorTableVisible: s,
            onToggleVisibility: function() {
              a._validateAndCatch();
            },
            onFocusLine: function(e) {
              (a.isFocused = !0),
                isNaN(e) || a.setTextSelection({ row: e, column: 1 }, { row: e, column: 1e3 });
            },
            onChangeHeight: function(e) {
              e = e + (a.dom.statusBar ? a.dom.statusBar.clientHeight : 0) + 1;
              (a.content.style.marginBottom = -e + 'px'),
                (a.content.style.paddingBottom = e + 'px');
            },
          })),
            this.frame.appendChild(this.errorTable.getErrorTable()),
            r.statusBar &&
              ((0, v.addClassName)(this.content, 'has-status-bar'),
              (this.curserInfoElements = {}),
              (e = document.createElement('div')),
              ((this.dom.statusBar = e).className = 'jsoneditor-statusbar'),
              this.frame.appendChild(e),
              ((i = document.createElement('span')).className = 'jsoneditor-curserinfo-label'),
              (i.innerText = 'Ln:'),
              ((s = document.createElement('span')).className = 'jsoneditor-curserinfo-val'),
              (s.innerText = '1'),
              e.appendChild(i),
              e.appendChild(s),
              ((r = document.createElement('span')).className = 'jsoneditor-curserinfo-label'),
              (r.innerText = 'Col:'),
              ((i = document.createElement('span')).className = 'jsoneditor-curserinfo-val'),
              (i.innerText = '1'),
              e.appendChild(r),
              e.appendChild(i),
              (this.curserInfoElements.colVal = i),
              (this.curserInfoElements.lnVal = s),
              ((r = document.createElement('span')).className = 'jsoneditor-curserinfo-label'),
              (r.innerText = 'characters selected'),
              (r.style.display = 'none'),
              ((i = document.createElement('span')).className = 'jsoneditor-curserinfo-count'),
              (i.innerText = '0'),
              (i.style.display = 'none'),
              (this.curserInfoElements.countLabel = r),
              (this.curserInfoElements.countVal = i),
              e.appendChild(i),
              e.appendChild(r),
              e.appendChild(this.errorTable.getErrorCounter()),
              e.appendChild(this.errorTable.getWarningIcon()),
          ...
          (t._onSchemaChange = function(e, t) {
            this.aceEditor &&
              (this.options.allowSchemaSuggestions && e
                ? (this.aceEditor.setOption('enableBasicAutocompletion', [new y(e, t)]),
                  this.aceEditor.setOption('enableLiveAutocompletion', !0))
                : (this.aceEditor.setOption('enableBasicAutocompletion', void 0),
                  this.aceEditor.setOption('enableLiveAutocompletion', !1)));
          }),
          ...
          (t._updateHistoryButtons = function() {
            ...
            this.aceEditor &&
              ...
              e.hasUndo &&
              e.hasRedo &&
              ((this.dom.undo.disabled = !e.hasUndo()), (this.dom.redo.disabled = !e.hasRedo()));
          }),
          (t._showSortModal = function() {
            try {
              var n = this,
                e = this.options.modalAnchor || a.ai,
                i = this.get();
              (0, o.showSortModal)(
                e,
                i,
                function(e) {
                  var t;
                  Array.isArray(i) &&
                    ((t = (0, v.sort)(i, e.path, e.direction)), (n.sortedBy = e), n.update(t)),
                    (0, v.isObject)(i) &&
                      ((t = (0, v.sortObjectKeys)(i, e.direction)), (n.sortedBy = e), n.update(t));
                },
                n.sortedBy
              );
            } catch (e) {
          ...
          (t._onKeyDown = function(e) {
            ...
            73 === (e.which || e.keyCode) &&
              e.ctrlKey &&
              (e.shiftKey ? this.compact() : this.format(), this._onChange(), (t = !0)),
          ...
          (t._updateCursorInfo = function() {
            ...
            function s() {
              r.curserInfoElements.countVal.innerText !== o &&
                ((r.curserInfoElements.countVal.innerText = o),
                (r.curserInfoElements.countVal.style.display = o ? 'inline' : 'none'),
                (r.curserInfoElements.countLabel.style.display = o ? 'inline' : 'none')),
                (r.curserInfoElements.lnVal.innerText = n),
                (r.curserInfoElements.colVal.innerText = i);
            }
            this.textarea
              ? setTimeout(function() {
                  var e = (0, v.getInputSelection)(r.textarea);
                  e.startIndex !== e.endIndex && (o = e.endIndex - e.startIndex),
                    (i = (o &&
                    r.cursorInfo &&
                    r.cursorInfo.line === e.end.row &&
                    r.cursorInfo.column === e.end.column
                      ? ((n = e.start.row), e.start)
                      : ((n = e.end.row), e.end)
                    ).column),
          ...
          (t._setText = function(e, t) {
            var n,
              i = this,
              e = !0 === this.options.escapeUnicode ? (0, v.escapeUnicodeChars)(e) : e;
          ...
          (t.validate = function() {
            ...
            try {
              var r = this.get(),
                s = (this.validateSchema &&
                  !this.validateSchema(r) &&
                  (i = this.validateSchema.errors.map(function(e) {
                    return (e.type = 'validation'), (0, v.improveSchemaError)(e);
                  })),
              ...
              return ((e, t) => {
                ...
                try {
                  var n = t(e);
                  return ((0, v.isPromise)(n) ? n : Promise.resolve(n)).then(function(e) {
                    return Array.isArray(e)
                      ? e
                          .filter(function(e) {
                            var t = (0, v.isValidValidationError)(e);
                            return (
                              t ||
                                console.warn(
                          ...
                          .map(function(e) {
                            return {
                              dataPath: (0, v.stringifyPath)(e.path),
                              message: e.message,
                ...
                return (
                  a === s.validationSequence &&
                    ...
                    'function' == typeof n.options.onValidationError &&
                      (0, v.isValidationErrorChanged)(e, n.lastSchemaErrors) &&
              ...
              return (
                this.getText() &&
                  ...
                  (o = [{ type: 'error', message: e.message.replace(/\n/g, '<br>'), line: t }])),
                this._renderErrors(o),
                'function' == typeof this.options.onValidationError &&
                  (0, v.isValidationErrorChanged)(o, this.lastSchemaErrors) &&
          ...
          (t._renderErrors = function(i) {
            var e = this.getText(),
              ...
              (0, v.getPositionForPath)(e, t));
            this.aceEditor &&
              ((this.annotations = e.map(function(t) {
          ...
          (t.getTextSelection = function() {
            var e,
              ...
              i = {};
            return this.textarea
              ? ((n = (0, v.getInputSelection)(this.textarea)),
                this.cursorInfo &&
                this.cursorInfo.line === n.end.row &&
                this.cursorInfo.column === n.end.column
                  ? ((i.start = n.end), (i.end = n.start))
                  : (i = n),
                {
                  start: i.start,
                  end: i.end,
              ...
              : this.aceEditor
                ? ((n = this.aceEditor.getSelection()),
                  (e = this.aceEditor.getSelectedText()),
                  (t = n.getRange()),
                  (n = n.getSelectionLead()).row === t.end.row && n.column === t.end.column
                    ? (i = t)
                    : ((i.start = t.end), (i.end = t.start)),
                  {
                    start: { row: i.start.row + 1, column: i.start.column + 1 },
                    end: { row: i.end.row + 1, column: i.end.column + 1 },
                    text: e,
                  })
                : void 0;
          }),
          (t.onTextSelectionChange = function(e) {
            'function' == typeof e &&
              (this._selectionChangedHandler = (0, v.debounce)(e, this.DEBOUNCE_INTERVAL));
          }),
          (t.setTextSelection = function(e, t) {
            ...
            e &&
              t &&
              (this.textarea
                ? ((n = (0, v.getIndexForPosition)(this.textarea, e.row, e.column)),
                  (o = (0, v.getIndexForPosition)(this.textarea, t.row, t.column)),
                  -1 < n &&
                    -1 < o &&
                    (this.textarea.setSelectionRange
                      ? (this.textarea.focus(), this.textarea.setSelectionRange(n, o))
                      : this.textarea.createTextRange &&
                        ((i = this.textarea.createTextRange()).collapse(!0),
                        i.moveEnd('character', o),
                        i.moveStart('character', n),
                        i.select()),
                    (o = (this.textarea.value.match(/\n/g) || []).length + 1),
                    (n = this.textarea.scrollHeight / o),
                    (i = e.row * n),
                    (this.textarea.scrollTop =
                      i > this.textarea.clientHeight ? i - this.textarea.clientHeight / 2 : 0)))
                : this.aceEditor &&
                  ((o = {
        ...
        var T = [
          { mode: 'text', mixin: t, data: 'text', load: C },
          { mode: 'code', mixin: t, data: 'text', load: C },
        ];
      },
      633: function(M, e, t) {
        t.r(e),
                ...
                },
                {
                  ...
                  value: function() {
                    this.unhighlightTimer &&
                      (clearTimeout(this.unhighlightTimer), (this.unhighlightTimer = void 0));
                  },
                },
                {
                  key: 'lock',
              ...
              if (null != n) {
                ...
                try {
                  if (((r = (n = n.call(e)).next), 0 === t)) {
                    ...
                    for (
                      ;
                      !(l = (i = r.call(n)).done) && (a.push(i.value), a.length !== t);
                      l = !0
                    );
                } catch (e) {
                  (d = !0), (o = e);
        ...
        function w(e, t) {
          ...
          if (Array.isArray(e) || (s = f(e)) || (t && e && 'number' == typeof e.length))
            return (
              s && (e = s),
              (r = 0),
              {
              ...
              Object.defineProperty(
                ...
                (e => (
                  (e = ((e, t) => {
                    ...
                    var n = e[Symbol.toPrimitive];
                    if (void 0 === n) return ('string' === t ? String : Number)(e);
                    if ('object' != N((n = n.call(e, t || 'default')))) return n;
                    throw new TypeError('@@toPrimitive must return a primitive value.');
                  })(e, 'string')),
                  'symbol' == N(e) ? e : e + ''
                ))(i.key),
        ...
        var k = (() => {
              ...
              (this.editor = e),
                ...
                t && t instanceof Object
                  ? (this.setField(t.field, t.fieldEditable),
                    ...
                    'internalValue' in t && this.setInternalValue(t.internalValue))
                  : (this.setField(''), this.setValue(null)),
                (this._debouncedOnChangeValue = (0, _.debounce)(
                  this._onChangeValue.bind(this),
                  w.prototype.DEBOUNCE_INTERVAL
                )),
                (this._debouncedOnChangeField = (0, _.debounce)(
            ...
            return (
              ...
              (t = [
                    ...
                    (this.editable = { field: !0, value: !0 }),
                      this.editor &&
                        ...
                        ('tree' !== this.editor.options.mode &&
                          ...
                          ((e = this.getValue.bind(this)),
                          'boolean' ==
                          typeof (t = this.editor.options.onEditable({
                            field: this.field,
                            get value() {
                              return e();
                            },
                            ...
                            : 'object' === N(t) && null !== t
                              ? ('boolean' == typeof t.field && (this.editable.field = t.field),
                                'boolean' == typeof t.value && (this.editable.value = t.value))
                              : (console.error(
                ...
                },
                {
                  ...
                  value: function(e) {
                    if (e) {
                      for (var t = this, n = 0; n < e.length && t; n++) t = t.childs[e[n]];
                      return t;
                    }
                  },
                },
                ...
                },
                {
                  key: 'findNode',
                  value: function(e) {
                    for (var n = (0, _.parsePath)(e), i = this; i && 0 < n.length; )
                      (() => {
                        var t = n.shift();
                        if ('number' == typeof t) {
                          if ('array' !== i.type)
                            throw new Error(
                              'Cannot get child node at index ' + t + ': node is no array'
                            );
                          i = i.childs[t];
                        } else {
                          if ('object' !== i.type)
                ...
                },
                {
                  ...
                  value: function() {
                    ...
                    if (i && this.dom && this.dom.tr) {
                      (0, _.addClassName)(this.dom.tr, 'jsoneditor-validation-error'),
                        e ||
                      ...
                      var o = document.createElement('button'),
                        t = ((o.type = 'button'),
                        (o.className = 'jsoneditor-button jsoneditor-schema-error'),
                        function() {
                        ...
                        s = function(e) {
                          var t = n.editor.frame,
                            e = ((n.dom.popupAnchor = (0, h.p)(o, n.editor.getPopupAnchor(), r, e)),
                      ...
                      this.dom.tr &&
                        (0, _.removeClassName)(this.dom.tr, 'jsoneditor-validation-error'),
                        e &&
                ...
                },
                {
                  ...
                  value: function() {
                    var e;
                    return this.parent
                      ? -1 !== (e = this.parent.childs.indexOf(this))
                        ? e
                        : null
                      : -1;
                  },
                ...
                },
                {
                  ...
                  value: function(e, t) {
                    ...
                    if ('array' === this.type) {
                      for (this.childs || (this.childs = []), n = 0; n < e.length; n++)
                        void 0 === (s = e[n]) ||
                      ...
                      for (
                        this.childs || (this.childs = []), i = this.childs.length - 1;
                        0 <= i;
                        i--
                      )
                        b(e, this.childs[i].field) || this.removeChild(this.childs[i], !1);
                      for (var d in ((n = 0), e))
                        b(e, d) &&
                          (void 0 === (s = e[d]) ||
                            s instanceof Function ||
                            ((a = this.findChildByProperty(d))
                              ...
                              : ((a = new w(this.editor, { field: d, value: s })),
                      ...
                      this.hideChilds(),
                        ...
                        delete this.childs,
                        (this.value = e);
                    Array.isArray(l) !== Array.isArray(this.childs) && this.recreateDom(),
                      ...
                      for (this.childs || (this.childs = []), o = 0; o < e.childs.length; o++)
                        void 0 === (t = e.childs[o]) ||
                          ...
                          (o < this.childs.length
                            ...
                            : ((n = new w(this.editor, { internalValue: t })),
                      ...
                      for (this.childs || (this.childs = []), o = 0; o < e.childs.length; o++)
                        void 0 === (t = e.childs[o]) ||
                          ...
                          (o < this.childs.length
                            ...
                            : ((n = new w(this.editor, { field: t.field, internalValue: t.value })),
                              (i = o < this.getMaxVisibleChilds()),
                              this.appendChild(n, i, !1)));
                      for (r = this.childs.length; r >= e.childs.length; r--)
                        this.removeChild(this.childs[r], !1);
                ...
                },
                {
                  ...
                  value: function() {
                    ...
                    this.dom && this.dom.tr && this.dom.tr.parentNode
                      ? ((e = this._detachFromDom()), this.clearDom(), this._attachToDom(e))
                      : this.clearDom();
                  },
                },
                {
                ...
                },
                {
                  ...
                  value: function() {
                    var t, n;
                    return (
                      ((t = new w(this.editor)).type = this.type),
                      (t.field = this.field),
                      ...
                      if (t) {
                        for (
                          var n = this.getAppendDom(),
                            i = (n.parentNode ||
                              ((o = e.nextSibling) ? t.insertBefore(n, o) : t.appendChild(n)),
                            Math.min(this.childs.length, this.visibleChilds)),
                            o = this._getNextTr(),
                            r = 0;
                          r < i;
                          r++
                        ...
                        (o = this._getNextTr()),
                          e.parentNode || t.insertBefore(e, o),
                ...
                },
                {
                  ...
                  value: function(e) {
                    ...
                    this.childs &&
                      this.expanded &&
                      ((t = this.getAppendDom()).parentNode && t.parentNode.removeChild(t),
                      this.childs.forEach(function(e) {
                        e.hide();
                      }),
                      (t = this.getShowMoreDom()).parentNode && t.parentNode.removeChild(t),
                ...
                },
                {
                  ...
                  value: function() {
                    ...
                    this.dom.field &&
                      ...
                      this.dom.tree &&
                      ((0, _.removeAllClassNames)(this.dom.tree),
                      (e = this.getValue.bind(this)),
                      (t =
                      ...
                      (0, _.addClassName)(this.dom.tree, 'jsoneditor-values ' + t));
                  },
                },
                {
                ...
                },
                {
                  ...
                  value: function(e, t, n) {
                    ...
                    this._hasChilds() &&
                      ...
                      'object' === this.type && void 0 === e.field && e.setField(''),
                      this.childs.push(e),
                      this.expanded &&
                        !1 !== t &&
                        ((t = e.getDom()),
                        (o = (i = this._getNextTr()) ? i.parentNode : void 0),
                        i && o && o.insertBefore(t, i),
                        e.showChilds(),
                        this.visibleChilds++),
                      !1 !== n) &&
                  ...
                  value: function(e, t, n) {
                    ...
                    this._hasChilds() &&
                      ((i = this.dom.tr ? this.dom.tr.parentNode : void 0) &&
                        (((o = document.createElement('tr')).style.height = i.clientHeight + 'px'),
                        i.appendChild(o)),
                      e.parent && e.parent.removeChild(e),
                      t instanceof A || !t
                        ? this.childs.length + 1 > this.visibleChilds
                          ? ((r = this.childs[this.visibleChilds - 1]), this.insertBefore(e, r, n))
                ...
                },
                {
                  ...
                  value: function(e, t, n) {
                    if (this._hasChilds()) {
                      ...
                      this.expanded &&
                        ((i = e.getDom()),
                        (o = (t = t.getDom()) ? t.parentNode : void 0),
                        t && o && o.insertBefore(i, t),
                        e.showChilds(),
                        this.showChilds()),
                        !1 !== n &&
                          (this.updateDom({ updateIndexes: !0 }), e.updateDom({ recurse: !0 }));
                ...
                },
                {
                  ...
                  value: function(e, t) {
                    this._hasChilds() &&
                      ...
                      (t = this.childs[t + 1]) ? this.insertBefore(e, t) : this.appendChild(e));
                  },
                },
                {
                  key: 'search',
                      ...
                      void 0 !== this.field &&
                        ...
                        (-1 !==
                          String(this.field)
                            .toLowerCase()
                            .indexOf(e) &&
                          ((this.searchField = !0), n.push({ node: this, elem: 'field' })),
                        ...
                        : void 0 !== this.value &&
                          ...
                          (-1 !==
                            String(this.value)
                              .toLowerCase()
                              .indexOf(e) &&
                            ((this.searchValue = !0), n.push({ node: this, elem: 'value' })),
                ...
                },
                {
                  ...
                  value: function() {
                    for (var e = this; e && e.parent; ) {
                      for (
                        var t = 'array' === e.parent.type ? e.index : e.parent.childs.indexOf(e);
                ...
                },
                {
                  key: 'focus',
                  value: function(e) {
                    if (((w.focusElement = e), this.dom.tr && this.dom.tr.parentNode)) {
                      var t = this.dom;
                      switch (e) {
                        case 'drag':
                          (t.drag || t.menu).focus();
                        ...
                        case 'expand':
                          this._hasChilds()
                            ...
                            : t.field && this.fieldEditable
                              ? (t.field.focus(), (0, _.selectContentEditable)(t.field))
                              : t.value && !this._hasChilds()
                                ? (t.value.focus(), (0, _.selectContentEditable)(t.value))
                                : t.menu.focus();
                          break;
                        case 'field':
                          t.field && this.fieldEditable
                ...
                },
                {
                  ...
                  value: function(e) {
                    ...
                    var t = this.childs;
                    if (t)
                      for (var n = 0, i = t.length; n < i; n++) if (t[n].containsNode(e)) return !0;
                    return !1;
                  },
                },
                {
                    ...
                    if (this.childs) {
                      ...
                      if (-1 !== n)
                        return (
                          ...
                          ((e = this.childs.splice(n, 1)[0]).parent = null),
                ...
                },
                {
                  ...
                  value: function(e) {
                    var t,
                      n = this.type;
                    n !== e &&
                      (('string' !== e && 'auto' !== e) || ('string' !== n && 'auto' !== n)
                        ? ((t = this._detachFromDom()),
                          ...
                          'object' === (this.type = e)
                            ? (this.childs || (this.childs = []),
                              ...
                              ('string' !== n && 'auto' !== n) || (this.expanded = !0))
                            : 'array' === e
                              ? (this.childs || (this.childs = []),
                      ...
                      ('auto' !== e && 'string' !== e) ||
                        ((this.value =
                          'string' === e
                            ? String(this.value)
                            : (0, _.parseString)(String(this.value))),
                        this.focus()),
                      this.updateDom({ updateIndexes: !0 }));
                  },
                },
                  ...
                  value: function() {
                    if (
                      ...
                      this.dom.value &&
                        'array' !== this.type &&
                        'object' !== this.type &&
                        ((this.valueInnerText = (0, _.getInnerText)(this.dom.value)),
                        '' === this.valueInnerText) &&
                        ...
                        (t =
                          'string' === this.type
                            ...
                            : ((e = this._unescapeHTML(this.valueInnerText)),
                              (0, _.parseString)(e))) !== this.value &&
                          ((this.value = t), this._debouncedOnChangeValue());
                      } catch (e) {
                        this._setValueError((0, l.Tl)('cannotParseValueError'));
                      }
                  },
                },
                {
                ...
                },
                {
                  ...
                  value: function() {
                    var e,
                      ...
                      n = (t.range &&
                        ((n = (0, _.textDiff)(String(this.value), String(this.previousValue))),
                        (t.range.startOffset = n.start),
                        (t.range.endOffset = n.end)),
                      this.editor.getDomSelection());
                    n.range &&
                      ((e = (0, _.textDiff)(String(this.previousValue), String(this.value))),
                      (n.range.startOffset = e.start),
                      (n.range.endOffset = e.end)),
                ...
                },
                {
                  ...
                  value: function() {
                    var e = this.editor.getDomSelection(),
                      ...
                      n = (e.range &&
                        ((n = (0, _.textDiff)(this.field, t)),
                        (e.range.startOffset = n.start),
                        (e.range.endOffset = n.end)),
                      this.editor.getDomSelection());
                    n.range &&
                      ((t = (0, _.textDiff)(t, this.field)),
                  ...
                  value: function() {
                    ...
                    if (e) {
                      var t = ['jsoneditor-value'],
                        n = this.value,
                        i = 'auto' === this.type ? (0, _.getType)(n) : this.type,
                        o = 'string' === i && (0, _.isUrl)(n);
                      if (
                        (t.push('jsoneditor-' + i),
                        ...
                        this.enum && this.editable.value
                          ? (this.dom.select ||
                              ...
                              ((t = document.createElement('option')).value = ''),
                              (t.textContent = '--'),
                              this.dom.select.appendChild(t),
                        ...
                        (0, _.isValidColor)(n)
                          ? (this.dom.color ||
                            ...
                            (0, _.addClassName)(this.dom.value, 'jsoneditor-color-value'),
                            (this.editable.value ? (0, _.removeClassName) : (0, _.addClassName))(
                              this.dom.color,
                        ...
                        if (
                          (o =
                            'function' == typeof this.editor.options.timestampFormat
                      ...
                      (0, _.stripFormatting)(e), this._updateDomDefault();
                    }
                  },
                },
                {
                ...
                },
                {
                  ...
                  value: function() {
                    this.dom.color &&
                      ...
                      (0, _.removeClassName)(this.dom.value, 'jsoneditor-color-value'));
                  },
                },
                {
                  key: '_updateDomField',
                  value: function() {
                    var e,
                      t = this.dom.field;
                    t &&
                      ((e = (0, _.makeFieldTooltip)(this.schema, this.editor.options.language)) &&
                        (t.title = e),
                      ('' === String(this.field) && this.parent && 'array' !== this.parent.type
                        ? (0, _.addClassName)
                        : (0, _.removeClassName))(t, 'jsoneditor-empty'),
                      (this.searchFieldActive ? (0, _.addClassName) : (0, _.removeClassName))(
                        t,
                        'jsoneditor-highlight-active'
                      ),
                      (this.searchField ? (0, _.addClassName) : (0, _.removeClassName))(
                        t,
                        'jsoneditor-highlight'
                      ),
                      (0, _.stripFormatting)(t));
                  },
                },
                {
                  key: '_getDomField',
                  value: function(e) {
                    if (
                      ...
                      this.dom.field &&
                        this.fieldEditable &&
                        ((this.fieldInnerText = (0, _.getInnerText)(this.dom.field)),
                        '' === this.fieldInnerText) &&
                      ...
                      try {
                        ...
                        -1 !== n.indexOf(t)
                          ? e
                            ? (t = (0, _.findUniqueName)(t, n)) !== this.field &&
                              ((this.field = t), this._debouncedOnChangeField())
                            : this._setFieldError((0, l.Tl)('duplicateFieldError'))
                          : t !== this.field && ((this.field = t), this._debouncedOnChangeField());
                      } catch (e) {
                        this._setFieldError((0, l.Tl)('cannotParseFieldError'));
                      }
                  },
                },
                {
                  ...
                  value: function() {
                    ...
                    this.schema &&
                      ...
                      (this.value === this.schema.default
                        ? ((e.title = (0, l.Tl)('default')),
                          (0, _.addClassName)(e, 'jsoneditor-is-default'),
                          _.removeClassName)
                        : (e.removeAttribute('title'),
                          (0, _.removeClassName)(e, 'jsoneditor-is-default'),
                          _.addClassName))(e, 'jsoneditor-is-not-default');
                  },
                },
                {
                  ...
                  value: function() {
                    ...
                    return (
                      ...
                      ('function' == typeof (e = this.editor.options.timestampTag)
                        ? 'boolean' ==
                          typeof (t = e({
                            field: this.field,
                            value: this.value,
                          ...
                          ? t
                          : (0, _.isTimestamp)(this.field, this.value)
                        : !0 === e && (0, _.isTimestamp)(this.field, this.value))
                    );
                  },
                },
                {
                  ...
                  value: function() {
                    ...
                    return (
                      n.tr ||
                        ...
                        (n.tr = document.createElement('tr')),
                        'tree' === (n.tr.node = this).editor.options.mode &&
                          ((t = document.createElement('td')),
                          this.editable.field &&
                            this.parent &&
                            (((e = document.createElement('button')).type = 'button'),
                            ((n.drag = e).className = 'jsoneditor-button jsoneditor-dragarea'),
                            (e.title = (0, l.Tl)('drag')),
                            t.appendChild(e)),
                          n.tr.appendChild(t),
                          (e = document.createElement('td')),
                          ...
                          (t.title = (0, l.Tl)('actionsMenu')),
                          e.appendChild(n.menu),
                          n.tr.appendChild(e)),
                        (t = document.createElement('td')),
                        n.tr.appendChild(t),
                        (n.tree = this._createDomTree()),
                        t.appendChild(n.tree),
                        this.updateDom({ updateIndexes: !0 })),
                      n.tr
                    );
                  },
                ...
                },
                {
                  ...
                  value: function(t) {
                    this.dom.tr &&
                      ((t ? (0, _.addClassName) : (0, _.removeClassName))(
                        this.dom.tr,
                        'jsoneditor-highlight'
                      ),
                  ...
                  value: function(t, e) {
                    (this.selected = t),
                      this.dom.tr &&
                        ...
                        (e ? (0, _.addClassName) : (0, _.removeClassName))(
                          this.dom.tr,
                          'jsoneditor-first'
                        ),
                ...
                },
                {
                  ...
                  value: function(t) {
                    var e,
                      ...
                      n = (n &&
                        (this.fieldEditable
                          ...
                          : ((n.contentEditable = !1), (n.className = 'jsoneditor-readonly')),
                        (e =
                          void 0 !== this.index
                            ? this.index
                            : void 0 !== this.field
                              ? this.field
                              : (e = this.editor.options.schema
                                  ? w._findSchema(
                        ...
                        document.activeElement !== n &&
                          e !== this._unescapeHTML((0, _.getInnerText)(n)) &&
                          (n.innerHTML = e),
                        this._updateSchema(),
                        this._updateEnumOptions()),
                      this.dom.value),
                    ...
                    n &&
                      ('array' === this.type || 'object' === this.type
                        ? ((0, _.addClassName)(n, 'jsoneditor-expandable'),
                          this.expanded
                            ? ((0, _.addClassName)(n, 'jsoneditor-expanded'),
                              (0, _.removeClassName)(n, 'jsoneditor-collapsed'))
                            : ((0, _.addClassName)(n, 'jsoneditor-collapsed'),
                              (0, _.removeClassName)(n, 'jsoneditor-expanded')))
                        : ((0, _.removeClassName)(n, 'jsoneditor-expandable'),
                          (0, _.removeClassName)(n, 'jsoneditor-expanded'),
                          (0, _.removeClassName)(n, 'jsoneditor-collapsed'))),
                      this._updateDomField(),
                      this._updateDomValue(),
                  ...
                  value: function() {
                    this.editor &&
                      ...
                      ((this.schema = this.editor.options.schema
                        ...
                        : null),
                      this.schema ? (this.enum = w._findEnum(this.schema)) : delete this.enum);
                  },
                },
                {
                  ...
                  value: function() {
                    ...
                    return (
                      'array' === this.type
                        ...
                        : 'object' === this.type
                          ? ((e = document.createElement('div')).textContent = '{...}')
                          : (!this.editable.value && (0, _.isUrl)(this.value)
                              ? ((e = document.createElement('a')).href = this.value)
                    ...
                    return (
                      ...
                      this._hasChilds()
                        ? ((e.className = this.expanded
                          ...
                          (e.title = (0, l.Tl)('expandTitle')))
                        : ((e.className = 'jsoneditor-button jsoneditor-invisible'),
                          (e.title = '')),
                      e
                    );
                  },
                  ...
                  value: function(e) {
                    var t,
                      ...
                      'click' === n &&
                        ...
                        t.lock(),
                        (0, _.addClassName)(o.menu, 'jsoneditor-selected'),
                        this.showContextMenu(o.menu, function() {
                          (0, _.removeClassName)(o.menu, 'jsoneditor-selected'),
                            t.unlock(),
                            t.unhighlight();
                        })),
                      'click' === n && i === o.expand && s && ((h = e.ctrlKey), this._onExpand(h)),
                      'click' !== n ||
                        (e.target !== r.dom.tdColor && e.target !== r.dom.color) ||
                        !this.editable.value ||
                      ...
                      'change' === n &&
                        i === o.select &&
                        ((this.dom.value.innerHTML = this._escapeHTML(o.select.value)),
                        this._getDomValue(),
                        this._updateDomValue()),
                      o.value);
                    if (i === a)
                      switch (n) {
                        ...
                        case 'change':
                          ...
                          l !== this._unescapeHTML((0, _.getInnerText)(a)) && (a.innerHTML = l);
                          break;
                        case 'input':
                        ...
                        case 'click':
                          e.ctrlKey &&
                            this.editable.value &&
                            (0, _.isUrl)(this.value) &&
                            (e.preventDefault(), window.open(this.value, '_blank', 'noreferrer'));
                          break;
                        case 'keyup':
                          this._getDomValue(), this._updateDomValue();
                          break;
                    ...
                    if (i === d)
                      switch (n) {
                        case 'blur':
                          ...
                          c !== this._unescapeHTML((0, _.getInnerText)(d)) && (d.innerHTML = c);
                          break;
                        case 'input':
                          this._getDomField(),
                            this._updateSchema(),
                    ...
                    h &&
                      ...
                      ((void 0 !== e.offsetX
                        ...
                        : e.pageX < (0, _.getAbsoluteLeft)(o.tdSeparator)) || s
                        ? d && ((0, _.setEndOfContentEditable)(d), d.focus())
                        : a && !this.enum && ((0, _.setEndOfContentEditable)(a), a.focus())),
                      ((i !== o.tdExpand || s) && i !== o.tdField && i !== o.tdSeparator) ||
                        'click' !== n ||
                        e.hasMoved ||
                        (d && ((0, _.setEndOfContentEditable)(d), d.focus())),
                      'keydown' === n && this.onKeyDown(e),
                      'function' == typeof this.editor.options.onEvent && this._onEvent(e);
                  },
                },
                {
                  key: '_onEvent',
                ...
                },
                {
                  ...
                  value: function(e) {
                    var t,
                      ...
                      b = e.altKey,
                      x = !1,
                      C = 'tree' === this.editor.options.mode,
                      T =
                    ...
                    13 === f
                      ? g === this.dom.value
                        ? (this.editable.value && !e.ctrlKey) ||
                          ((0, _.isUrl)(this.value) &&
                            (window.open(this.value, '_blank', 'noreferrer'), (x = !0)))
                        : g === this.dom.expand &&
                          this._hasChilds() &&
                          ((p = e.ctrlKey), this._onExpand(p), g.focus(), (x = !0))
                      : 68 === f
                        ? v && C && (w.onDuplicate(T), (x = !0))
                        : 69 === f
                          ? v && (this._onExpand(y), g.focus(), (x = !0))
                          : 77 === f && C
                            ? v && (this.showContextMenu(g), (x = !0))
                            : 46 === f && C
                              ? v && (w.onRemove(T), (x = !0))
                              : 45 === f && C
                                ? v && !y
                                  ? (this._onInsertBefore(), (x = !0))
                                  : v && y && (this._onInsertAfter(), (x = !0))
                                : 35 === f
                                  ? b &&
                                    ((p = this._lastNode()) &&
                                      p.focus(w.focusElement || this._getElementName(g)),
                                    (x = !0))
                                  : 36 === f
                                    ? b &&
                                      ((p = this._firstNode()) &&
                                        ...
                                        : b &&
                                          ...
                                          (p = S.expanded
                                            ? (p = S.getAppendDom())
                                              ? p.nextSibling
                                              : void 0
                                            : S.getDom().nextSibling) &&
                                          ((h = w.getNodeFromTarget(p)),
                                          (p = p.nextSibling),
                                          (u = w.getNodeFromTarget(p)),
                                          h) &&
                                          h instanceof A &&
                                          1 !== S.parent.childs.length &&
                                          u &&
                                          u.parent &&
                                          ((n = this.editor.getDomSelection()),
                                          (i = (o = E.parent).childs[S.getIndex() + 1] || o.append),
                                          (r = E.getIndex()),
                                          (s = u.getIndex()),
                                          (a = o.getInternalPath()),
                                          (l = u.parent.getInternalPath()),
                                          T.forEach(function(e) {
                                            u.parent.moveBefore(e, u);
                                          }),
                                          this.focus(w.focusElement || this._getElementName(g)),
                                          this.editor._onAction('moveNodes', {
                                            count: T.length,
                                            fieldNames: T.map(j),
                                            oldParentPath: o.getInternalPath(),
                                            newParentPath: E.parent.getInternalPath(),
                                            oldIndex: i.getIndex(),
                                            newIndex: E.getIndex(),
                                            oldIndexRedo: r,
                                            newIndexRedo: s,
                                      ...
                                      : 38 === f
                                        ? b && !y
                                          ? ((t = this._previousNode()) &&
                                              ...
                                              t.focus(w.focusElement || this._getElementName(g))),
                                            (x = !0))
                                          : !b && v && y && C
                                            ? ((t = this._previousNode()) &&
                                            ...
                                            : b &&
                                              ...
                                              ((t = E._previousNode()) &&
                                                ...
                                                ((n = this.editor.getDomSelection()),
                                                (i =
                                                  (o = E.parent).childs[S.getIndex() + 1] ||
                                                  o.append),
                                                (r = E.getIndex()),
                                                (s = t.getIndex()),
                                                (a = o.getInternalPath()),
                                                ...
                                                this.focus(
                                                  w.focusElement || this._getElementName(g)
                                                ),
                                                this.editor._onAction('moveNodes', {
                                                  count: T.length,
                                                  fieldNames: T.map(j),
                                        ...
                                        : 39 === f
                                          ? b && !y
                                            ? ((p = this._nextElement(g)) &&
                                                this.focus(this._getElementName(p)),
                                              (x = !0))
                                            : b &&
                                              y &&
                                              C &&
                                              (p = E.getDom().previousSibling) &&
                                              (t = w.getNodeFromTarget(p)) &&
                                              t.parent &&
                                              !t.isVisible() &&
                                              ((n = this.editor.getDomSelection()),
                                              (i =
                                                      ...
                                                      (h =
                                                        (h = S.expanded
                                                          ? S.append
                                                            ? S.append._nextNode()
                                                            : void 0
                                                          : S._nextNode()) && !h.isVisible()
                                                          ? h.parent.showMore
                                                          : h) && h instanceof A
                                                        ? S
                                                        : h) &&
                                                    (h._nextNode() || h.parent.append)) &&
                                                    m.parent &&
                                                    ((n = this.editor.getDomSelection()),
                                                    (i =
                                                      (o = E.parent).childs[S.getIndex() + 1] ||
                ...
                },
                {
                  ...
                  value: function(e) {
                    var t, n, i;
                    e &&
                      ((i = (n = (t = this.dom.tr.parentNode).parentNode).scrollTop),
                      n.removeChild(t)),
                      this.expanded ? this.collapse(e) : this.expand(e),
                      e && (n.appendChild(t), (n.scrollTop = i)),
                      'function' == typeof this.editor.options.onExpand &&
                ...
                },
                {
                  ...
                  value: function() {
                    ...
                    'function' == typeof this.editor.options.onColorPicker &&
                      ...
                      t.updateDom(),
                      (e = (0, h.p)(this.dom.color, this.editor.getPopupAnchor())),
                      this.editor.options.onColorPicker(e, this.value, function(e) {
                        'string' == typeof e &&
                          e !== t.value &&
                          (t._deleteDomColor(),
                          (t.value = e),
                ...
                },
                {
                  ...
                  value: function(e, t, n) {
                    var i = this.editor.getDomSelection(),
                      ...
                      n = (this.parent.insertBefore(e, this),
                ...
                },
                {
                  ...
                  value: function(e, t, n) {
                    var i = this.editor.getDomSelection(),
                      ...
                      t = (e.expand(!0),
                      this.parent.insertAfter(e, this),
                      this.editor.highlighter.unhighlight(),
                      e.focus('field'),
                      this.editor.getDomSelection());
                ...
                },
                {
                  ...
                  value: function(n, e) {
                    ...
                    'string' == typeof n && (n = (0, _.parsePath)(n)),
                      this._hasChilds() &&
                        (this.hideChilds(),
                        (t = this.childs),
                ...
                },
                {
                  ...
                  value: function() {
                    return (
                      this.showMore || (this.showMore = new B(this.editor, this)),
                      this.showMore.getDom()
                    );
                  },
                },
                ...
                },
                {
                  ...
                  value: function() {
                    ...
                    return (
                      t &&
                        t.parentNode &&
                        ((t = t.parentNode.firstChild), (e = w.getNodeFromTarget(t))),
                      e
                    );
                  },
                },
                {
                  ...
                  value: function() {
                    ...
                    if (t && t.parentNode)
                      for (
                        var n = t.parentNode.lastChild, e = w.getNodeFromTarget(n);
                        n && e && !e.isVisible();

                      )
                        (n = n.previousSibling), (e = w.getNodeFromTarget(n));
                    return e;
                  },
                },
                {
                    ...
                    this.editable.value &&
                      ...
                      this._hasChilds() &&
                        (this.editor.options.enableSort &&
                          o.push({
                            text: (0, l.Tl)('sort'),
                            title: (0, l.Tl)('sortTitle', { type: this.type }),
                        ...
                        this.editor.options.enableTransform &&
                          o.push({
                            text: (0, l.Tl)('transform'),
                            title: (0, l.Tl)('transformTitle', { type: this.type }),
                        ...
                        o.push({
                          text: (0, l.Tl)('extract'),
                          title: (0, l.Tl)('extractTitle', { type: this.type }),
                      ...
                      this.parent &&
                        ...
                        i === n[n.length - 1] &&
                          ...
                          i.addTemplates(n, !0),
                          o.push({
                            text: (0, l.Tl)('appendText'),
                            title: (0, l.Tl)('appendTitle'),
                            submenuTitle: (0, l.Tl)('appendSubmenuTitle'),
                        ...
                        o.push({
                          text: (0, l.Tl)('insert'),
                          title: (0, l.Tl)('insertTitle'),
                          submenuTitle: (0, l.Tl)('insertSub'),
                        ...
                        this.editable.field) &&
                        (o.push({
                          text: (0, l.Tl)('duplicateText'),
                          title: (0, l.Tl)('duplicateField'),
                        ...
                        o.push({
                          text: (0, l.Tl)('removeText'),
                          title: (0, l.Tl)('removeField'),
                      ...
                      new s.t(o, { close: t }).show(e, this.editor.getPopupAnchor());
                  },
                },
                {
                  key: 'showSortModal',
                  value: function() {
                    var n = this,
                      e = this.editor.options.modalAnchor || m.ai,
                      t = this.getValue();
                    (0, u.showSortModal)(
                      e,
                      t,
                ...
                },
                {
                  ...
                  value: function(e) {
                    return e instanceof Array
                      ...
                      : e instanceof Object
                        ? 'object'
                        : 'string' == typeof e && 'string' != typeof (0, _.parseString)(e)
                          ? 'string'
                          : 'auto';
                  },
                },
                    ...
                    for (var t = '', n = 0; n < e.length; ) {
                      ...
                      '\n' === i
                        ...
                        : '\\' === i
                          ? ((t += i),
                            n++,
                            ('' !== (i = e.charAt(n)) && -1 !== '"\\/bfnrtu'.indexOf(i)) ||
                              (t += '\\'),
                            (t += i))
                          : (t += '"' === i ? '\\"' : i),
                        n++;
          ...
          R = ((k.prototype.DEBOUNCE_INTERVAL = 150), (k.prototype.MAX_SEARCH_RESULTS = 999), 100);
        function y(e) {
        ...
        (k.focusElement = void 0),
          (k.select = function(e) {
            setTimeout(function() {
              (0, _.selectContentEditable)(e);
            }, 0);
          }),
          (k.onDragStart = function(t, e) {
            if (!Array.isArray(t)) return k.onDragStart([t], e);
            var n, i, o, r, s;
            0 !== t.length &&
              ((i = t[t.length - 1]),
              (o = (n = t[0]).parent),
              (s = k.getNodeFromTarget(e.target)),
              (r = n.editor),
              (s = (0, _.getAbsoluteTop)(s.dom.tr) - (0, _.getAbsoluteTop)(n.dom.tr)),
              r.mousemove ||
                (r.mousemove = (0, _.addEventListener)(e.view, 'mousemove', function(e) {
                  k.onDrag(t, e);
                })),
              r.mouseup ||
                (r.mouseup = (0, _.addEventListener)(e.view, 'mouseup', function(e) {
                  k.onDragEnd(t, e);
                })),
              r.highlighter.lock(),
              (r.drag = {
          ...
          (k.onDrag = function(e, t) {
            if (!Array.isArray(e)) return k.onDrag([e], t);
            if (0 !== e.length) {
              var n,
                i,
                o,
                ...
                h = e[0],
                u = h.dom.tr,
                p = (0, _.getAbsoluteTop)(u),
                m = u.offsetHeight;
              if (l < p) {
                for (
                  y = u;
                  (y = y.previousSibling),
                    (b = k.getNodeFromTarget(y)),
                    (o = y ? (0, _.getAbsoluteTop)(y) : 0),
                    y && l < o;

                );
                (b = b && !b.parent ? void 0 : b) ||
                  ((y = (u = u.parentNode.firstChild) ? u.nextSibling : void 0),
                  (b = k.getNodeFromTarget(y)) === h && (b = void 0)),
                  !(b =
                    b &&
                    b.isVisible() &&
                    (o = (y = b.dom.tr) ? (0, _.getAbsoluteTop)(y) : 0) + m < l
                      ? void 0
                      : b) ||
                    (!1 !== a.options.limitDragging && b.parent !== e[0].parent) ||
                    (e.forEach(function(e) {
                ...
                var f = e[e.length - 1];
                if (
                  (m = (u = f.expanded && f.append ? f.append.getDom() : f.dom.tr)
                    ? u.nextSibling
                    : void 0)
                ) {
                  for (
                    r = (0, _.getAbsoluteTop)(m), n = m;
                    (i = k.getNodeFromTarget(n)),
                      n &&
                        ((s = n.nextSibling ? (0, _.getAbsoluteTop)(n.nextSibling) : 0),
                        (s = n ? s - r : 0),
                        i &&
                          i.parent.childs.length === e.length &&
                          i.parent.childs[e.length - 1] === f &&
                          (p += 27),
                        (n = n.nextSibling)),
                      n && p + s < l;
                  ...
                  if (i && i.parent) {
                    for (
                      var m = d - a.drag.mouseX,
                        ...
                        g = a.drag.level + m,
                        v = i.getLevel(),
                        y = i.dom.tr && i.dom.tr.previousSibling;
                      v < g && y;

                    ) {
                      var b = k.getNodeFromTarget(y),
                        x = e.some(function(e) {
                          return e === b || b.isDescendantOf(e);
                        });
                      if (!x) {
                        if (!(b instanceof A)) break;
                        x = b.parent.childs;
                        if (x.length === e.length && x[e.length - 1] === f) break;
                        v = (i = k.getNodeFromTarget(y)).getLevel();
                      }
                      y = y.previousSibling;
                    }
                    (i =
                      i instanceof A && !i.isVisible() && i.parent.showMore.isVisible()
                        ? i._nextNode()
                        : i) &&
                      (!1 === a.options.limitDragging || i.parent === e[0].parent) &&
                      i.dom.tr &&
                      i.dom.tr !== u.nextSibling &&
                      (e.forEach(function(e) {
          ...
          (k.onDragEnd = function(e, t) {
            if (!Array.isArray(e)) return k.onDrag([e], t);
            var n, i, o, r, s, a, l, d, c;
            0 !== e.length &&
              ((n = (a = e[0]).editor),
              a && a.dom.menu && a.dom.menu.focus(),
              (i = n.drag.oldParent.getInternalPath()),
              (o = a.parent.getInternalPath()),
              (r = n.drag.oldParent === a.parent),
              ...
              e.forEach(function(e) {
                e.updateDom(),
                  t.target !== e.dom.drag && t.target !== e.dom.menu && n.highlighter.unhighlight();
              }),
              delete n.drag,
              n.mousemove &&
                ((0, _.removeEventListener)(t.view, 'mousemove', n.mousemove), delete n.mousemove),
              n.mouseup &&
                ((0, _.removeEventListener)(t.view, 'mouseup', n.mouseup), delete n.mouseup),
              n.stopAutoScroll(),
              t.preventDefault());
          }),
          (k._findEnum = function(e) {
              ...
              for (h.s(); !(c = h.n()).done; ) {
                if ('$ref' in (i = c.value) && 'string' == typeof i.$ref) {
                  ...
                  if (p in t) i = t[p];
                    ...
                    if (!p.startsWith('#/')) {
                      if (1 === (null == (u = p.match(/#\//g)) ? void 0 : u.length)) {
                        var m,
                          f,
                          g,
                          v = L(p.split('#/'), 2),
                        ...
                        if (y in t)
                          return (
                            ...
                            (f = { $ref: '#/'.concat(b) }),
                            (g = []).push(r),
                            0 < o.length && g.push.apply(g, V(o)),
                            k._findSchema(m, t, g, f)
                          );
                      }
                      throw Error('Unable to resolve reference '.concat(p));
                    }
                    var x,
                      C = p.substring(2).split('/'),
                      i = e,
                      T = w(C);
                    try {
                      for (T.s(); !(x = T.n()).done; ) {
                        var E = x.value;
                        if (!(E in i)) throw Error('Unable to resolve reference '.concat(p));
                        i = i[E];
                      }
                    } catch (e) {
                      T.e(e);
                ...
                if ('string' == typeof r) {
                  if ('object' === N(i.properties) && null !== i.properties && r in i.properties)
                    return (i = i.properties[r]), k._findSchema(e, t, o, i);
                  if ('object' === N(i.patternProperties) && null !== i.patternProperties)
                    for (var S in i.patternProperties)
                      if (r.match(S))
                        return (i = i.patternProperties[S]), k._findSchema(e, t, o, i);
                  if ('object' === N(i.additionalProperties))
                    return (i = i.additionalProperties), k._findSchema(e, t, o, i);
                } else if ('number' == typeof r && 'object' === N(i.items) && null !== i.items)
                  return (i = i.items), k._findSchema(e, t, o, i);
              }
            } catch (e) {
              h.e(e);
            } finally {
          ...
          (k.onRemove = function(e) {
            if (!Array.isArray(e)) return k.onRemove([e]);
            var t, n, i, o, r, s;
            e &&
              0 < e.length &&
              ((t = (i = e[0]).parent),
          ...
          (k.onDuplicate = function(e) {
            if (!Array.isArray(e)) return k.onDuplicate([e]);
            var t, i, n, o, r, s, a;
            e &&
              0 < e.length &&
              ((t = e[e.length - 1]),
              ...
              (s = e.map(function(e) {
                ...
                return (
                  'object' === e.parent.type &&
                    ((t = e.parent.getFieldNames()), (n.field = (0, _.findUniqueName)(e.field, t))),
                  i.insertAfter(n, r),
                  (r = n)
                );
              })),
              1 === e.length
                ? 'object' === s[0].parent.type
                  ? ((s[0].dom.field.innerHTML = e[0]._escapeHTML(e[0].field)), s[0].focus('field'))
                  : s[0].focus()
                : n.select(s),
              (a = n.getDomSelection()),
          ...
          (k.getNodeFromTarget = function(e) {
            for (; e; ) {
              if (e.node) return e.node;
              e = e.parentNode;
            }
          }),
          (k.targetIsColorPicker = function(e) {
            var t = k.getNodeFromTarget(e);
            if (t)
          ...
          (k.blurNodes = function(e) {
            var t, n;
            Array.isArray(e)
              ? ((t = (n = e[0]).parent),
                (n = n.getIndex()),
                (t.childs[n + e.length] ? t.childs[n + e.length] : t.childs[n - 1] || t).focus())
              : k.blurNodes([e]);
          });
        ((n.prototype = new k()).getDom = function() {
          var e = this.dom;
          if (e.tr) return e.tr;
          this._updateEditability();
          var t = document.createElement('tr'),
            n = ((t.className = 'jsoneditor-append'),
            (t.node = this),
            (e.tr = t),
            'tree' === this.editor.options.mode &&
              ...
              (n.className = 'jsoneditor-button jsoneditor-contextmenu-button'),
          ...
          return (
            i.appendChild(document.createTextNode('(' + (0, l.Tl)('empty') + ')')),
          ...
          (n.prototype.updateDom = function(e) {
            var t = this.dom,
              ...
              i = (i &&
                (i.firstChild.nodeValue = '(' + (0, l.Tl)('empty') + ' ' + this.parent.type + ')'),
              t.tr);
            this.isVisible()
              ? t.tr.firstChild ||
          ...
          (n.prototype.showContextMenu = function(e, t) {
            ...
            this.editor.options.onCreateMenu &&
              ((n = i.parent.getPath()),
              (o = this.editor.options.onCreateMenu(o, { type: 'append', path: n, paths: [n] }))),
              new s.t(o, { close: t }).show(e, this.editor.getPopupAnchor());
          }),
        ...
        ((x.prototype = new k()).getDom = function() {
          var t, n, e, i, o, r;
          return (
            this.dom.tr ||
              (this._updateEditability(),
              this.dom.tr ||
                ...
                (o = document.createElement('a')).appendChild(
                  document.createTextNode((0, l.Tl)('showMore'))
                ),
                (o.href = '#'),
                (o.onclick = function(e) {
                  return (
                    (n.visibleChilds =
                      Math.floor(n.visibleChilds / n.getMaxVisibleChilds() + 1) *
                ...
                (r = document.createElement('a')).appendChild(
                  document.createTextNode((0, l.Tl)('showAll'))
                ),
                (r.href = '#'),
                (r.onclick = function(e) {
                  return (
                    (n.visibleChilds = 1 / 0), t.updateDom(), n.showChilds(), e.preventDefault(), !1
                  );
                }),
                (e = document.createElement('div')),
          ...
          (x.prototype.updateDom = function(e) {
            var t;
            this.isVisible()
              ? ((this.dom.tr.node = this.parent.childs[this.parent.visibleChilds]),
                this.dom.tr.parentNode ||
                  ((t = this.parent._getNextTr()) && t.parentNode.insertBefore(this.dom.tr, t)),
          ...
          (x.prototype._getShowMoreText = function() {
            return (
              (0, l.Tl)('showMoreStatus', {
          ...
          (x.prototype.onEvent = function(e) {
              ...
              Object.defineProperty(
                ...
                (e => (
                  (e = ((e, t) => {
                    ...
                    var n = e[Symbol.toPrimitive];
                    if (void 0 === n) return ('string' === t ? String : Number)(e);
                    if ('object' != C((n = n.call(e, t || 'default')))) return n;
                    throw new TypeError('@@toPrimitive must return a primitive value.');
                  })(e, 'string')),
                  'symbol' == C(e) ? e : e + ''
                ))(i.key),
                  ...
                  redo: function(e) {
                    ...
                    e.paths.map(r).forEach(function(e) {
                      var t,
                        n = e.clone();
                      'object' === i.type &&
                        ((t = i.getFieldNames()), (n.field = (0, _.findUniqueName)(e.field, t))),
                        i.insertAfter(n, o),
                        (o = n);
                    });
                  },
        ...
        var H = (() => {
          function o(e, t) {
            ...
            var n = this,
              ...
              document.createElement('div')),
              t = (((this.dom.wrapper = e).className = 'jsoneditor-search'),
              t.appendChild(e),
              document.createElement('div')),
              t = (((this.dom.results = t).className = 'jsoneditor-results'),
              e.appendChild(t),
              document.createElement('div')),
              e = (((this.dom.input = t).className = 'jsoneditor-frame'),
              (t.title = (0, l.Tl)('searchTitle')),
              e.appendChild(t),
              document.createElement('button')),
              i = ((e.type = 'button'),
              ...
              document.createElement('button')),
              e = ((e.type = 'button'),
              (e.title = (0, l.Tl)('searchNextResultTitle')),
              ...
              document.createElement('button'));
            (e.type = 'button'),
              (e.title = (0, l.Tl)('searchPreviousResultTitle')),
            ...
            (t = [
              {
                ...
                value: function(e) {
                  var t;
                  this.results &&
                    ((t = null !== this.resultIndex ? this.resultIndex + 1 : 0) >
                ...
                value: function(e, t) {
                  ...
                  this.activeResult &&
                    ...
                    this.results && this.results[e]
                      ? ((this.resultIndex = e),
                        (i = this.results[this.resultIndex].node),
                        'field' === (o = this.results[this.resultIndex].elem)
              ...
              Object.defineProperty(
                ...
                (e => (
                  (e = ((e, t) => {
                    ...
                    var n = e[Symbol.toPrimitive];
                    if (void 0 === n) return ('string' === t ? String : Number)(e);
                    if ('object' != D((n = n.call(e, t || 'default')))) return n;
                    throw new TypeError('@@toPrimitive must return a primitive value.');
                  })(e, 'string')),
                  'symbol' == D(e) ? e : e + ''
                ))(i.key),
        ...
        var J = (() => {
              ...
              (t = [
                {
                  key: 'reset',
                  value: function() {
                    this.path.textContent = (0, l.Tl)('selectNode');
                  },
                },
                {
                  key: 'setPath',
                        ...
                        o.forEach(function(n, i) {
                          ...
                          (t.className = 'jsoneditor-treepath-element'),
                            ...
                            i === o.length - 1 &&
                              ...
                              (t.textContent = '...'),
                              (t.onclick = function(e) {
                                ((r.contentMenuClicked = !1), _.addClassName)(r.path, 'show-all'),
                                  (r.path.style.width =
                                    r.path.parentNode.getBoundingClientRect().width - 10 + 'px'),
                                  (r.path.onblur = function() {
                                    r.contentMenuClicked
                                      ? ((r.contentMenuClicked = !1), r.path.focus())
                                      : ((0, _.removeClassName)(r.path, 'show-all'),
          ...
          U = ((t.create = function(e, t) {
            ...
            function s(e) {
              return (
                void 0 === n &&
                  (((n = document.createElement('span')).style.visibility = 'hidden'),
            ...
            var c, n, h, o, u, p, m, f, g, v, i, y, b, x, C, T;
            (this.container = e),
              (this.dom = {}),
              ...
              this._setOptions(t),
              t.autocomplete &&
                (this.autocomplete = (((c = (c = t.autocomplete) || {}).filter =
                  c.filter || 'start'),
                (c.trigger = c.trigger || 'keydown'),
                (c.confirmKeys = c.confirmKeys || [39, 35, 9]),
                (c.caseSensitive = c.caseSensitive || !1),
                (u = o = ''),
                ((p = document.createElement('div')).style.position = 'relative'),
                (p.style.outline = '0'),
                (p.style.border = '0'),
                (p.style.margin = '0'),
                (p.style.padding = '0'),
                ((m = document.createElement('div')).className = 'autocomplete dropdown'),
                ...
                (x = y = {
                  rs: (b = {
                    ...
                    show: function(e, t, n) {
                      ...
                      (this.startFrom = t),
                        ...
                        '' === o && (o = window.getComputedStyle(e).getPropertyValue('font-size')),
                        '' === u &&
                          (u = window.getComputedStyle(e).getPropertyValue('font-family')),
                        (m.style.marginLeft = '0'),
                        (m.style.marginTop = e.getBoundingClientRect().height + 'px'),
                        ...
                        p.appendChild(this.elementHint),
                        p.appendChild(m),
                    ...
                    repaint: function(e) {
                      ...
                      h = e.substring(0, this.startFrom);
                      for (var i = 0; i < t; i++) {
                        var o = this.options[i];
                        if (
                          (!c.caseSensitive && 0 === o.toLowerCase().indexOf(n.toLowerCase())) ||
                          (c.caseSensitive && 0 === o.indexOf(n))
                        ) {
                          (this.elementHint.innerText = h + n + o.substring(n.length)),
                            (this.elementHint.realInnerText = h + o);
                          break;
                        }
                      }
                      (m.style.left = s(h) + 'px'),
                        x.refresh(n, this.options),
                        (this.elementHint.style.width = s(this.elementHint.innerText) + 10 + 'px'),
                        'hidden' !== m.style.visibility &&
                          (this.elementHint.style.width =
                            s(this.elementHint.innerText) + m.clientWidth + 'px');
                    },
                  }),
                  hide: function() {
                  ...
                  refresh: function(i, e) {
                    (f.style.visibility = 'hidden'), (v = 0), (f.textContent = '');
                    var t = window.innerHeight || document.documentElement.clientHeight,
                      n = f.parentNode.getBoundingClientRect(),
                      o = n.top - 6,
                      t = t - n.bottom - 6,
                      r = ((g = []), 'function' == typeof c.filter ? c.filter : E[c.filter]),
                      n = r
                        ? e.filter(function(e) {
                            return r(
                              c.caseSensitive ? i : i.toLowerCase(),
                              c.caseSensitive ? e : e.toLowerCase(),
                              c
                            );
                          })
                        : [];
                    0 ===
                      (g = n.map(function(e) {
                        var t = document.createElement('div'),
                          ...
                          (t.__hint = e),
                          (t.textContent = ''),
                          t.appendChild(document.createTextNode(e.substring(0, i.length))),
                          document.createElement('b'));
                        return (
                          n.appendChild(document.createTextNode(e.substring(i.length))),
                          t.appendChild(n),
                          f.appendChild(t),
                          t
                        );
                      ...
                      (1 === g.length &&
                        ((i.toLowerCase() === g[0].__hint.toLowerCase() && !c.caseSensitive) ||
                          (i === g[0].__hint && c.caseSensitive))) ||
                      g.length < 2 ||
                      (y.highlight(0),
                      3 * t < o
                        ? ((f.style.maxHeight = o + 'px'),
                          (f.style.top = ''),
                          (f.style.bottom = '100%'))
                        : ((f.style.top = '100%'),
                          (f.style.bottom = ''),
                  ...
                  highlight: function(e) {
                    -1 !== i && g[i] && (g[i].className = 'item'),
                      (g[e].className = 'item hover'),
                      (i = e);
                  },
                  move: function(e) {
                    return 'hidden' === f.style.visibility
                      ? ''
                      : (v + e !== -1 && v + e !== g.length && ((v += e), y.highlight(v)),
                        g[v].__hint);
                  },
                ...
                (C = function(e) {
                  ...
                  if (null != this.elementHint && 33 !== t && 34 !== t)
                    if (27 === t)
                      b.hideDropDown(), b.element.focus(), e.preventDefault(), e.stopPropagation();
                    else {
                      var n,
                        i = (i = this.element.innerText).replace('\n', '');
                      if (0 <= c.confirmKeys.indexOf(t))
                        9 === t && 0 === this.elementHint.innerText.length && b.onTab(),
                          0 < this.elementHint.innerText.length &&
                            ...
                            r(this.element),
                            9 === t) &&
                            (b.element.focus(), e.preventDefault(), e.stopPropagation());
                      else if (13 === t)
                        if (0 === this.elementHint.innerText.length) b.onEnter();
                        else {
                          var o = 'hidden' === m.style.visibility;
                          if ((x.hide(), o))
                            return b.hideDropDown(), b.element.focus(), void b.onEnter();
                          (this.element.innerText = this.elementHint.realInnerText),
                            b.hideDropDown(),
                            r(this.element),
                            e.preventDefault(),
                        ...
                        40 === t
                          ? ((o = i.substring(this.startFrom)),
                            '' === (n = x.move(1)) && b.onArrowDown(),
                            (this.elementHint.innerText = h + o + n.substring(o.length)),
                            (this.elementHint.realInnerText = h + n),
                            e.preventDefault(),
                            e.stopPropagation())
                          : 38 === t &&
                            ((o = i.substring(this.startFrom)),
                            '' === (n = x.move(-1)) && b.onArrowUp(),
                            (this.elementHint.innerText = h + o + n.substring(o.length)),
                            (this.elementHint.realInnerText = h + n),
                            e.preventDefault(),
                            e.stopPropagation());
                ...
                (x.onmouseselection = function(e, t) {
                  (t.element.innerText = t.elementHint.innerText = h + e),
                    t.hideDropDown(),
                ...
                b)),
              this.options.history && 'view' !== this.options.mode && (this.history = new z(this)),
              this._createFrame(),
              this._createTable();
          }),
          (t.destroy = function() {
          ...
          (t._setOptions = function(t) {
            ...
            (this.options = {
              ...
              onColorPicker: function(e, t, n) {
                ...
                F()
                  ? ((i = e.getBoundingClientRect().top),
                    (i = (0, _.getWindow)(e).innerHeight - i < 300 && 300 < i),
                    new (F())({
                      parent: e,
                      color: t,
                      popup: i ? 'top' : 'bottom',
              ...
              this.setSchema(this.options.schema, this.options.schemaRefs),
              (this._debouncedValidate = (0, _.debounce)(
                this._validateAndCatch.bind(this),
                this.DEBOUNCE_INTERVAL
              )),
              t.onSelectionChange && this.onSelectionChange(t.onSelectionChange),
              (0, l.AI)(this.options.languages),
              (0, l.xC)(this.options.language);
          }),
          (t.set = function(e) {
          ...
          (t.update = function(e) {
            ...
            this.node.deepEqual(e) ||
              ...
              t.start &&
              t.end &&
              ((e = this.node.findNodeByPath(t.start.path)),
              (n = this.node.findNodeByPath(t.end.path)),
              e) &&
              n
          ...
          (t.setText = function(t) {
            try {
              this.set((0, _.parse)(t));
            } catch (e) {
              t = (0, _.tryJsonRepair)(t);
              this.set((0, _.parse)(t));
            }
          }),
          (t.updateText = function(t) {
            try {
              this.update((0, _.parse)(t));
            } catch (e) {
              t = (0, _.tryJsonRepair)(t);
              this.update((0, _.parse)(t));
            }
          ...
          (t.expand = function(e) {
            var t;
            e &&
              (t = this.node ? this.node.findNodeByPath(e.path) : null) &&
          ...
          (t._onChange = function() {
            if (!this.onChangeDisabled) {
              ...
              if (
                (this.options.onClassName && this.node.recursivelyUpdateCssClassesOnNodes(),
            ...
            if (n) {
              ...
              this.validateSchema &&
                ...
                (i = this.validateSchema.errors
                  .map(function(e) {
                    return (0, _.improveSchemaError)(e);
                  })
                  .map(function(e) {
                    return { node: n.findNode(e.dataPath), error: e, type: 'validation' };
                  })
                  .filter(function(e) {
                    return null != e.node;
                  }));
                  ...
                  return (
                    r === o.validationSequence &&
                      ...
                      'function' == typeof t.options.onValidationError &&
                        (0, _.isValidationErrorChanged)(e, t.lastSchemaErrors) &&
              ...
              .map(function(e) {
                return {
                  ...
                  error: {
                    message:
                      'object' === e[0].type
                        ? (0, l.Tl)('containsInvalidProperties')
                        : (0, l.Tl)('containsInvalidItems'),
                  },
                };
              })
              .concat(e)
            ...
            try {
              ...
              if (this.options.onValidate)
                return (
                  ...
                  ((0, _.isPromise)(t) ? t : Promise.resolve(t)).then(function(e) {
                    return Array.isArray(e)
                      ? e
                          .filter(function(e) {
                            var t = (0, _.isValidValidationError)(e);
                            return (
                              t ||
                                console.warn(
                                  'Ignoring a custom validation error with invalid structure. Expected structure: {path: [...], message: "..."}. Actual error:',
            ...
            e &&
              ...
              e.paths
                ? ((t = this),
                  ...
                  this.select(n))
                : ((i =
                    (n = e.path ? this.node.findNodeByInternalPath(e.path) : null) && e.domName
                      ? n.dom[e.domName]
                      : null),
                  e.range && i
                    ? ((e = Object.assign({}, e.range, { container: i })),
                      (0, _.setSelectionOffset)(e))
                    : n && n.focus()));
          }),
          (t.getDomSelection = function() {
            var t = k.getNodeFromTarget(this.focusTarget),
              n = this.focusTarget,
              e = t
                ...
                : null,
              i = (0, _.getSelectionOffset)();
            return (
              (i =
                (i = i && 'DIV' !== i.container.nodeName ? null : i) && i.container !== n
                  ? null
              ...
              ? ((n = this).animateTimeout &&
                ...
                (s = function() {
                  ...
                  3 < Math.abs(e)
                    ? ((a.scrollTop += e / 3),
                      (n.animateCallback = t),
                      (n.animateTimeout = setTimeout(s, 50)))
                    : (t && t(!0),
                      (a.scrollTop = r),
          ...
          (t._createFrame = function() {
            ...
            (this.frameFocusTracker = new a.$(s)),
              (this.frame.onclick = function(e) {
                var t = e.target;
              ...
              (0, _.addEventListener)(this.frame, 'focus', n, !0),
              (0, _.addEventListener)(this.frame, 'blur', n, !0),
              (this.frame.onfocusin = n),
              (this.frame.onfocusout = n),
              this.options.mainMenuBar &&
                ((0, _.addClassName)(this.contentOuter, 'has-main-menu-bar'),
                (this.menu = document.createElement('div')),
                (this.menu.className = 'jsoneditor-menu'),
                this.frame.appendChild(this.menu),
                ((s = document.createElement('button')).type = 'button'),
                (s.className = 'jsoneditor-expand-all'),
                (s.title = (0, l.Tl)('expandAll')),
                (s.onclick = function() {
                  t.expandAll(),
                    'function' == typeof e.options.onExpand &&
                      e.options.onExpand({ path: [], isExpand: !0, recursive: !0 });
                }),
                this.menu.appendChild(s),
                ((s = document.createElement('button')).type = 'button'),
                (s.title = (0, l.Tl)('collapseAll')),
                (s.className = 'jsoneditor-collapse-all'),
                (s.onclick = function() {
                  t.collapseAll(),
                    'function' == typeof e.options.onExpand &&
                      e.options.onExpand({ path: [], isExpand: !1, recursive: !0 });
                }),
                this.menu.appendChild(s),
                this.options.enableSort &&
                  (((s = document.createElement('button')).type = 'button'),
                  (s.className = 'jsoneditor-sort'),
                  (s.title = (0, l.Tl)('sortTitleShort')),
                  (s.onclick = function() {
                ...
                this.options.enableTransform &&
                  (((s = document.createElement('button')).type = 'button'),
                  (s.title = (0, l.Tl)('transformTitleShort')),
                  (s.className = 'jsoneditor-transform'),
                  (s.onclick = function() {
                ...
                this.options.search) &&
                (this.searchBox = new H(this, this.menu)),
              this.options.navigationBar &&
                ...
                (this.treePath = new J(this.navBar, this.getPopupAnchor())),
          ...
          (t._onEvent = function(e) {
            if (!k.targetIsColorPicker(e.target)) {
              var t,
                n = k.getNodeFromTarget(e.target);
              if (
                ('keydown' === e.type && this._onKeyDown(e),
                n &&
                  'focus' === e.type &&
                  ((this.focusTarget = e.target), this.options.autocomplete) &&
                ...
                'mousedown' === e.type && k.onDragStart(this.multiselection.nodes, e);
              } else
                'mousedown' === e.type &&
                  (0, _.hasParentNode)(e.target, this.content) &&
                  (this.deselect(),
          ...
          (t._updateTreePath = function(e) {
            ...
            e && e.length
              ? ((0, _.removeClassName)(this.navBar, 'nav-bar-empty'),
                (n = []),
                e.forEach(function(e) {
              ...
              : (0, _.addClassName)(this.navBar, 'nav-bar-empty');
          }),
          ...
          (t._onTreePathMenuItemSelected = function(e, t) {
            e &&
              ...
              e.node &&
              (this._updateTreePath(e.node.getNodePath()), e.node.expandTo(), e.node.focus());
          }),
          ...
          (t._updateDragDistance = function(e) {
            ...
            return (
              ...
              (this.dragDistanceEvent.hasMoved =
                this.dragDistanceEvent.hasMoved || 10 < this.dragDistanceEvent.dragDistance),
          ...
          (t._onMultiSelectStart = function(e) {
            ...
            'tree' === this.options.mode &&
              ...
              ((this.multiselection = { start: n || null, end: null, nodes: [] }),
              this._startDragDistance(e),
              (t = this).mousemove ||
                (this.mousemove = (0, _.addEventListener)(e.view, 'mousemove', function(e) {
                  t._onMultiSelect(e);
                })),
              this.mouseup ||
                (this.mouseup = (0, _.addEventListener)(e.view, 'mouseup', function(e) {
          ...
          (t._onMultiSelect = function(e) {
            ...
            e.preventDefault(),
              this._updateDragDistance(e),
              e.hasMoved &&
                ((e = k.getNodeFromTarget(e.target)) &&
                  (null == this.multiselection.start && (this.multiselection.start = e),
                ...
                this.multiselection.nodes &&
                  ...
                  this.multiselection.start === e || this.multiselection.start.isDescendantOf(e)
          ...
          (t._onMultiSelectEnd = function(e) {
            ...
            t && t.dom.menu && t.dom.menu.focus(),
              ...
              this.mousemove &&
                ((0, _.removeEventListener)(e.view, 'mousemove', this.mousemove),
                delete this.mousemove),
              this.mouseup &&
                ((0, _.removeEventListener)(e.view, 'mouseup', this.mouseup), delete this.mouseup);
          }),
          ...
          (t.select = function(e) {
            ...
            e &&
              ...
              this._selectionChangedHandler) &&
              ((e = this.getSelection()), this._selectionChangedHandler(e.start, e.end));
          }),
          (t._findTopLevelNodes = function(e, t) {
            ...
            return (
              (t && s) ||
                (e.parent
                  ? (e = (s = t = e).parent)
                  : ((t = e.childs[0]), (s = e.childs[e.childs.length - 1]))),
              e && t && s
                ? ((t = e.childs.indexOf(t)),
                  (s = e.childs.indexOf(s)),
                  (r = Math.min(t, s)),
                  (t = Math.max(t, s)),
                  e.childs.slice(r, t + 1))
                : []
            );
          }),
          (t._showAutoComplete = function(t) {
            var n,
              i = k.getNodeFromTarget(t),
              o = '';
            0 <= t.className.indexOf('jsoneditor-value') && (o = 'value'),
              '' !== (o = 0 <= t.className.indexOf('jsoneditor-field') ? 'field' : o) &&
                ((n = this),
                setTimeout(function() {
                  var e;
                  !i ||
                  !('focus' === n.options.autocomplete.trigger || 0 < t.innerText.length) ||
                  null ===
                    (e = n.options.autocomplete.getOptions(t.innerText, i.getPath(), o, i.editor))
          ...
          (t._onKeyDown = function(e) {
            ...
            9 === n &&
              ((t = this),
              setTimeout(function() {
                t.focusTarget !== l && (0, _.selectContentEditable)(t.focusTarget);
              }, 0)),
              this.searchBox &&
                (o && 70 === n
                  ? (this.searchBox.dom.search.focus(),
                    ...
                    (a = !0))
                  : (114 === n || (o && 71 === n)) &&
                    (s ? this.searchBox.previous(!0) : this.searchBox.next(!0), (a = !0))),
              this.history &&
                (o && !s && 90 === n
                  ? (this._onUndo(), (a = !0))
          ...
          (t._createTable = function() {
            var e;
            this.options.navigationBar && (0, _.addClassName)(this.contentOuter, 'has-nav-bar'),
          ...
          (t.showContextMenu = function(e, t) {
            ...
            i.push({
              ...
              this.options.onCreateMenu &&
                ...
                (i = this.options.onCreateMenu(i, { type: 'multiple', path: n[0], paths: n }))),
              new s.t(i, { close: t }).show(e, this.getPopupAnchor());
          }),
          ...
          (t.getSelection = function() {
            ...
            return (
              this.multiselection.nodes &&
                this.multiselection.nodes.length &&
                ((e = this.multiselection.nodes[0]),
                (t = this.multiselection.nodes[this.multiselection.nodes.length - 1]),
          ...
          (t.onSelectionChange = function(e) {
            'function' == typeof e &&
              (this._selectionChangedHandler = (0, _.debounce)(e, this.DEBOUNCE_INTERVAL));
          }),
          ...
          (t._getNodeInstancesByRange = function(e, t) {
            e &&
              e.path &&
              ((n = this.node.findNodeByPath(e.path)), t) &&
              t.path &&
      ...
      237: function(M, e, t) {
        ...
        function v(e) {
          for (var t in e) F(e, t) && delete e[t];
          return e;
        }
        function y(e) {
          return null === e
        ...
        var b = /^https?:\/\/\S+$/;
        function x(e) {
          return ('string' == typeof e || e instanceof String) && b.test(e);
        }
        function C(e) {
        ...
        function _(e, t) {
          ...
          if (
            ...
            return '' !== (n = N(e.nodeValue)) ? t.flush() + n : '';
          if (e.hasChildNodes()) {
        ...
        function K(e, t, n, i) {
          return e.addEventListener
            ? (void 0 === i && (i = !1),
              'mousewheel' === t && j() && (t = 'DOMMouseScroll'),
        ...
        function A(n) {
          ...
          for (; void 0 !== n[i]; )
            if ('.' === n[i])
              ...
              if ('[' !== n[i])
                throw new Error(
                  'Invalid JSON path: unexpected character "' + n[i] + '" at index ' + i
                );
              if ("'" === n[++i] || '"' === n[i]) {
                var o = n[i];
          ...
          return (
            'enum' === e.keyword &&
              ...
              (5 <
                ...
                ((t = ['(' + (n.length - 5) + ' more...)']), (n = n.slice(0, 5)).push(t)),
        ...
        function ee(e) {
          return 'object' === d(e) && Array.isArray(e.path) && 'string' == typeof e.message;
        }
        function te(e, t, n) {
          n = void 0 !== n ? n : 0;
          return (
        ...
        function oe(t) {
          var e,
            ...
            s = 0;
          return (
            'number' == typeof t.selectionStart && 'number' == typeof t.selectionEnd
        ...
        function le(n, e) {
          ...
          return n
            ? ((i = ''),
              n.title && (i += n.title),
              n.description && (0 < i.length && (i += '\n'), (i += n.description)),
              n.default &&
                (0 < i.length && (i += '\n\n'),
                (i =
                  (i += (0, s.Tl)('default', void 0, e) + '\n') +
                  JSON.stringify(n.default, null, 2))),
            ...
            : 'null' === (t = e.toLowerCase())
              ...
              : 'true' === t ||
                ('false' !== t &&
                  (/^0\d+$/.test(e) ||
                  /^0[xbo]/i.test(e) ||
                  ((t = Number(e)), (n = parseFloat(e)), isNaN(t)) ||
                  isNaN(n)
                    ? e
                    : t));
        }
        ...
        function O(e) {
          return 'object' === d(e) && null !== e && !Array.isArray(e);
        }
        function ve(e, t) {
          return -1 !== e.indexOf(t);
        }
        function ye(e, t) {
          if (e || t) {
            if (!Array.isArray(e) || !Array.isArray(t) || t.length !== e.length) return !0;
            for (var n = 0; n < e.length; n++) {
              var i = e[n],
                o = t[n];
              if (i.type !== o.type || JSON.stringify(i.error) !== JSON.stringify(o.error))
                return !0;
            }
          }
          return !1;
        ...
        e.exports = function t(e, n) {
          ...
          var o,
            ...
            u = n
              ...
              .replace(/^\0/, '')
              .split('\0'),
            a = parseInt(e.match(d), 16) || (1 !== h.length && e.match(l) && Date.parse(e)),
            s = parseInt(n.match(d), 16) || (a && n.match(l) && Date.parse(n)) || null;
          if (s) {
            if (a < s) return -1;
            if (s < a) return 1;
          }
      ...
      151: function(t, e) {
        ...
        function w(e, t) {
          if (e !== t) {
            ...
            if (!0 === E(e)) {
              ...
              for (var n = 0; n < e.length; n++) if (!1 === w(e[n], t[n])) return !1;
            } else {
              if (!0 !== S(e)) return !1;
              var i,
                o,
        ...
        function l(e) {
          (this._interpreter = e),
            (this.functionTable = {
              abs: { _func: this._functionAbs, _signature: [{ types: [0] }] },
              avg: { _func: this._functionAvg, _signature: [{ types: [8] }] },
              ceil: { _func: this._functionCeil, _signature: [{ types: [0] }] },
              contains: {
                _func: this._functionContains,
                _signature: [{ types: [2, 3] }, { types: [1] }],
              },
              ends_with: {
                _func: this._functionEndsWith,
                _signature: [{ types: [2] }, { types: [2] }],
              },
              floor: { _func: this._functionFloor, _signature: [{ types: [0] }] },
              length: { _func: this._functionLength, _signature: [{ types: [2, 3, 4] }] },
              ...
              join: { _func: this._functionJoin, _signature: [{ types: [2] }, { types: [9] }] },
              reverse: { _func: this._functionReverse, _signature: [{ types: [2, 3] }] },
              ...
              not_null: {
                ...
                _signature: [{ types: [1], variadic: !0 }],
              },
            });
        }
        var o, c, d, h, u, p, m, f, g, v, N, k, j, A, I, P, y, b, x, C, T, D, O, F, M, L, V;
        (e = e),
          (o =
          ...
          (n.prototype = {
            tokenize: function(e) {
              ...
              for (this._current = 0; this._current < e.length; )
                if (
                  ('a' <= (r = e[this._current]) && r <= 'z') ||
                  ('A' <= r && r <= 'Z') ||
                  '_' === r
                )
                  (o = this._current),
                    (t = this._consumeUnquotedIdentifier(e)),
                    i.push({ type: d, value: t, start: o });
                  ...
                  i.push({
                    ...
                    this._current++;
                else if (s(e[this._current])) (n = this._consumeNumber(e)), i.push(n);
                else if ('[' === e[this._current]) (n = this._consumeLBracket(e)), i.push(n);
                else if ('"' === e[this._current])
                  (o = this._current),
                    (t = this._consumeQuotedIdentifier(e)),
                    i.push({ type: h, value: t, start: o });
                else if ("'" === e[this._current])
                  (o = this._current),
                    (t = this._consumeRawStringLiteral(e)),
                    i.push({ type: O, value: t, start: o });
                else if ('`' === e[this._current]) {
                  var o = this._current,
                    r = this._consumeLiteral(e);
                  i.push({ type: O, value: r, start: o });
                } else if (void 0 !== M[e[this._current]]) i.push(this._consumeOperator(e));
                else if (void 0 !== L[e[this._current]]) this._current++;
                else if ('&' === e[this._current])
                  (o = this._current),
                    this._current++,
                    '&' === e[this._current]
                      ? (this._current++, i.push({ type: 'And', value: '&&', start: o }))
                      : i.push({ type: k, value: '&', start: o });
                else {
                  if ('|' !== e[this._current])
                    throw (((r = new Error('Unknown character:' + e[this._current])).name =
                      'LexerError'),
                    r);
                  (o = this._current),
                    this._current++,
                    '|' === e[this._current]
                      ? (this._current++, i.push({ type: 'Or', value: '||', start: o }))
                      : i.push({ type: j, value: '|', start: o });
                }
              return i;
            },
            ...
            _consumeQuotedIdentifier: function(e) {
              for (
                var t = this._current, n = (this._current++, e.length);
            ...
            _consumeNumber: function(e) {
              for (
                var t = this._current, n = (this._current++, e.length);
                s(e[this._current]) && this._current < n;
            ...
            _consumeLBracket: function(e) {
              ...
              return (
                ...
                '?' === e[this._current]
                  ...
                  : ']' === e[this._current]
                    ? (this._current++, { type: P, value: '[]', start: t })
                    : { type: T, value: '[', start: t }
              );
            },
            ...
            _consumeLiteral: function(e) {
              ...
              (t = (t = o(e.slice(t, this._current))).replace('\\`', '`')),
          ...
          (r.prototype = {
            parse: function(e) {
              ...
              if ('EOF' !== this._lookahead(0))
                throw ((t = this._lookaheadToken(0)),
                ((t = new Error('Unexpected token type: ' + t.type + ', value: ' + t.value)).name =
                  'ParserError'),
                t);
              return e;
            },
            ...
            expression: function(e) {
              for (
                var t = this._lookaheadToken(0),
                  n = (this._advance(), this.nud(t)),
                  i = this._lookahead(0);
                e < V[i];

              )
                this._advance(), (n = this.led(i, n)), (i = this._lookahead(0));
              return n;
            },
              ...
              switch (e.type) {
                    ...
                    (t = null),
                    {
                      ...
                      children: [
                        ...
                        (t =
                          this._lookahead(0) === u
                            ? { type: 'Identity' }
                            : this._parseProjectionRHS(V.Star)),
                      ],
                    }
                  );
                case b:
                ...
                case P:
                  return {
                    type: 'Projection',
                    children: [
                      { type: P, children: [{ type: 'Identity' }] },
                      (t = this._parseProjectionRHS(V.Flatten)),
                    ],
                  };
                case T:
                  return this._lookahead(0) === v || this._lookahead(0) === f
                    ? ((t = this._parseIndexExpression()),
                      this._projectIfSlice({ type: 'Identity' }, t))
                    : this._lookahead(0) === y && this._lookahead(1) === u
                      ? (this._advance(),
                        this._advance(),
                        {
                          type: 'Projection',
                ...
                case k:
                  return {
                    ...
                    children: [(n = this.expression(V.Expref))],
                  };
                case D:
                  for (var o = []; this._lookahead(0) !== p; )
                    this._lookahead(0) === N
                      ? ((n = { type: N }), this._advance())
                      : (n = this.expression(0)),
                      o.push(n);
                  return this._match(p), o[0];
                default:
                  this._errorToken(e);
              }
            },
              ...
              switch (e) {
                case x:
                  ...
                  return this._lookahead(0) !== y
                    ? { type: 'Subexpression', children: [t, (n = this._parseDotRHS(i))] }
                    : (this._advance(),
                      {
                        type: 'ValueProjection',
                ...
                case j:
                  return (n = this.expression(V.Pipe)), { type: j, children: [t, n] };
                case 'Or':
                  return { type: 'OrExpression', children: [t, (n = this.expression(V.Or))] };
                case 'And':
                  return { type: 'AndExpression', children: [t, (n = this.expression(V.And))] };
                case D:
                  for (var o, i = t.name, r = []; this._lookahead(0) !== p; )
                    this._lookahead(0) === N
                      ? ((o = { type: N }), this._advance())
                      : (o = this.expression(0)),
                      this._lookahead(0) === m && this._match(m),
                      r.push(o);
                  return this._match(p), { type: 'Function', name: i, children: r };
                case b:
                  i = this.expression(0);
                  return (
                    this._match(u),
                    {
                      ...
                      children: [
                        ...
                        (n =
                          this._lookahead(0) === P
                            ? { type: 'Identity' }
                            : this._parseProjectionRHS(V.Filter)),
                        i,
                      ],
                    }
                  );
                case P:
                  return {
                    type: 'Projection',
                    children: [{ type: P, children: [t] }, this._parseProjectionRHS(V.Flatten)],
                  };
                case 'EQ':
                case 'NE':
                case 'GT':
                ...
                case T:
                  ...
                  return i.type === v || i.type === f
                    ? ((n = this._parseIndexExpression()), this._projectIfSlice(t, n))
                    : (this._match(y),
                      this._match(u),
                      {
                        type: 'Projection',
                        children: [t, (n = this._parseProjectionRHS(V.Star))],
                      });
                default:
            ...
            _match: function(e) {
              ...
              if (this._lookahead(0) !== e)
                throw ((t = this._lookaheadToken(0)),
                ((e = new Error('Expected ' + e + ', got: ' + t.type)).name = 'ParserError'),
                e);
              this._advance();
            },
            ...
            _parseIndexExpression: function() {
              var e;
              return this._lookahead(0) === f || this._lookahead(1) === f
                ? this._parseSliceExpression()
                : ((e = { type: 'Index', value: this._lookaheadToken(0).value }),
                  this._advance(),
                  this._match(u),
                  e);
            },
            _projectIfSlice: function(e, t) {
              ...
              return 'Slice' === t.type
                ? { type: 'Projection', children: [e, this._parseProjectionRHS(V.Star)] }
                : e;
            },
            _parseSliceExpression: function() {
              for (
                var e, t = [null, null, null], n = 0, i = this._lookahead(0);
                i !== u && n < 3;
                ...
                if (i === f) n++;
                  ...
                  if (i !== v)
                    throw ((e = this._lookahead(0)),
                    ((e = new Error(
                      'Syntax error, unexpected token: ' + e.value + '(' + e.type + ')'
                    )).name = 'Parsererror'),
                    e);
            ...
            _parseDotRHS: function(e) {
              ...
              return 0 <= [d, h, y].indexOf(t)
                ? this.expression(e)
                : t === T
                  ? (this._match(T), this._parseMultiselectList())
                  : t === C
            ...
            _parseProjectionRHS: function(e) {
              ...
              if (V[this._lookahead(0)] < 10) t = { type: 'Identity' };
                ...
                if (this._lookahead(0) !== x)
                  throw ((n = this._lookaheadToken(0)),
                  ((n = new Error(
                    'Sytanx error, unexpected token: ' + n.value + '(' + n.type + ')'
                  )).name = 'ParserError'),
                  n);
            ...
            _parseMultiselectList: function() {
              for (var e = []; this._lookahead(0) !== u; ) {
                ...
                if (
                  (e.push(t),
                  this._lookahead(0) === m && (this._match(m), this._lookahead(0) === u))
                )
          ...
          (a.prototype = {
            ...
            visit: function(e, t) {
              ...
              switch (e.type) {
                ...
                case 'Subexpression':
                  for (u = this.visit(e.children[0], t), g = 1; g < e.children.length; g++)
                ...
                case 'Index':
                  return E(t)
                    ? void 0 === (u = t[(l = (l = e.value) < 0 ? t.length + l : l)])
                      ? null
                      : u
                    : null;
                case 'Slice':
                  ...
                  var l = e.children.slice(0),
                    ...
                    h = l[2],
                    u = [];
                  if (0 < h) for (g = d; g < c; g += h) u.push(t[g]);
                  else for (g = d; c < g; g += h) u.push(t[g]);
                  return u;
                case 'Projection':
                  var p = this.visit(e.children[0], t);
                  if (!E(p)) return null;
                  for (m = [], g = 0; g < p.length; g++)
                    null !== (i = this.visit(e.children[1], p[g])) && m.push(i);
                  return m;
                case 'ValueProjection':
                  if (!S((p = this.visit(e.children[0], t)))) return null;
                  for (
                    var m = [],
                      f = (e => {
                    ...
                    null !== (i = this.visit(e.children[1], f[g])) && m.push(i);
                  return m;
                case 'FilterProjection':
                  if (!E((p = this.visit(e.children[0], t)))) return null;
                  var v = [],
                    y = [];
                  for (g = 0; g < p.length; g++)
                    _((n = this.visit(e.children[2], p[g]))) || v.push(p[g]);
                  for (var b = 0; b < v.length; b++)
                    null !== (i = this.visit(e.children[1], v[b])) && y.push(i);
                  return y;
                case 'Comparator':
                  switch (
                    ((o = this.visit(e.children[0], t)), (r = this.visit(e.children[1], t)), e.name)
                  ) {
                    case 'EQ':
                      u = w(o, r);
                      break;
                  ...
                  return u;
                case P:
                  var x = this.visit(e.children[0], t);
                  if (!E(x)) return null;
                  var C = [];
                  for (g = 0; g < x.length; g++) E((i = x[g])) ? C.push.apply(C, i) : C.push(i);
                  return C;
                case 'Identity':
                  return t;
                case 'MultiSelectList':
                  if (null === t) return null;
                  for (m = [], g = 0; g < e.children.length; g++)
                    m.push(this.visit(e.children[g], t));
                  return m;
                case 'MultiSelectHash':
                  if (null === t) return null;
                  for (m = {}, g = 0; g < e.children.length; g++)
                    m[(a = e.children[g]).name] = this.visit(a.value, t);
                  return m;
                case 'OrExpression':
                ...
                case 'Function':
                  var T = [];
                  for (g = 0; g < e.children.length; g++) T.push(this.visit(e.children[g], t));
                  return this.runtime.callFunction(e.name, T);
                case 'ExpressionReference':
                  l = e.children[0];
                  return (l.jmespathType = k), l;
                default:
            ...
            computeSliceParams: function(e, t) {
              ...
              if (null === t) t = 1;
                ...
                throw (((r = new Error('Invalid slice, step cannot be 0')).name = 'RuntimeError'),
                r);
              var r = t < 0,
            ...
            capSliceRange: function(e, t, n) {
              return (
                t < 0 ? (t += e) < 0 && (t = n < 0 ? -1 : 0) : e <= t && (t = n < 0 ? e - 1 : e), t
              );
            },
          }),
          (l.prototype = {
            ...
            _validateArgs: function(e, t, n) {
              ...
              if (n[n.length - 1].variadic) {
                ...
                throw ((i = 1 === n.length ? ' argument' : ' arguments'),
                new Error(
                  'ArgumentError: ' + e + '() takes ' + n.length + i + ' but received ' + t.length
                ));
              for (var o = 0; o < n.length; o++) {
                for (
                  var r, s = !1, a = n[o].types, l = this._getTypeName(t[o]), d = 0;
                  d < a.length;
                  d++
                )
                  if (this._typeMatches(l, a[d], t[o])) {
                    s = !0;
                    break;
                  }
                if (!s)
            ...
            _functionMap: function(e) {
              for (var t = [], n = this._interpreter, i = e[0], o = e[1], r = 0; r < o.length; r++)
            ...
            _functionValues: function(e) {
              for (var t = e[0], n = Object.keys(t), i = [], o = 0; o < n.length; o++)
                i.push(t[n[o]]);
              return i;
            },
            ...
            _functionMaxBy: function(e) {
              for (
                var t,
                  ...
                  i = e[1],
                  o = e[0],
                  r = this.createKeyFunction(i, [0, 2]),
                  s = -1 / 0,
                  a = 0;
                a < o.length;
                a++
            ...
            createKeyFunction: function(n, i) {
              ...
              return function(e) {
                var t,
                  e = r.visit(n, e);
                if (i.indexOf(o._getTypeName(e)) < 0)
                  throw ((t =
                    'TypeError: expected one of ' + i + ', received ' + o._getTypeName(e)),
                  new Error(t));
                return e;
              };
            },
              ...
              return (
                (function l(d, c, h) {
                  ...
                  function n(e) {
                    if (d.size) {
                      f('{');
                      for (var t = c + 1, n = !0, i = d.entries(), o = i.next(); !o.done; ) {
                        var r,
                          s = o.value,
                          a = s[0],
                          s = !!e || s[1];
            ...
            typeof (n = function() {
              ...
              (r.make = function(e, t) {
                ...
                (r.prototype = {
                  ...
                  html: function(e) {
                    if (v(e)) this.elem.appendChild(e);
              ...
              function w(r, s) {
                ...
                function i(e) {
                  if (o(e) || t(e, ':disabled') || e.hasAttribute('contenteditable')) return false;
                  else
                    return (
                      e.hasAttribute('tabindex') ||
                      t(e, 'input,select,textarea,button,a[href],area[href],iframe')
                    );
                }
                function a(e) {
              ...
              return (
                document.documentElement.addEventListener('keydown', function e(t) {
                  var n = t.which || t.keyCode;
                  if (n === 27) S.trigger();
                  else if (n === 9) d.trigger(t);
                }),
                function e(i) {
                  if (y(i) || v(i)) i = { content: i };
                  var o = b();
                  var t = b();
                  var n = b();
                  var r = b();
                  ...
                  var l = g.bind(window, 'modal');
                  var d = g.bind(window, 'overlay');
                  var c = g.bind(window, 'close');
                  var h;
                  function u(e) {
                    d().hide();
                    l().hide();
      ...
      857: function(i, e, t) {
        ...
        function H(e) {
          return g.test(e) || (e && U(e.charCodeAt(0)));
        }
        let g = /^[[{\w-]$/;
        function J(e) {
          return e === o || e === _ || e === N || e === k;
        }
        function U(e) {
          return $(e) || W(e);
        }
        ...
        function Z(e, t) {
          let n = e.length;
          if (!J(e.charCodeAt(n - 1))) return e + t;
          for (; J(e.charCodeAt(n - 1)); ) n--;
        ...
        function v(p) {
          let m = 0,
            f = '';
          if (!r()) throw new C('Unexpected end of json string', p.length);
          var e = s(O);
          if ((e && g(), H(p[m]) && /[,\n][ \t\r]*$/.test(f))) {
            e || (f = Z(f, ','));
            {
              let e = !0,
                t = !0;
              for (; t; ) e ? (e = !1) : s(O) || (f = Z(f, ',')), (t = r());
              f = `[
${(f = t ? f : Q(f, ','))}
]`;
            }
          } else e && (f = Q(f, ','));
          for (; p.charCodeAt(m) === E || p.charCodeAt(m) === w; ) m++, g();
          if (m >= p.length) return f;
          throw new C('Unexpected character ' + JSON.stringify(p[m]), m);
          function r() {
            g();
            var e =
              (() => {
                if (p.charCodeAt(m) !== u) return !1;
                {
                  (f += '{'), m++, g(), v(O) && g();
                  let t = !0;
                  for (; m < p.length && p.charCodeAt(m) !== E; ) {
                    let e;
                    if (
                      (t ? ((e = !0), (t = !1)) : ((e = s(O)) || (f = Z(f, ',')), g()),
                      a(),
                      !(y() || l(!0)))
                    ) {
                      p.charCodeAt(m) === E ||
                      ...
                      void 0 === p[m]
                        ? (f = Q(f, ','))
                        : (() => {
                            throw new C('Object key expected', m);
                          })();
                      break;
                    }
                    g();
                    var n = s(M),
                      i = m >= p.length,
                      o = (n || (H(p[m]) || i ? (f = Z(f, ':')) : d()), r());
                    o || (n || i ? (f += 'null') : d());
                  }
                  return p.charCodeAt(m) === E ? ((f += '}'), m++) : (f = Z(f, '}')), !0;
                }
              })() ||
              (() => {
                if (p.charCodeAt(m) !== S) return !1;
                {
                  (f += '['), m++, g(), v(O) && g();
                  let e = !0;
                  for (; m < p.length && p.charCodeAt(m) !== w; ) {
                    e ? (e = !1) : s(O) || (f = Z(f, ',')), a();
                    var t = r();
                    if (!t) {
                      f = Q(f, ',');
                  ...
                  return p.charCodeAt(m) === w ? ((f += ']'), m++) : (f = Z(f, ']')), !0;
                }
              })() ||
              y() ||
              (() => {
                ...
                if (p.charCodeAt(m) === I) {
                  if ((m++, i())) return o(n), !0;
                  if (!V(p.charCodeAt(m))) return (m = n), !1;
                }
                for (; V(p.charCodeAt(m)); ) m++;
                if (p.charCodeAt(m) === F) {
                  if ((m++, i())) return o(n), !0;
                  if (!V(p.charCodeAt(m))) return (m = n), !1;
                  for (; V(p.charCodeAt(m)); ) m++;
                }
                if (p.charCodeAt(m) === oe || p.charCodeAt(m) === ie) {
                  if ((m++, (p.charCodeAt(m) !== I && p.charCodeAt(m) !== A) || m++, i()))
                    return o(n), !0;
                  if (!V(p.charCodeAt(m))) return (m = n), !1;
                  for (; V(p.charCodeAt(m)); ) m++;
                }
                if (i()) {
                  if (m > n)
                    return (e = p.slice(n, m)), (t = /^0\d/.test(e)), (f += t ? `"${e}"` : e), !0;
                } else m = n;
                return !1;
              })() ||
              n('true', 'true') ||
              ...
              (() => {
                if ('/' === p[m]) {
                  var e = m;
                  for (m++; m < p.length && ('/' !== p[m] || '\\' === p[m - 1]); ) m++;
                  return m++, (f += `"${p.substring(e, m)}"`), !0;
                }
              })();
            return g(), e;
          }
          function g() {
            ...
            for (
              ...
              (e =
                (e = (() => {
                  if (p.charCodeAt(m) === c && p.charCodeAt(m + 1) === h) {
                    for (; m < p.length && !((e, t) => '*' === e[t] && '/' === e[t + 1])(p, m); )
                      m++;
                    m += 2;
                  } else {
                    if (p.charCodeAt(m) !== c || p.charCodeAt(m + 1) !== c) return !1;
                    for (; m < p.length && p.charCodeAt(m) !== _; ) m++;
                  }
                  return !0;
                })()) && t());
          ...
          function t() {
            ...
            for (
              ...
              (e += t ? p[m] : ' '), m++;
            return 0 < e.length && ((f += e), !0);
          }
          function s(e) {
            return p.charCodeAt(m) === e && ((f += p[m]), m++, !0);
          }
          function v(e) {
            return p.charCodeAt(m) === e && (m++, !0);
          }
          function a() {
            g(),
              p.charCodeAt(m) === F &&
          ...
          function y(e) {
            ...
            let r = p.charCodeAt(m) === T;
            if ((r && (m++, (r = !0)), U(p.charCodeAt(m)))) {
              var s = q(p.charCodeAt(m)) ? q : K(p.charCodeAt(m)) ? K : W(p.charCodeAt(m)) ? W : $,
                a = m,
                l = f.length;
              let t = '"';
              for (m++; ; ) {
                ...
                if (s(p.charCodeAt(m))) {
                  ...
                  if (
                    ...
                    return b(), !0;
                  if (L(p.charAt(x(d - 1)))) return (m = a), (f = f.substring(0, l)), y(!0);
                  (f = f.substring(0, l)),
                    (m = d + 1),
                    (t = t.substring(0, c) + '\\' + t.substring(c));
                } else {
                  if (o && z(p[m])) {
                    if (p.charCodeAt(m - 1) === M && R.test(p.substring(a + 1, m + 2)))
                      for (; m < p.length && B.test(p[m]); ) (t += p[m]), m++;
                    return (t = Z(t, '"')), (f += t), b(), !0;
                  }
                  if (p.charCodeAt(m) === T) {
                    c = p.charAt(m + 1);
                    if (void 0 !== ge[c]) (t += p.slice(m, m + 2)), (m += 2);
                    else if ('u' === c) {
                      let e = 2;
                      for (
                        ;
                        e < 6 &&
                        (((i = p.charCodeAt(m + e)) >= P && i <= D) ||
                          (i >= te && i <= re) ||
                          (i >= ne && i <= se));

                      )
                        e++;
                      if (6 === e) (t += p.slice(m, m + 6)), (m += 6);
                      else {
                        if (!(m + e >= p.length))
                          throw ((h = void 0),
                          (h = p.slice(m, m + 6)),
                          new C(`Invalid unicode character "${h}"`, m));
                        m = p.length;
                      }
                    } else (t += c), (m += 2);
                  } else {
                    var h = p.charAt(m),
                      u = p.charCodeAt(m);
                    if (u === j && p.charCodeAt(m - 1) !== T) t += '\\' + h;
                    else if ((n = u) === _ || n === k || n === N || n === G || n === Y) t += fe[h];
                    else {
                      if (!(32 <= (n = u) && n <= 1114111))
                        throw ((u = void 0),
                        (u = h),
                        new C('Invalid character ' + JSON.stringify(u), m));
                      t += h;
                    }
                    m++;
                  }
          ...
          function b() {
            let e = !1;
            for (g(); p.charCodeAt(m) === A; ) {
              (e = !0), m++, g();
              var t = (f = Q(f, '"', !0)).length,
                n = y();
              f = n
                ? ((n = f), (t = t), (i = 1), n.substring(0, t) + n.substring(t + i))
                : Z(f, '"');
            }
            var i;
            e;
          ...
          function n(e, t) {
            return p.slice(m, m + e.length) === e && ((f += t), (m += e.length), !0);
          }
          function l(e) {
            var t = m;
            if (pe.test(p[m])) {
              for (; m < p.length && me.test(p[m]); ) m++;
              let e = m;
              for (; J(p.charCodeAt(e)); ) e++;
              if ('(' === p[e])
                return (
                  (m = e + 1),
                  r(),
                  p.charCodeAt(m) === X && (m++, p.charCodeAt(m) === ee) && m++,
                  !0
                );
            }
            for (
              ;
              m < p.length && !z(p[m]) && !U(p.charCodeAt(m)) && (!e || p.charCodeAt(m) !== M);

            )
              m++;
            if (p.charCodeAt(m - 1) === M && R.test(p.substring(t, m + 2)))
              for (; m < p.length && B.test(p[m]); ) m++;
            if (m > t) {
              for (; J(p.charCodeAt(m - 1)) && 0 < m; ) m--;
              t = p.slice(t, m);
              return (
                (f += 'undefined' === t ? 'null' : JSON.stringify(t)),
                p.charCodeAt(m) === j && m++,
                !0
              );
            }
          ...
          function x(e) {
            let t = e;
            for (; 0 < t && J(p.charCodeAt(t)); ) t--;
            return t;
          }
          function i() {
            return m >= p.length || L(p[m]) || J(p.charCodeAt(m));
          }
          function o(e) {
            f += p.slice(e, m) + '0';
          }
          function d() {
            throw new C('Colon expected', m);
          }
        }
      },
    }),
  ...
  function i(e) {
    var t = o[e];
    return (
      void 0 !== t || ((t = o[e] = { exports: {} }), n[e].call(t.exports, t, t.exports, i)),
      t.exports
    );
  }
  var n, o;
