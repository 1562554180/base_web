/*! Aliplayer - v2.8.0 - 2019-02-22 */ !(function o(a, s, l) {
...
})(
  {
                        ...
                        r = function(t) {
                          ...
                          return function() {
                            var e =
                              ...
                              r;
                            return (e /= 4294967296), (e += 0.5) * (0.5 < c.random() ? 1 : -1);
                          };
                        },
                        n = 0;
                      n < e;
        ...
        !(function() {
          ...
          (s.prototype.needsClick = function(e) {
            ...
            (s.prototype.onTouchStart = function(e) {
              ...
              if (
                ((t = this.getTargetElementFromEventTarget(e.target)), (i = e.targetTouches[0]), u)
              ) {
            ...
            (s.prototype.touchHasMoved = function(e) {
              ...
              return (
                Math.abs(t.pageX - this.touchStartX) > i || Math.abs(t.pageY - this.touchStartY) > i
              );
            }),
            ...
            (s.prototype.onTouchEnd = function(e) {
              ...
              if (
                ...
                return (
                  100 < e.timeStamp - i || (u && window.top !== window && 'input' === r)
                    ? (this.targetElement = null)
                    : (this.focus(a),
                      this.sendClick(a, e),
                      (u && 'select' === r) || ((this.targetElement = null), e.preventDefault())),
                  !1
                );
              return (
                !(
            ...
            (s.notNeeded = function(e) {
              ...
              if (
                n &&
                10 <= (r = navigator.userAgent.match(/Version\/([0-9]*)\.([0-9]*)/))[1] &&
                3 <= r[2] &&
            ...
            'function' == typeof define && 'object' == typeof define.amd && define.amd
              ...
              : void 0 !== t && t.exports
                ? ((t.exports = s.attach), (t.exports.FastClick = s))
                : (window.FastClick = s);
        })();
      },
      {},
            ...
            bindEvent: function() {
              ...
              o.on(e, 'click', function() {
                r._player._changeStream &&
                  r._switchUrl &&
                  r._player._changeStream(r._switchUrl.index, a.get('Quality_Change_Text')),
                  n.css(r.el(), 'display', 'none');
              });
        ...
        var r = e('../ui/component'),
          ...
          p = r.extend({
            ...
            bindEvent: function() {
              ...
              u.domain
                ? -1 < u.domain.indexOf('localhost') &&
                  (t = '//' + u.domain + '/build/skins/default/img/dragcursor.png')
                : (t = 'de/prismplayer/' + u.h5Version + '/skins/default/img/dragcursor.png'),
                (e.src = t),
            ...
            _canSeekable: function(e) {
              var t = !0;
              return (
                'function' == typeof this._player.canSeekable && (t = this._player.canSeekable(e)),
                t
              );
            },
            ...
            _onMouseClick: function(e) {
              ...
              a && n == o ? t._player.seek(i) : t._player._loadByUrlInner(n, i, !0),
    ...
    17: [
      function(o, e, t) {
        ...
        (e.exports.setCurrentLanguage = function(e, t, i) {
          var r = window[n];
          if (
            ((void 0 !== e && e) || (e = s()), 'en-us' != e && 'zh-cn' != e && (!i || (i && !i[e])))
          )
            throw new Error(
      ...
      function(e, t, i) {
        ...
        (unpackPlayReady = function(e) {
          var t = (function(e, t, i) {
            ...
            for (
              var o = Math.floor(e.byteLength / 2),
                a = new Uint16Array(o),
                s = new DataView(r),
                l = 0;
              l < o;
      ...
      function(e, i, t) {
        ...
        (i.exports.cache = {}),
          ...
          (i.exports.getData = function(e) {
            ...
            return (
              t || ((t = e[i.exports.expando] = i.exports.guid()), (i.exports.cache[t] = {})),
              i.exports.cache[t]
            );
          }),
      ...
      function(e, n, t) {
        ...
        (n.exports.el = function(e) {
          ...
          (n.exports.getTransformName = function(e) {
            var t,
              i,
              r = ['transform', 'WebkitTransform', 'MozTransform', 'msTransform', 'OTransform'],
              n = r[0];
            ...
            if (e) {
              ...
              if ('string' == typeof t) {
                ...
                (e.paramData || 0 == e.paramData) &&
                  ((n = e.paramData), (e.paramData = null), e.removeAttribute(n)),
                  (t = {
                    type: t,
                    target: e,
                    paramData: n,
        ...
        var r = /^((?:[a-zA-Z0-9+\-.]+:)?)(\/\/[^\/\;?#]*)?(.*?)??(;.*?)?(\?.*?)?(#.*?)?$/,
          ...
          d = {
            buildAbsoluteURL: function(e, t, i) {
              ...
              return (
                null === s.path && (s.path = i.alwaysNormalize ? d.normalizePath(n.path) : n.path),
      ...
      function(e, t, i) {
        ...
        (I.prototype.getUrl = function() {
          return (
            !this._url &&
              this.relurl &&
              (this._url = n.buildAbsoluteURL(this.baseurl, this.relurl, {
                alwaysNormalize: !0,
              })),
            this._url
          );
            ...
            for (c.lastIndex = 0; null != (i = c.exec(e)); ) {
              ...
              if (s) {
                ...
                for (var l = 0; l < s.length; l++) {
                  var u = s[l];
                  -1 !== u.indexOf('avc1')
                    ? (n.videoCodec = this.avc1toavcoti(u))
                    : -1 !== u.indexOf('hvc1')
                      ? (n.videoCodec = u)
                      : (n.audioCodec = u);
                }
              ...
              if (h) {
                ...
                (p.rawProgramDateTime = (' ' + n[5]).slice(1)),
                  ...
                  void 0 === l.programDateTime &&
                    (l.programDateTime = new Date(new Date(Date.parse(n[5])) - 1e3 * s));
              else {
      ...
      function(e, s, t) {
        ...
        (s.exports.get = function(e, t, i, r, n) {
          ...
          (s.exports.jsonp = function(e, t, i) {
            ...
            e &&
              ((n.src = e + (0 <= e.indexOf('?') ? '&' : '?') + 'callback=' + r + '&cb=' + r),
              (n.onerror = function() {
      ...
      function(e, f, t) {
        var y = e('./object'),
          ...
          _ = {
            ...
            thumbnailUrl: '',
            skinRes:
              '//' + i.domain + '/de/prismplayer-flash/' + i.flashVersion + '/atlas/defaultSkin',
          };
        (f.exports.defaultH5Layout = [
          ...
          (f.exports.createWrapper = function(e) {
            ...
            if (
              ('string' == typeof i
                ? (0 === i.indexOf('#') && (i = i.slice(1)), (t = r.el(i)))
                : (t = i),
              !t || !t.nodeName)
            )
          ...
          (f.exports.handleOption = function(e, t) {
                  ...
                  if ('controlBar' == i.skinLayout[u].name) {
                    ...
                    for (var c = i.skinLayout[u].children.length, d = 0; d < c; d++) {
                      ...
                      if (
                        ...
                        'setting' == p ||
                        'subtitle' == p ||
                        (o && ('progress' == p || 'playButton' == p || 'timeDisplay' == p))
                      ) {
                        ...
                        'progress' == p
                          ...
                          : 'timeDisplay' == p
                            ...
                            : n && 'liveDisplay' == p && (h.name = 'liveIco'),
                          s.push(h);
                      }
                    }
                    break;
            ...
            return (
              (void 0 === e.components ||
                !e.components ||
                (y.isArray(e.components) && 0 == e.components.length)) &&
                'false' != e.components &&
                (i.components = [g]),
              i
            );
    ...
    38: [
      function(e, A, t) {
        if (
          ((A.exports.USER_AGENT = navigator.userAgent),
          (A.exports.IS_IPHONE = /iPhone/i.test(A.exports.USER_AGENT)),
          ...
          (A.exports.IS_X5 = /qqbrowser/i.test(A.exports.USER_AGENT.toLowerCase())),
          (A.exports.IS_CHROME =
            /Chrome/i.test(A.exports.USER_AGENT) && !A.exports.IS_EDGE && !A.exports.IS_X5),
          (A.exports.IS_SAFARI = /Safari/i.test(A.exports.USER_AGENT) && !A.exports.IS_CHROME),
        ...
        var r, n, o, a;
        (A.exports.IS_MAC_SAFARI =
          A.exports.IS_MAC && A.exports.IS_SAFARI && !A.exports.IS_CHROME && !A.exports.HAS_FLASH),
          (A.exports.IS_IOS = A.exports.IS_IPHONE || A.exports.IS_IPAD || A.exports.IS_IPOD),
          (A.exports.IOS_VERSION = (function() {
            var e = A.exports.USER_AGENT.match(/OS (\d+)_/i);
            if (e && e[1]) return e[1];
          })()),
          (A.exports.IS_ANDROID = /Android/i.test(A.exports.USER_AGENT)),
          (A.exports.ANDROID_VERSION = (o = A.exports.USER_AGENT.match(
            /Android (\d+)(?:\.(\d+))?(?:\.(\d+))*/i
          ))
            ? ((r = o[1] && parseFloat(o[1])),
              (n = o[2] && parseFloat(o[2])),
              r && n ? parseFloat(o[1] + '.' + o[2]) : r || null)
            : null),
          (A.exports.IS_OLD_ANDROID =
            A.exports.IS_ANDROID &&
            /webkit/i.test(A.exports.USER_AGENT) &&
            A.exports.ANDROID_VERSION < 2.3),
          (A.exports.TOUCH_ENABLED = !!(
            'ontouchstart' in window ||
            (window.DocumentTouch && document instanceof window.DocumentTouch)
          )),
          (A.exports.IS_MOBILE = A.exports.IS_IOS || A.exports.IS_ANDROID),
          (A.exports.IS_H5 = A.exports.IS_MOBILE || !A.exports.HAS_FLASH),
          (A.exports.IS_PC = !A.exports.IS_H5),
          (A.exports.is_X5 =
            /micromessenger/i.test(A.exports.USER_AGENT) ||
          ...
          (A.exports.getHost = function(e) {
            ...
            var n = r.split('/');
            return (
              n && 0 < n.length && (t = n[0]), (n = t.split(':')) && 0 < n.length && (t = n[0]), t
            );
          }),
          ...
          function(e, t) {
            ...
            if (
              ((s.webkit = !!l) && (s.version = l[1]),
              u && ((a.android = !0), (a.version = u[2])),
              h && !p && ((a.ios = a.iphone = !0), (a.version = h[2].replace(/_/g, '.'))),
              d && ((a.ios = a.ipad = !0), (a.version = d[2].replace(/_/g, '.'))),
              p && ((a.ios = a.ipod = !0), (a.version = p[3] ? p[3].replace(/_/g, '.') : null)),
              v && ((a.wp = !0), (a.version = v[1])),
              f && ((a.webos = !0), (a.version = f[2])),
              g && (a.touchpad = !0),
              S && ((a.blackberry = !0), (a.version = S[2])),
              b && ((a.bb10 = !0), (a.version = b[2])),
              T && ((a.rimtabletos = !0), (a.version = T[2])),
              x && (s.playbook = !0),
              _ && ((a.kindle = !0), (a.version = _[1])),
              m && ((s.silk = !0), (s.version = m[1])),
              !m && a.android && e.match(/Kindle Fire/) && (s.silk = !0),
              E && ((s.chrome = !0), (s.version = E[1])),
              w && ((s.firefox = !0), (s.version = w[1])),
              P && ((a.firefoxos = !0), (a.version = P[1])),
              C && ((s.ie = !0), (s.version = C[1])),
              I && (c || a.ios || y || u) && ((s.safari = !0), a.ios || (s.version = I[1])),
              k && (s.webview = !0),
              c)
            ) {
              ...
              c
                ...
                : y
                  ? ((a.name = 'windows'),
                    ...
                    (o = ''),
                    (-1 < n.indexOf('Windows NT 5.0') || -1 < n.indexOf('Windows 2000')) &&
                      (o = '2000'),
                    (-1 < n.indexOf('Windows NT 5.1') || -1 < n.indexOf('Windows XP')) &&
                      (o = 'XP'),
                    (-1 < n.indexOf('Windows NT 5.2') || -1 < n.indexOf('Windows 2003')) &&
                      (o = '2003'),
                    (-1 < n.indexOf('Windows NT 6.0') || -1 < n.indexOf('Windows Vista')) &&
                      (o = 'Vista'),
                    (-1 < n.indexOf('Windows NT 6.1') || -1 < n.indexOf('Windows 7')) && (o = '7'),
                    (-1 < n.indexOf('Windows NT 6.2') || -1 < n.indexOf('Windows 8')) && (o = '8'),
                    (-1 < n.indexOf('Windows NT 6.3') || -1 < n.indexOf('Windows 8.1')) &&
                      (o = '8.1'),
      ...
      function(e, t, i) {
        ...
        (t.exports.getAbsoluteURL = function(e) {
          ...
          (t.exports.parseUrl = function(e) {
            ...
            return (
              (o.segments = i.pathname.replace(/^\//, '').split('/')),
      ...
      function(e, r, t) {
        ...
        (r.exports.formatTime = function(e) {
          ...
          return (
            ...
            (i = Math.floor(n / 60)),
            (r = n % 60),
            !(t === 1 / 0 || isNaN(t) || i === 1 / 0 || isNaN(i) || r === 1 / 0 || isNaN(r)) &&
              ('00' === (t = 10 <= t ? t : '0' + t) ? '' : t + ':') +
                (i = 10 <= i ? i : '0' + i) +
                ':' +
                (r = 10 <= r ? r : '0' + r)
          ...
          (r.exports.formatDate = function(e, t) {
            ...
            i))
              new RegExp('(' + r + ')').test(t) &&
                (t = t.replace(
                  RegExp.$1,
                  1 == RegExp.$1.length ? i[r] : ('00' + i[r]).substr(('' + i[r]).length)
                ));
            return t;
          }),
            ...
            if (
              ...
              Object.defineProperty(
                ...
                x({}, o, {
                  ...
                  set: function(e) {
                    var t,
                      i = 'string' == typeof (t = e) && !!b[t.toLowerCase()] && t.toLowerCase();
                    if (!1 === i)
              ...
              for (var o = !1; r.buffer; ) {
                ...
                switch ((o ? (o = !1) : (i = t()), r.state)) {
                  ...
                  case 'ID':
                    ...
                    if (!i) continue;
                    if (
                      ((r.cue = new s(0, 0, '')), (r.state = 'CUE'), -1 === i.indexOf('--\x3e'))
                    ) {
                      r.cue.id = i;
                      continue;
                    }
        ...
        var r = e('../lib/oo'),
          ...
          s = r.extend({
            ...
            _onPlayerLoaddata: function() {
              if (((this._LoadedData = !0), !this.buffer_flag)) {
                var e = 0,
                  t = 0;
                this.player.tag &&
                  ((e = this.player.tag.videoWidth), (t = this.player.tag.videoHeight)),
            ...
            _reportPlay: function() {
              return (
                !(this.buffer_flag || !this._LoadedData) &&
            ...
            _onPlayerPlay: function() {
              (this.playstartTime = new Date().getTime()),
                0 == this.playId && (this.playId = _.guid()),
                this.firstPlay ||
                  0 != this.pause_flag ||
                  this.seeking ||
                  (this.sessionId = _.guid()),
            ...
            _onPlayerUnderload: function() {
              if (
                (this.buffer_flag || !this.player._options || !this.player._options.autoplay) &&
                this.stucking &&
                !this.seeking
              ) {
              ...
              if (this.trackLog) {
                ...
                try {
                  Aliplayer &&
                    ...
                    ((i.args = a), Aliplayer.__logCallback__(i));
                } catch (e) {
                  console.log(e);
                }
      ...
      function(e, t, i) {
        ...
        t.exports.create = function(e, t) {
          'function' != typeof t && (t = function() {}),
            (e.readyCallback = t),
            _.setCurrentLanguage(e.language, 'h5', e.languageTexts);
          ...
          return a.player
            ...
            : (n
                ? (o = new p(a, i))
                : !i.useFlashPrism && g.isFlv(r) && g.isSupportFlv()
                  ? (o = new f(a, i))
                  : v.IS_MOBILE || (!i.useFlashPrism && !g.isRTMP(r))
                    ? i.vid && !i.source
                      ? (o = i.authInfo
                          ? new u(a, i)
                          : i.playauth || (i.accessKeyId && i.accessKeySecret)
                            ? new c(a, i)
                            : new d(a, i))
                      : g.isDash(r) && g.isSupportMSE()
                        ? (o = new y(a, i))
                        : g.isHls(r)
                          ? g.canPlayHls()
                            ? (o =
                                g.isSupportHls() &&
                                (g.isUsedHlsPluginOnMobile() ||
                                  g.isSafariUsedHlsPlugin(i.useHlsPluginForSafari))
                                  ? new h(a, i)
                                  : new s(a, i))
                            : g.isSupportHls()
                              ? (o = new h(a, i))
                              : v.os.pc
                                ? i.userH5Prism || i.useH5Prism || (o = new l(a, i))
                                : (o = new s(a, i))
                          : (o = (v.os.pc, new s(a, i)))
                    : (o = new l(a, i)),
              o);
      ...
      function(e, t, i) {
        ...
        (l.prototype.createEl = function() {
          'AUDIO' !== this.tag.tagName &&
            ((this._el = this.tag), (this.tag = n.prototype.createEl.call(this, 'audio')));
          var t = this._el,
            e = this.tag;
          e.player = this;
    ...
    50: [
      function(e, t, i) {
        ...
        t.exports.handle = function(e) {
          var t = this;
          e.paramData.notPlay || this._enteredProgressMarker || t.play(),
      ...
      function(e, t, i) {
        ...
        t.exports.handle = function(e) {
          ...
          t._options.autoplay ||
            ...
            !t.paused() ||
            (t.trigger(r.Private.H5_Loading_Hide), t.trigger(r.Private.Play_Btn_Show)),
      ...
      function(e, t, i) {
        ...
        t.exports.handle = function(e) {
          ...
          if (((t.waiting = !1), t._clearTimeout(), t.checkOnline())) {
            ...
            if (
              (n.error.code &&
                ((i = n.error.code), (r = d.VideoErrorCode[n.error.code]), (o = i + ' || ' + o)),
              t._options.isLive)
            )
              ...
              if (i < 4) {
                if (3 == i && t._firstDecodeError) {
                  ...
                  return (
                    t._loadByUrlInner(t._options.source, a, !0), void (t._firstDecodeError = !1)
                  );
                }
                s = d.VideoErrorCodeText[i];
              } else
                t._eventState == d.SUSPEND
                  ? ((s = p.get('Error_Load_Abort_Text')), (r = d.ErrorCode.RequestDataError))
                  : t._eventState == d.LOAD_START
                    ? ((s = p.get('Error_Network_Text')),
                      0 < t._options.source.indexOf('auth_key') &&
                        (s = s + '\uff0c' + p.get('Error_AuthKey_Text')),
                      (r = d.ErrorCode.StartLoadData))
                    : t._eventState == d.LOADED_METADATA &&
                      ((s = p.get('Error_Play_Text')), (r = d.ErrorCode.PlayingError));
              (s = s + '\uff0c' + p.get('Error_Retry_Text')),
                1 < t._urls.length &&
    ...
    64: [
      function(e, t, i) {
        ...
        t.exports.handle = function(e) {
          var t = this;
          t.trigger(n.Private.H5_Loading_Hide),
            t.trigger(n.Private.Cover_Hide),
            t.trigger(n.Private.Info_Hide),
            (t.waiting = !1),
            (t._ended = !1),
            (t._liveRetryCount = 0),
            (t._vodRetryCount = 0),
          ...
          if (
            ...
            t._checkTimeoutHandle &&
              (clearTimeout(t._checkTimeoutHandle), (t._checkTimeoutHandle = null)),
            t._waitingLoadedHandle &&
              (clearTimeout(t._waitingLoadedHandle), (t._waitingLoadedHandle = null)),
          ...
          t.trigger(n.Private.AutoStreamHide),
            t.trigger(n.Player.Playing),
            t.trigger(n.Private.Play_Btn_Hide),
            t.trigger(n.Private.Error_Hide);
        };
      },
      {
        '../../event/eventtype': 48,
      ...
      function(e, t, i) {
        ...
        t.exports.handle = function(e) {
          ...
          if (
            ...
            r < t && !i.paused()
              ? (i.pause(), a.trigger(this.tag, n.Video.ManualEnded))
              : r - t < 0.2 &&
                0 <= o.browser.version.indexOf('49.') &&
                !i.paused() &&
                (i.pause(), a.trigger(this.tag, n.Video.ManualEnded));
          }
          i._playingSlientPause &&
            (clearTimeout(i._playingSlientPause), (i._playingSlientPause = null)),
        ...
        t.exports.handle = function(e) {
          ...
          if (!i._options.isLive) {
            var t = this.getCurrentTime(),
              r = this.getDuration();
            if (r - t < 0.2 || r < t)
              return i.pause(), (i._ended = !0), void s.trigger(this.tag, o.Video.ManualEnded);
          }
              ...
              if (
                ...
                if (
                  ...
                  0 < this._options.progressMarkers.length &&
                    this.trigger(b.Private.ProgressMarkerLoaded, this._options.progressMarkers),
        ...
        (w.prototype.initPlay = function(e) {
          ...
          (w.prototype.checkOnline = function() {
            ...
            if (0 == navigator.onLine) {
              ...
              return (
                (e.display_msg = y.get('Error_Offline_Text')), this.trigger(b.Player.Error, e), !1
              );
            }
            return !0;
          }),
          ...
          (w.prototype.renderUI = function() {}),
          (w.prototype.switchUrl = function() {
          ...
          (w.prototype.loadByUrl = function(e, t, i, r) {
            this._monitor && this._monitor.reset(),
              (this._isError = !1),
              (this._duration = 0),
              this._clearTimeout(),
              ...
              this._options.autoplay || i
                ? this.trigger(b.Player.Play)
                : this.trigger(b.Player.Pause);
            var n = this;
            this._options.isLive ||
              s.one(this.tag, b.Video.CanPlay, function(e) {
          ...
          (w.prototype._initPlayBehavior = function(e, t) {
            ...
            if (!p.validateSource(t)) {
              ...
              return (
                (i.display_msg = y.get('Error_Invalidate_Source')),
            ...
            return (
              ...
              this._options.autoplay || this._options._autoplay || this._options.preload || e
                ? ((this._options._preload = !0),
                  this._initLoad(t),
                  (this._options.autoplay || this._options._autoplay) && this._startPlay())
                : this.trigger(b.Private.Play_Btn_Show),
              !0
            );
          }),
            ...
            this.getMetaData(),
              e &&
                (this._isPreload() && !r.IS_MOBILE
                  ? this.trigger(b.Private.H5_Loading_Show)
                  : (this.trigger(b.Private.H5_Loading_Hide),
                    this.trigger(b.Private.Play_Btn_Show)),
          ...
          (w.prototype._clearLiveErrorHandle = function() {
            this._liveErrorHandle &&
              (clearTimeout(this._liveErrorHandle), (this._liveErrorHandle = null));
          }),
            ...
            if (
              (0 < e.indexOf('m3u8')
                ? '' != this.tag.canPlayType('application/x-mpegURL') ||
                  p.isSupportHls() ||
                  (t = y.get('Error_Not_Support_M3U8_Text'))
                : 0 < e.indexOf('mp4')
                  ? '' == this.tag.canPlayType('video/mp4') &&
                    (t = y.get('Error_Not_Support_MP4_Text'))
                  : (p.isRTMP(e) || p.isFlv(e)) &&
                    r.IS_MOBILE &&
                    (t = y.get('Error_Not_Support_Format_On_Mobile')),
              t)
            ) {
              var i = {
                mediaId: this._options.vid ? this._options.vid : '',
          ...
          (w.prototype.log = function(e, t) {
            ...
            if (this._monitor)
              return (
                this._options && ((i = this._options.vid || '0'), (r = this._options.from || '0')),
                this._monitor.updateVideoInfo({
                  video_id: i,
                  album_id: 0,
                  source: this._options.source,
          ...
          (w.prototype._overrideNativePlay = function() {
            ...
            this.tag.play = function() {
              if (!n._options.source) {
                ...
                return (
                  n._options.vid
                    ? (e.display_msg = y.get('Error_Vid_Empty_Source'))
                    : (e.display_msg = y.get('Error_Empty_Source')),
          ...
          (w.prototype._executeReadyCallback = function() {
            try {
              this._options.autoplay ||
                ...
                (this.trigger(b.Private.H5_Loading_Hide), this.trigger(b.Private.Play_Btn_Show)),
          ...
          (w.prototype._clearTimeout = function() {
            this._checkTimeoutHandle &&
              (clearTimeout(this._checkTimeoutHandle), (this._checkTimeoutHandle = null)),
              this._waitingTimeoutHandle &&
                (clearTimeout(this._waitingTimeoutHandle), (this._waitingTimeoutHandle = null)),
              this._clearLiveErrorHandle();
          }),
          (t.exports = w);
      },
            ...
            if (e && s.isArray(e) && 0 < e.length)
              for (var i = 0; i < e.length; i++) {
                ...
                var n = new (Function.prototype.bind.apply(constr, args))(),
                  o = n[d.createEl];
                o && 'function' == typeof o && o.call(n, t.el()),
        ...
        var l = function(e, t) {
            if (t) {
              var i,
                ...
                n = r.type,
                o = r.data;
              ((i = n) == c.Video.LoadStart ||
                i == c.Video.LoadedData ||
                i == c.Video.LoadedMetadata) &&
                (n = d.loading),
                p(e, n);
          ...
          p = function(e, t) {
            void 0 !== r[t] &&
              (t != r.pause || (e._status != r.error && e._status != r.ended)) &&
              (e._status = t);
          };
        t.exports = n;
      },
      ...
      function(e, t, i) {
        var r = e('../../lib/ua'),
          ...
          o = function(e, t) {
            ...
            t
              ? ((height = n), (width = o))
              : ((height = i.indexOf('%') ? i : i + 'px'), (width = r.indexOf('%') ? r : r + 'px')),
              (e.tag.style.width = o),
          ...
          (t.exports.adaptX5Play = function(e) {
            r.os.android &&
              ...
              void 0 !== e._options.x5_fullscreen &&
                ...
                (e.tag.setAttribute('x5-video-player-fullscreen', e._options.x5_fullscreen),
                n.addClass(e.tag, 'x5-full-screen')),
              'top' == e._options.x5_video_position && n.addClass(e.tag, 'x5-top-left'),
              void 0 !== e._options.x5_orientation &&
                e.tag.setAttribute('x5-video-orientation', e._options.x5_orientation));
          });
      },
      {
        '../../lib/dom': 24,
        ...
        t.exports.inject = function(e, t, i, r, a, n, o) {
          ...
          if (n || ((l = s), !e._drm && y.isDash(l))) {
            ...
            (t.prototype._checkDrmReady = function() {
              ...
              (t.prototype.pause = function(e) {
                return (
                  this._checkDrmReady(), (this._isManualPause = e || !1), this.tag.pause(), this
                );
              }),
              ...
              (t.prototype.initPlay = function(e) {
                if (f.contentProtocolMixed(s)) {
                  ...
                  return (
                    (t.display_msg = v.get('Request_Block_Text')),
                ...
                function i(i, t) {
                  var r = !i._drm,
                    n = function() {
                      ...
                      h.DRMKeySystem[4] &&
                        ((e.drm.servers[h.DRMKeySystem[5]] = 'https://foo.bar/drm/widevine'),
                ...
                (that = this)._isLoadedDrm && 'undefined' != typeof shaka
                  ...
                  : (this.trigger(g.Private.H5_Loading_Show),
                    function(e) {
                      ...
                      p.domain
                        ? -1 < p.domain.indexOf('g-assets.daily')
                          ? (i =
                              'http://' + p.domain + '/de/prismplayer/' + p.h5Version + '/drm/' + t)
                          : -1 < p.domain.indexOf('localhost') &&
                            (i = 'http://' + p.domain + '/build/drm/' + t)
                        : (i = 'de/prismplayer/' + p.h5Version + '/drm/' + t);
                      var r = this;
                      d.loadJS(i, function() {
          ...
          function c(t, i) {
            ...
            i.code == shaka.util.Error.Code.EXPIRED
              ? ((n = h.ErrorCode.AuthKeyExpired), (r = v.get('DRM_License_Expired')))
              : i.code == shaka.util.Error.Code.HTTP_ERROR
                ? ((n = h.ErrorCode.NetworkError), (r = v.get('Http_Error')))
                : i.code == shaka.util.Error.Code.HTTP_ERROR
                  ? ((n = h.ErrorCode.LoadingTimeout), (r = v.get('Http_Timeout')))
                  : i.category == shaka.util.Error.NETWORK &&
                    ((n = h.ErrorCode.NetworkError), (r = v.get('Error_Network_Text')));
            !(function() {
              if (
                (setTimeout(function() {
      ...
      function(e, t, i) {
        var n = e('../../ui/component'),
          ...
          m = n.extend({
            init: function(e, t) {
              if (
                (void 0 === t.skinLayout && (t.skinLayout = p.defaultFlashLayout),
                n.call(this, this, t),
                (this._id = 'prism-player-' + o.guid()),
                (this.tag = e),
                (this._el = this.tag),
                (this._childrenUI = [f, y]),
                this.initChildren(),
                (this.id = this._id),
                (window[this.id] = this),
            ...
            _initPlayer: function() {
              var e =
                '//' + c.domain + '/de/prismplayer-flash/' + c.flashVersion + '/PrismPlayer.swf';
              c.domain
                ? -1 < c.domain.indexOf('localhost') &&
                  (e = '//' + c.domain + '/build/flash//PrismPlayer.swf')
                : (e = 'de/prismplayer-flash/' + c.flashVersion + '/PrismPlayer.swf');
            ...
            _comboFlashVars: function() {
              ...
              var n = this._options,
                o = {
                  ...
                  videoInfoService: n.videoInfoService
                    ? n.videoInfoService
                ...
                a = [];
              return (
                void 0 !== n.rtmpBufferTime && (o.rtmpBufferTime = n.rtmpBufferTime),
          ...
          if (n || ((a = o), !e._flv && c.isFlv(a))) {
            ...
            (e._Type = t),
              ...
              (t.prototype.play = function(e) {
                ...
                if ((this.trigger(v.Private.Cover_Hide), this._options.isLive && e))
                  ...
                  this.tag.paused &&
                    (this._hasLoaded || (this.getMetaData(), this._flv.load()), this._flv.play());
                }
                return this;
              }),
              (t.prototype.replay = function() {
                return (
                  this._checkFlvReady(), this._loadByUrlInner(this._options.source, 0, !0), this
                );
              }),
              ...
              (t.prototype.pause = function(e) {
                return (
                  this._checkFlvReady(), (this._isManualPause = e || !1), this._flv.pause(), this
                );
              }),
              ...
              (t.prototype.initPlay = function(e) {
                if (
                  (d.browser.safari && this.trigger(v.Private.Snapshot_Hide),
                  f.contentProtocolMixed(o))
                ) {
                  var t = {
                    mediaId: this._options.vid ? this._options.vid : '',
                    error_code: h.ErrorCode.InvalidSourceURL,
                  ...
                  return (
                    (t.display_msg = y.get('Request_Block_Text')),
                    void this.trigger(v.Player.Error, t)
                  );
                }
                ...
                (that = this)._isLoadedFlv && 'undefined' != typeof Hls
                  ...
                  : (this.trigger(v.Private.H5_Loading_Show),
                    function(e, t) {
            ...
            var l = function(c, e) {
              ...
              e.on(flvjs.Events.ERROR, function(e, t, i) {
                ...
                if (t == flvjs.ErrorDetails.NETWORK_EXCEPTION) {
                  ...
                  !o ||
                  (0 != o.toLowerCase().indexOf('http://') &&
                    0 != o.toLowerCase().indexOf('https://'))
                    ? ((r = h.ErrorCode.InvalidSourceURL),
                      (n = y.get('Error_Invalidate_Source_Widthout_Protocal')),
                      (d = !0))
                    : navigator.onLine
                      ? ((r = h.ErrorCode.RequestDataError), (n = y.get('Maybe_Cors_Error')))
                      : ((r = h.ErrorCode.NetworkError), (n = y.get('Error_Network_Text')));
                ...
                var a = function() {
                  if (
                    ...
                    c.logError(e),
                      (e.display_msg = n),
                      p.cityBrain && (c.flv = null),
                      c.trigger(v.Player.Error, e);
                  }
                };
                if (c._options && c._options.isLive && !d) {
                  ...
                  if (s.liveRetry > c._liveRetryCount) {
                    ...
                    c.trigger(v.Player.LiveStreamStop), (c._liveErrorHandle = setTimeout(a, 500));
                } else {
      ...
      function(e, t, i) {
        ...
        t.exports.inject = function(e, t, i, r, o, n) {
          ...
          if (
            ...
            !e._hls &&
              y.isHls(l) &&
              (!y.canPlayHls() || y.isSafariUsedHlsPlugin(u) || y.isUsedHlsPluginOnMobile()))
          ) {
            var l, u;
            (e._Type = t),
              (e._superType = i),
              ...
              (t.prototype.pause = function(e) {
                return (
                  this.tag && (this._checkHlsReady(), this.tag.pause(), this._hls.stopLoad()),
              ...
              (t.prototype.initPlay = function(e) {
                ...
                function i(a, e) {
                  ...
                  o && (i._sce_dlgtqredxx = o),
                  (i.enableWorker = a._options.enableWorker),
                  (i.debug = a._options.debug),
                  a._options.hlsOption))
                    i[n] = a._options.hlsOption[n];
                  v.IS_IE11 && o && (i.enableWorker = !1),
                    (a._hls = new Hls(i)),
                    c(a, a._hls),
                    (a._loadSourced = !1),
                    (a._options.autoplay || a._options.preload || e) &&
                      ((a._loadSourced = !0), a._hls.loadSource(a._options.source)),
                    ...
                    a._hls.on(Hls.Events.LEVEL_SWITCHED, function(e, t) {
                      if (a._qualityService) {
                        ...
                        n &&
                          a.trigger(_.Private.QualityChange, {
                            levelSwitch: !0,
                            url: i,
                            desc: n,
                          });
                    ...
                    a._options.hlsFragChangedEmpty &&
                      a._hls.on(Hls.Events.FRAG_CHANGED, function(e, t) {
                        var i = {
                          startOffset: 0,
                ...
                this._isLoadedHls && 'undefined' != typeof Hls
                  ...
                  : (this.trigger(_.Private.H5_Loading_Show),
                    function(e, t, i) {
                      ...
                      var n =
                        'https://' + p.domain + '/de/prismplayer/' + p.h5Version + '/hls/' + r;
                      p.domain
                        ? -1 < p.domain.indexOf('g-assets.daily')
                          ? (n =
                              'http://' + p.domain + '/de/prismplayer/' + p.h5Version + '/hls/' + r)
                          : -1 < p.domain.indexOf('localhost') &&
                            (n = 'http://' + p.domain + '/build/hls/' + r)
                        : (n = 'de/prismplayer/' + p.h5Version + '/hls/' + r);
                      var o = this;
                      d.loadJS(n, function() {
                        e.apply(o);
                      });
              ...
              e.on(Hls.Events.ERROR, function(e, t) {
                if (
                  ...
                  if (t.details == Hls.ErrorDetails.MANIFEST_LOAD_ERROR) {
                    ...
                    t.response
                      ? '404' == t.response.code
                        ? ((i = h.ErrorCode.NotFoundSourceURL), (r = g.get('Error_Not_Found')))
                        : '403' == t.response.code
                          ? ((i = h.ErrorCode.AuthKeyExpired), (r = g.get('Error_AuthKey_Text')))
                          : '0' == t.response.code && navigator.onLine
                            ? ((i = h.ErrorCode.RequestDataError),
                              (r = r + '\uff0c' + g.get('Maybe_Cors_Error')))
                            : (r = g.get('Error_Load_M3U8_Failed_Text'))
                      : (r = g.get('Error_Load_M3U8_Failed_Text'));
                  } else
                    t.details == Hls.ErrorDetails.MANIFEST_LOAD_TIMEOUT
                      ? ((n = !0), (r = g.get('Error_Load_M3U8_Timeout_Text')))
                      : t.details == Hls.ErrorDetails.MANIFEST_PARSING_ERROR ||
                        t.details == Hls.ErrorDetails.MANIFEST_INCOMPATIBLE_CODECS_ERROR
                        ? ((n = !0), (r = g.get('Error_M3U8_Decode_Text')))
                        : t.type == Hls.ErrorTypes.NETWORK_ERROR
                          ? ((i = h.ErrorCode.NetworkError), (r = g.get('Error_Network_Text')))
                          : (t.type != Hls.ErrorTypes.MUX_ERROR &&
                              t.type != Hls.ErrorTypes.MEDIA_ERROR) ||
                            ((i = h.ErrorCode.PlayDataDecode), (r = g.get('Error_TX_Decode_Text')));
                  r = r + '(' + t.details + ')';
                  var o = function() {
                    if (
                      (u.pause(),
                  ...
                  if (u._options && u._options.isLive) {
                    ...
                    if (a.liveRetry > u._liveRetryCount) {
                      ...
                      u._liveRetryCount++,
                        f.sleep(1e3 * s),
                        n && u._loadByUrlInner(u._options.source, 0, !0);
                    } else
                      u.trigger(_.Player.LiveStreamStop), (u._liveErrorHandle = setTimeout(o, 500));
                  } else {
                    if (!u._vodRetryCount && navigator.onLine) {
                      var l = u.getCurrentTime();
                      return (
                        u._loadByUrlInner(u._options.source, l, !0), void (u._vodRetryCount = 1)
                      );
                    }
                    o();
                  }
      ...
      function(e, t, i) {
        var l = e('../../lib/io'),
          ...
          f = function(e, r, n) {
            ...
            var a =
                i + ('Signature=' + d.AliyunEncodeURI(d.makeChangeSiga(o, e.accessSecret, 'POST'))),
              s = d.makeUTF8sort(o, '=', '&');
            l.post(
              a,
              s,
              ...
              (this._authKeyExpiredHandle = new a(this)),
                'mp3' == t.format
                  ? ((t.height = 'auto'),
                    ...
                    r.call(this, e, t))
                  : ((t._native = !1), c.call(this, e, t));
            },
          });
        (_.prototype.loadData = function(e, t) {
          if (
            'undefined' != typeof _sce_r_skjhfnck ||
            ('' != e.format && 'm3u8' != e.format && 1 != this._options.encryptType)
          )
            this._loadData(e, t);
          else {
            ...
            s.domain
              ? -1 < s.domain.indexOf('g-assets.daily')
                ? (r = 'http://' + s.domain + '/de/prismplayer/' + s.h5Version + '/hls/' + i)
          ...
          (_.prototype._loadData = function(o, a) {
            ...
            if (
              ...
              ('' != o.format && 'm3u8' != o.format) || 1 != this._options.encryptType)
            )
              o.rand = n.randomUUID();
            else {
                  ...
                  if (
                    ...
                    l._mtsError_message(
                      l,
                      {
                        ...
                        Message:
                          y.get('Error_Vod_URL_Is_Empty_Text') +
                    ...
                    l.log('COMPLETEFETCHDATA', {
                      ...
                      (l._urls = e.urls),
                      (l._currentPlayIndex = v.findSelectedStreamLevel(
                        l._urls,
                        o.defaultDefinition
                      ));
                    ...
                    if (
                      ((l._options.source = i),
                      (l.encType = ''),
                      l.trigger(g.Private.PREPARE, t.definition),
                      ...
                      v.isFlv(i)
                        ? h.inject(l, _, c, l._options)
                        : v.isDash(i)
                          ? f.inject(l, _, c, l._options)
                          : l._player._executeReadyCallback();
                    l._authKeyExpiredHandle.tick(d.AuthKeyRefreshExpired),
                      l.trigger(g.Private.SourceLoaded, t),
                      l.initPlay(a),
                      l.trigger(g.Private.ChangeURL),
          ...
          (_.prototype._changeStream = function(e, t) {
            this._urls.length > e &&
              ...
              this.trigger(g.Private.QualityChange, t || y.get('Quality_Change_Fail_Switch_Text')));
          }),
          ...
          (_.prototype._mtsError_message = function(e, t, i) {
            ...
            -1 < o.indexOf('InvalidParameter.Rand') || -1 < o.indexOf('"Rand" is not valid.')
              ? (d.ErrorCode.EncrptyVideoNotSupport, (a = y.get('Error_Not_Support_encrypt_Text')))
              : -1 < o.indexOf('SecurityToken.Expired')
                ? (d.ErrorCode.AuthKeyExpired, (a = y.get('Error_Playauth_Expired_Text')))
                : -1 < o.indexOf('InvalidVideo.NoneStream') &&
                  (d.ErrorCode.URLsIsEmpty,
                  (a =
                    y.get('Error_Fetch_NotStream') +
                    '(' +
                    r._options.format +
                    '|' +
            ...
            t.sri && (l.sri = t.sri),
              r.logError(l),
              (l.display_msg = a || y.get('Error_Vod_Fetch_Urls_Text')),
              r.trigger('error', l),
              ...
              n.stringify(
                r(
                  i +
                    ...
                    '&' +
                    c.exports.AliyunEncodeURI(c.exports.makeUTF8sort(e, '=', '&')),
                  t + '&'
                )
              )
            );
        ...
        t.exports.getPlayAuth = function(e, i, r, n) {
          ...
          var t = c.randomUUID(),
            ...
            a =
              c.makeUTF8sort(o, '=', '&') +
              '&Signature=' +
              c.AliyunEncodeURI(c.makeChangeSiga(o, e.accessKeySecret)),
      ...
      function(e, t, i) {
        ...
        t.exports.getDataByAuthInfo = function(e, o, a, s) {
          ...
          e.authInfo && (i.AuthInfo = e.authInfo),
            ...
            e.playConfig && (i.PlayConfig = e.playConfig),
            e.reAuthInfo && (i.ReAuthInfo = e.reAuthInfo);
          var r =
              u.makeUTF8sort(i, '=', '&') +
              '&Signature=' +
              ...
              if (e) {
                ...
                var n = (function(e, t) {
                  ...
                  var u,
                    ...
                    d = [];
                  return (
                    (d = 0 < n.length ? n : 0 < r.length ? r : 0 < i.length ? i : o),
                    'asc' == t && d.reverse(),
                    d
                  );
              ...
              this.service.loadData(
                ...
                function(e) {
                  (n._serverRequestId = e.requestId),
                    ...
                    n._authKeyExpiredHandle.tick(l.AuthKeyRefreshExpired);
                },
                function(e) {
                  console.log(e);
                }
        ...
        (a.prototype.startMeta = function() {
          ...
          (a.prototype.start = function() {
            if ('rectRunning' != this._status) {
              ...
              var i = this;
              this._aiContainer ||
                ((this._aiContainer = new n(this._player)),
                  ...
                  if (e && 0 < e.length) {
                    for (var t = null, i = [], r = 0; r < e.length; r++) {
                      ...
                      n.tid &&
                        ...
                        t || ((t = this._createRect(n)), i.push(t)),
          ...
          (a.prototype._findAvailableSetting = function() {
            ...
            for (
              var e = this._player.getCurrentTime(),
                t = 1 * this._absoluteDate + 1e3 * e,
                i = [],
                r = this._aiSetting.length,
                n = 0,
                o = n;
              o < r;
              o++
          ...
          (a.prototype._startQueryAiSetting = function(e, u, c) {
            var t,
              d = this._player._options.ai;
            if (d.boxes)
              return (
                ((t = this)._aiSetting = t._player._options.ai.boxes), void (c && (c(), (c = null)))
              );
            var p = this,
              i = o.parseUrl(e),
              h = i.segments,
              ...
              y = function() {
                ...
                var i = 1 * p._queryStartDate + 2e3,
                  ...
                  o = function() {
                    'cancel' != p._status &&
                      (p.__retrieveHandlerId = setTimeout(function() {
                        y.call(p);
                      }, 500));
                  };
                ...
                (a = function(e) {
                  ...
                  'function' == typeof (l = d.meta).getMeta
                    ? l.getMeta(n, a, s)
                    : v.post(l.url, JSON.stringify(n), a, s);
              };
            y();
          }),
          (a.prototype._cancelQueryAiSetting = function() {
            this.__retrieveHandlerId &&
      ...
      function(e, t, i) {
        ...
        (r.prototype._notifyDefaultValue = function(e) {
          !this._defaultTrack && 0 < e.length && (this._defaultTrack = e[0]),
            this._defaultTrack &&
              this._player.trigger(n.Private.SelectorUpdateList, {
                type: 'audio',
          ...
          (r.prototype['switch'] = function(e) {
            if (this._player._hls) this._player._hls.audioTrack = 1 * e;
              ...
              for (
                var t = this._video.audioTracks ? this._video.audioTracks.length : 0, i = 0;
                i < t;
                i++
              ) {
          ...
          a = function(e) {
            ...
            e.on(r.Private.ChangeURL, function() {
              ...
              e.on(r.Player.CanPlay, function() {
                t._player._drm ||
                  (t._isCreated ||
                    ((t.tracks = t._getTracks()), e.trigger(r.Player.TextTrackReady, t.tracks)),
        ...
        (a.prototype._adaptiveCueStype = function() {
          ...
          (a.prototype.close = function() {
            for (
              ...
              'expired' != i.mode &&
                ('showing' == i.mode && (this._backupCC = i), (i.mode = 'disabled'));
            }
          }),
          (a.prototype.open = function() {
            if (this.tracks && !(this.tracks.length < 2)) {
              ...
              return (
                e || ((e = this.tracks[1].value), (t = this.tracks[1].text)), this['switch'](e), t
              );
            }
          }),
          ...
          (a.prototype._getTracks = function() {
            ...
            for (
              var t = [this._defaultTrack], i = l.get(u.SelectedCC), r = '', n = !1, o = 0;
              o < e;
              o++
            ) {
              ...
              if ('expired' != a.mode && 'subtitles' == a.kind) {
                ...
                a['default'] && ((this._defaultTrack = s), (n = !0)),
                  s.value == i && (r = s),
                  t.push(s);
              }
            }
          ...
          (a.prototype['switch'] = function(e) {
            if ((this.close(), 'off' != e)) {
              for (
                var t = this._video && this._video.textTracks ? this._video.textTracks.length : 0,
                  i = 0;
                i < t;
                i++
              ) {
                    ...
                    : 'webkitIsFullScreen' in document
                      ...
                      : 'webkitDisplayingFullscreen' in document
                        ...
                        : 'mozFullScreen' in document
                          ...
                          : 'mozfullScreen' in document
                            ? (e.isFullScreen = 'mozfullScreen')
                            : 'MSFullScreen' in document && (e.isFullScreen = 'MSFullScreen'),
                ...
                ? (t[e.requestFn](),
                  (this._requestFullScreenTimer = setTimeout(function() {
                    i.isFullScreenChanged ||
                      (d.apply(i), i._player.trigger(s.Player.RequestFullScreen)),
                      (i._requestFullScreenTimer = null);
                  }, 1e3)))
                : (d.apply(i), this._player.trigger(s.Player.RequestFullScreen)),
              this._player
            );
          }
                ...
                ? (document[e.cancelFn](),
                  (t._cancelFullScreenTimer = setTimeout(function() {
                    t.isFullScreenChanged ||
                      (p.apply(t), t._player.trigger(s.Player.CancelFullScreen)),
        ...
        (r.prototype.validate = function() {
          ...
          (r.prototype.getBaseTime = function() {
            ...
            return -1 == this.seekTime
              ? o.parseTime(this.currentTimeDisplay)
              : o.parseTime(this.liveShiftStartDisplay) + this.seekTime;
          }),
          ...
          (r.prototype._switchLiveShiftPlayer = function(e) {
            ...
            if (a.isHls(r)) t = r;
              ...
              return (
                ...
                l.inject(this._player, o, n, this._player._options, '', !0),
                i
              );
            }
            return t;
          ...
          (r.prototype.dispose = function() {
            this.stop(),
              this._localLiveTimeHandler &&
                (clearTimeout(this._localLiveTimeHandler), (this._localLiveTimeHandler = null)),
              (this._player = null);
          }),
          (t.exports = r);
      },
    ...
    99: [
      function(e, t, i) {
        ...
        (n.prototype.loadVideoInfo = function(i) {
          ...
          r.jsonp(
            '//tv.taobao.com/player/json/getBaseVideoInfo.do?vid=' + n + '&playerType=3',
            function(e) {
            ...
            if ((e = (i = this).options().children))
              if (a.isArray(e))
                for (var o = 0; o < e.length; o++)
                  'string' == typeof (t = e[o]) ? ((r = t), (n = {})) : ((r = t.name), (n = t)),
                    i.addChild(r, n);
              else
            ...
            computeLayout: function(e) {
              if (this._player.tag)
                if (
                  ...
                  (e.style.width = t + 'px'),
                    height < eleHeight
                      ? ((e.style.top = (eleHeight - height) / 2 + 'px'),
                  ...
                  (e.style.height = i + 'px'),
                    width < eleWidth
                      ? ((e.left = (eleWidth - width) / 2 + 'px'),
                        (e.style.width = width + 'px'),
                        (this.width = width))
                      : ((e.style.width = '100%'), (e.style.left = '0px'), (this.width = eleWidth)),
        ...
        var r = e('../../component'),
          ...
          r.extend({
            ...
            createEl: function() {
              var e = r.prototype.createEl.call(this),
                t =
                  '<?xml version="1.0" encoding="UTF-8"?><svg width="8px" height="8px" viewBox="0 0 8 8" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">\x3c!-- Generator: Sketch 49.1 (51147) - http://www.bohemiancoding.com/sketch --\x3e<title>Artboard 2</title><desc>Created with Sketch.</desc><defs></defs><g id="plug" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><path d="M3,3 L3,0 L5,0 L5,3 L8,3 L8,5 L5,5 L5,8 L3,8 L3,5 L0,5 L0,3 L3,3 Z" id="Combined-Shape" fill="#FF1D00" fill-rule="nonzero"></path></g></svg>';
              return (
                (e.innerHTML =
                  '<div class="prism-ai-rect-region"><div class="prism-ai-title"><div class="top-left-anchor"></div><div class="top-right-anchor"></div><p></p></div><div class="prism-ai-rect"><div class="prism-ai-slash-container"><div class="prism-ai-top-slash prism-ai-slash"></div><div class="prism-ai-slash"></div><div class="prism-ai-slash"></div><div class="prism-ai-slash"></div><div class="prism-ai-slash"></div><div class="prism-ai-slash"></div><div class="prism-ai-slash"></div><div class="prism-ai-slash"></div><div class="prism-ai-slash"></div></div></div><div class="anchor-plug top-left">' +
                  t +
                  '</div><div class="anchor-plug top-right">' +
                  t +
                  '</div><div class="anchor-plug bottom-left">' +
                  t +
                  '</div><div class="anchor-plug bottom-right">' +
                  t +
                  '</div></div><div class="prism-ai-labels"></div>'),
                e
              );
            },
            updateLayout: function(e) {
              ...
              o
                ? ((o = o),
                  ...
                  this.updateTitle(o),
                  s.css(a, 'display', 'block'))
                : s.css(a, 'display', 'none');
            },
            ...
            updateAnchor: function(e) {
              ...
              (t.style['border-width'] = e + 'px'),
                ((t = document.querySelector('#' + this.id() + ' .top-right-anchor')).style[
                  'border-width'
                ] = e + 'px');
            },
            updateCross: function(t, i) {
              ...
              e &&
                ...
                (e = document.querySelectorAll(
                  '#' + this.id() + ' .prism-ai-rect-region span i'
                )) &&
                  e.forEach(function(e) {
            ...
            updateLabels: function(e) {
              if (!e || 0 != e.length) {
                ...
                if (
                  ((document.querySelector('#' + this.id() + ' .prism-ai-labels').innerHTML =
                    t.text),
                  t.classValue)
                ) {
          ...
          o = function(n, o) {
            ...
            for (var a = [], s = '', l = '', u = 0; u < n.length; u++)
              Object.keys(n[u]).forEach(function(e) {
                var t = n[u][e],
                  i = o.displayAttrs[e],
                  r = o.getClass;
                !l && r && 'function' == typeof r && (l = r(n[u], n)),
                  e == o.displayAttrs.header
                    ? (s = t)
                    : 'function' == typeof i
                      ? a.push(
              ...
              o.on(this.el(), 'mouseover', function() {
                ...
                this.on(a.Private.PlayClick, function() {
                  if (t._player.paused()) {
                    ...
                    (t._player.getDuration() <= e || t._player._ended) && t._player.seek(0),
                      t._player.play(!0);
          ...
          l = r.extend({
            ...
            disposeUI: function() {
              this.disabledHandler &&
                (clearTimeout(this.disabledHandler), (this.disabledHandler = null));
            },
          });
        t.exports = l;
      },
          ...
          n = r.extend({
            ...
            onEvent: function() {
              ...
              if ((1 == e.controlBarForOver && (r = 'hover'), 'hover' == r)) {
                ...
                'click' == r
                  ? (t.on(o.Private.Click, function(e) {
        ...
        var r = e('../component'),
          ...
          a = r.extend({
            ...
            createEl: function() {
              ...
              return (
                t ? (e.style.backgroundImage = 'url(' + t + ')') : n.css(e, 'display', 'none'), e
              );
            },
            _hide: function(e) {
              var t = document.querySelector('#' + this.id() + ' .prism-cover');
          ...
          s = r.extend({
            ...
            disposeUI: function() {
              this.playHideHandler &&
                (clearTimeout(this.playHideHandler), (this.playHideHandler = null));
            },
          });
        t.exports = s;
      },
          ...
          p = r.extend({
            ...
            _onMouseOver: function(e) {
              if (
                (this._cursorHideHandler &&
                  (clearTimeout(this._cursorHideHandler), (this._cursorHideHandler = null)),
            ...
            _onMouseOut: function(e) {
              ...
              this._cursorHideHandler && clearTimeout(this._cursorHideHandler),
                (this._cursorHideHandler = setTimeout(function() {
                  t.cursorNode &&
                    (a.css(t.cursorNode, 'display', 'none'),
                ...
                this._mouseClickTimeHandle && clearTimeout(this._mouseClickTimeHandle),
                  (this._mouseClickTimeHandle = setTimeout(function() {
                    (t._player._seeking = !0),
                      ...
                      t._player._hls && (t._player.pause(), t._player._hls.startLoad(i)),
                      t._player.seek(i),
                      t._player.trigger(d.Private.EndStart, {
                        toTime: i,
                      }),
            ...
            disposeUI: function() {
              this.cursorNodeHandler &&
                (clearTimeout(this.cursorNodeHandler), (this.cursorNodeHandler = null)),
                this._cursorHideHandler &&
                  (clearTimeout(this._cursorHideHandler), (this._cursorHideHandler = null)),
                this._mouseClickTimeHandle &&
                  (clearTimeout(this._mouseClickTimeHandle), (this._mouseClickTimeHandle = null));
            },
          });
        t.exports = p;
      },
          ...
          s = r.extend({
              ...
              r._player.on(a.Private.MarkerTextShow, function(e) {
                ...
                if ((r._player.trigger(i, e.paramData), t.progressMarker.isCustomized))
                  ...
                  r._thumbnailShowHanlde &&
                    (n.css(r.el(), 'display', 'none'), clearTimeout(r._thumbnailShowHanlde)),
                    (r._thumbnailShowHanlde = setTimeout(function() {
                      if (
                        ...
                        (left = e * t.left),
                          ...
                          left + width > e
                            ? (n.css(r.el(), 'right', '0px'), n.css(r.el(), 'left', 'auto'))
                            : ((left -= width / 2),
                              (left = left < 0 ? 0 : left),
            ...
            disposeUI: function() {
              this._thumbnailShowHanlde &&
                (clearTimeout(this._thumbnailShowHanlde), (this._thumbnailShowHanlde = null));
            },
          });
        t.exports = s;
      },
          ...
          n = r.extend({
                ...
                for (
                  ...
                  if (this._player._urls[o].Url == e) {
                    (n = this._player._currentPlayIndex = o),
                      u.set(c.SelectedStreamLevel, this._player._urls[o].definition, 365);
                    break;
                  }
                if (r != n && -1 < n) {
                  var a = this._player.getCurrentTime();
                  this._previousCurrentTime
                    ? 'playing' != this._player._status && (a = this._previousCurrentTime)
            ...
            _updateText: function(e) {
              ...
              i &&
                ...
                ((r += e ? '(' + e + ')' : ''), (i.innerText = r), t && (t.text = r));
            },
          });
        t.exports = n;
      },
            ...
            bindEvent: function() {
              ...
              this._player.on(u.Private.CCStateChanged, function(e) {
                ...
                'on' == t && i
                  ...
                  : 'off' == t &&
                    '' == n._backCCText &&
                    (n._backCCText = n._previousSelection.text);
                var r = 'Off';
                'on' == t && (r = n._backCCText),
                  n._player.trigger(u.Private.SelectorUpdateList, {
                    type: 'cc',
                    text: r,
                  });
              });
              ...
              var n = this,
                ...
                i = function(e) {
                  e &&
                    e.text &&
                    (document.querySelector(
                      '#' + n.id() + ' .prism-setting-' + e.type + ' .current-setting'
                    ).innerText = e.text);
                };
                ...
                this._player.on(l.Private.QualityChange, function(e) {
                  ...
                  if (t.levelSwitch) {
                    var i = document.querySelector(
                        '#' + n.id() + ' .prism-setting-quality .current-setting'
                      ),
                      r = c.get('Auto');
                    -1 < i.innerText.indexOf(r) &&
        ...
        var r = e('../component'),
              ...
              this._player.on(y.Private.Snapshot_Hide, function() {
                ...
                this.on('click', function() {
                  ...
                  'vertical' == s
                    ...
                    : 'horizon' == s && (a.translate(e.width, 0), a.scale(-1, 1)),
          ...
          v = function(e, t) {
            ...
            i &&
              i.text &&
              ((e.font = i.font),
              i.fillColor && ((e.fillStyle = i.fillColor), e.fillText(i.text, i.left, i.top)),
              i.strokeColor &&
                ((e.strokeStyle = i.strokeColor), e.strokeText(i.text, i.left, i.top)),
              e.stroke());
          };
        t.exports = s;
      },
          ...
          a = r.extend({
            ...
            bindEvent: function() {
              ...
              this._player.on(o.Video.DurationChange, function() {
                ...
                e
                  ? ((document.querySelector('#' + i.id() + ' .time-bound').style.display =
                      'inline'),
                    (document.querySelector('#' + i.id() + ' .duration').style.display = 'inline'),
                    (document.querySelector('#' + i.id() + ' .duration').innerText = e))
                  : ((document.querySelector('#' + i.id() + ' .duration').style.display = 'none'),
                ...
                this._player.on(o.Video.TimeUpdate, function() {
                  ...
                  document.querySelector('#' + i.id() + ' .current-time') &&
                    (t
                      ? ((document.querySelector('#' + i.id() + ' .current-time').style.display =
                          'inline'),
                        (document.querySelector('#' + i.id() + ' .current-time').innerText = t))
                      : (document.querySelector('#' + i.id() + ' .current-time').style.display =
                          'none'));
                });
            },
    ...
    129: [
      function(e, t, i) {
        ...
        t.exports.registerTooltipEvent = function(e, n) {
          var o = this,
            a = function() {
              o._controlbarTooltipHandler &&
                (clearTimeout(o._controlbarTooltipHandler), (o._controlbarTooltipHandler = null));
            };
        ...
        var r = e('../component'),
          ...
          r.extend({
            ...
            _getPosition: function(e) {
              ...
              return (
                r < o - i && (o = e.clientY),
                (r - (o - i) + n) / (r = this.volumnRange.offsetHeight)
              );
            },
            _offEvent: function() {
