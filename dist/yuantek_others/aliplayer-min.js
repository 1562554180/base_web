/*! Aliplayer - v2.8.0 - 2019-02-22 */ ! function o(a, s, l) {
  function u(i, e) {
    if (!s[i]) {
      if (!a[i]) {
      ...
      var c, i, e, t, r, d, n, o, a, s, l, u, p = p || (c = Math, i = Object.create || function () {
        ...
        _process: function (e) {
          var t = this._data,
            ...
            n = this.blockSize,
            o = r / (4 * n),
            a = (o = e ? c.ceil(o) : c.max((0 | o) - this._minBufferSize, 0)) * n,
            s = c.min(4 * a, r);
          if (a) {
      ...
      return i = (t = e).lib, r = i.WordArray, n = i.Hasher, o = t.algo, d = [], a = o.SHA1 = n.extend({
        ...
        _doProcessBlock: function (e, t) {
          for (var i = this._hash.words, r = i[0], n = i[1], o = i[2], a = i[3], s = i[4], l = 0; l < 80; l++) {
            ...
            c += l < 20 ? 1518500249 + (n & o | ~n & a) : l < 40 ? 1859775393 + (n ^ o ^ a) : l < 60 ? (n & o | n & a | o & a) - 1894007588 : (n ^ o ^ a) - 899497514, s = a, a = o, o = n << 30 | n >>> 2, n = r, r = c
          }
  ...
  7: [function (e, t, i) {
    ! function () {
      ...
      s.prototype.needsClick = function (e) {
        ...
        } else if (this.needsFocus(a)) return 100 < e.timeStamp - i || u && window.top !== window && "input" === r ? this.targetElement = null : (this.focus(a), this.sendClick(a, e), u && "select" === r || (this.targetElement = null, e.preventDefault())), !1;
    ...
    var r = e("../ui/component"),
      ...
      p = r.extend({
        ...
        bindEvent: function () {
          ...
          u.domain ? -1 < u.domain.indexOf("localhost") && (t = "//" + u.domain + "/build/skins/default/img/dragcursor.png") : t = "de/prismplayer/" + u.h5Version + "/skins/default/img/dragcursor.png", e.src = t, n.on(this.cursorNode, "mousedown", function (e) {
            i._onMouseDown(e)
        ...
        _onMouseClick: function (e) {
          ...
          var n = this._liveshiftService.getSourceUrl(r),
            o = t._player._options.source,
            a = c.isHls(t._player._options.source);
          a && n == o ? t._player.seek(i) : t._player._loadByUrlInner(n, i, !0), t._player.trigger(d.Private.Play_Btn_Hide), t._liveshiftService.seekTime = i, t._player.trigger(d.Private.EndStart, {
            toTime: i,
            notPlay: !0
    ...
    var i = o("../config"),
      ...
      l = function (e, t) {
        var i = d(e),
          r = "",
          n = c();
        r = "flash" == e ? "en-us" == n ? o("./flash/en-us") : "zh-cn" == n ? o("./flash/zh-cn") : t[n] : "en-us" == n ? o("./en-us") : "zh-cn" == n ? o("./zh-cn") : t[n], a.set(i, JSON.stringify(r)), u(e, r)
      },
      u = function (e, t) {
        var i = d(e);
        window[i] = t
    ...
    unpackPlayReady = function (e) {
      ...
      decode: function (e) {
        ...
        var u = new ArrayBuffer(a),
          c = new Uint8Array(u);
        for (t = 0; t < s; t += 4) i = d[e.charCodeAt(t)], r = d[e.charCodeAt(t + 1)], n = d[e.charCodeAt(t + 2)], o = d[e.charCodeAt(t + 3)], c[l++] = i << 2 | r >> 4, c[l++] = (15 & r) << 4 | n >> 2, c[l++] = (3 & n) << 6 | 63 & o;
        return u
      },
      encode: function (e) {
        ...
        for (c.lastIndex = 0; null != (i = c.exec(e));) {
          ...
          if (s) {
            ...
            for (var l = 0; l < s.length; l++) {
              var u = s[l]; - 1 !== u.indexOf("avc1") ? n.videoCodec = this.avc1toavcoti(u) : -1 !== u.indexOf("hvc1") ? n.videoCodec = u : n.audioCodec = u
            }
          }
          r.push(n)
        }
      ...
      parseLevelPlaylist: function (e, t, i, r) {
        ...
        for (P.lastIndex = 0; null !== (n = P.exec(e));) {
          ...
          if (h) {
            ...
            if (!isNaN(p.duration)) {
              var y = a++;
              p.type = r, p.start = s, p.levelkey = u, p.sn = y, p.level = i, p.cc = c, p.baseurl = t, p.relurl = (" " + n[3]).slice(1), l.fragments.push(p), s += (d = p).duration, p = new I
            }
          } else if (n[4]) {
            ...
            switch (n[o]) {
              ...
              case "KEY":
                ...
                S && (u = new k, b && 0 <= ["AES-128", "SAMPLE-AES"].indexOf(S) && (u.method = S, u.baseuri = t, u.reluri = b, u.key = null, u.iv = T));
                break;
              case "START":
  ...
  30: [function (e, s, t) {
    ...
    s.exports.get = function (e, t, i, r, n) {
      ...
      try {
        if (void 0 === o && (o = !0), u.open(e, t, o), a && (u.withCredentials = !0), s)
  ...
  34: [function (e, f, t) {
    ...
    f.exports.defaultH5Layout = [{
      ...
      return !(!v.IS_MOBILE || !v.IS_CHROME && !v.IS_FIREFOX)
    }, f.exports.isSafariUsedHlsPlugin = function (e) {
      return !!(v.os.pc && v.browser.safari && e)
      ...
      return f.exports.isSupportHls() ? "" : v.IS_IOS ? a.get("iOSNotSupportVodEncription") : a.get("UseChromeForVodEncription")
      ...
      var i = y.merge(y.copy(_), e);
      v.IS_ANDROID && (i.autoplay = !1);
      var r = [{
          name: "fullScreenButton",
          align: "tr",
          x: 20,
  ...
  38: [function (e, A, t) {
    ...
    A.exports.IS_MAC_SAFARI = A.exports.IS_MAC && A.exports.IS_SAFARI && !A.exports.IS_CHROME && !A.exports.HAS_FLASH, A.exports.IS_IOS = A.exports.IS_IPHONE || A.exports.IS_IPAD || A.exports.IS_IPOD, A.exports.IOS_VERSION = function () {
      ...
      }, A.exports.dingTalk = function () {
        var e = A.exports.USER_AGENT.toLowerCase();
        return /dingtalk/i.test(e)
      }, A.exports.wechat = function () {
        var e = A.exports.USER_AGENT.toLowerCase();
        return /micromessenger/i.test(e)
      }, A.exports.inIFrame = function () {
        return self != top
      }, A.exports.getReferer = function () {
        var t = document.referrer;
        if (A.exports.inIFrame()) try {
          t = top.document.referrer
        } catch (e) {
          t = document.referrer
        }
        return t
      }, A.exports.getHref = function () {
        location.href;
        if (A.exports.inIFrame()) try {
          top.location.href
        } catch (e) {
    ...
    function p(t, e, a) {
      ...
      t = t.substr(3), n(), e.endTime = r(), n(),
        function (e, t) {
          ...
          "auto" === i && -1 === c.line && (i = -1), t.line = i, t.lineAlign = o.get("lineAlign", "start"), t.snapToLines = o.get("snapToLines", !0), t.size = o.get("size", 100), t.align = o.get("align", d);
  ...
  44: [function (e, t, i) {
    var r = e("../lib/oo"),
      ...
      s = r.extend({
        init: function (e, t, i) {
          void 0 === i && (i = !0), this.trackLog = i, this.player = e, this.requestId = "", this.sessionId = _.guid(), this.playId = 0, this.firstPlay = !0, this.osName = m.os.name, this.osVersion = m.os.version || "", this.exName = m.browser.name, this.exVersion = m.browser.version || "";
          var r = this.player.getOptions(),
            n = t.from ? t.from : "",
            o = (r.isLive, r.isLive ? "live" : "vod"),
            a = "pc";
          m.IS_IPAD ? a = "pad" : m.os.phone && (a = "phone");
          var s = encodeURIComponent(m.getReferer()),
            l = m.getHref(),
        ...
        bindEvent: function () {
          ...
          this.player.on(o.Player.Init, function () {
            ...
            t._onPlayerCanplay(), t._onPlayerUnderload()
            ...
            if (t.player.getCurrentTime()) {
              ...
              t.player.paused() || 30 <= ++a && (t._log("HEARTBEAT", {
                vt: e,
                interval: 1e3 * a
              }), a = 0)
            }
        ...
        _onPlayerloadstart: function () {
          this.loadstartTime = (new Date).getTime(), this.playId = _.guid(), !this.buffer_flag && this.player._isPreload() && this._log("STARTPLAY", {
            vt: (new Date).getTime()
          })
        },
        ...
        _onPlayerLoaddata: function () {
          if (this._LoadedData = !0, !this.buffer_flag) {
            var e = 0,
              t = 0;
        ...
        _onPlayerInit: function () {
          this.buffer_flag = 0, this.pause_flag = 0, this.startTimePlay = 0
        },
        ...
        _reportPlay: function () {
          return !(this.buffer_flag || !this._LoadedData) && (this.first_play_time = (new Date).getTime(), this._log("PLAY", {
            dsm: "fix",
        ...
        _onPlayerPlay: function () {
          this.playstartTime = (new Date).getTime(), 0 == this.playId && (this.playId = _.guid()), this.firstPlay || 0 != this.pause_flag || this.seeking || (this.sessionId = _.guid()), this.player._isPreload() || (this._log("STARTPLAY", {
            vt: (new Date).getTime()
          }), this.loadstartTime = (new Date).getTime()), this.buffer_flag && this.pause_flag && (this.pause_flag = 0, this.pauseEndTime = (new Date).getTime(), this._log("RECOVER", {
            vt: Math.floor(1e3 * this.player.getCurrentTime()),
        ...
        _log: function (e, t) {
          if (this.trackLog) {
            ...
            var i = c.copy(this.opt);
            if (this.requestId = _.guid(), "ERROR" == e && "FETCHEDIP" != e && "CDNDETECT" != e) {
              var r = this;
              d.jsonp("https://cdn.dns-detect.alicdn.com/api/cdnDetectHttps?method=createDetectHttps", function (e) {
                r._log("CDNDETECT", {
                  flag: 0,
                  error: "",
                  eri: r.requestId
            ...
            var n = S.logReportTo;
            i.e = p[e], i.ri = this.sessionId, i.t = (new Date).getTime(), i.cdn_ip = this._userNetInfo.cdnIp, i.hn = this._userNetInfo.localIp;
            ...
            return c.each(i, function (e, t) {
              u.push(e + "=" + t)
            }), u = u.join("&"), d.jsonp(n + "?" + u, function () {}, function () {}), this.sessionId
          }
        },
        _getUuid: function () {
          var e = n.get("p_h5_u");
          return e || (e = _.guid(), n.set("p_h5_u", e, 730)), e
        }
      });
    t.exports = s
  }, {
  ...
  45: [function (e, t, i) {
    var s = e("./base/player"),
      ...
      v = e("../lib/ua"),
      g = e("../lib/playerutil"),
      _ = (e("../lib/dom"), e("../lib/io"), e("../lang/index"));
    t.exports.create = function (e, t) {
      "function" != typeof t && (t = function () {}), e.readyCallback = t, _.setCurrentLanguage(e.language, "h5", e.languageTexts);
      var i = g.handleOption(e),
        r = i.source,
        n = g.isAudio(r);
      n && (i.mediaType = "audio");
      var o, a = g.createWrapper(i);
      return a.player ? a.player : (n ? o = new p(a, i) : !i.useFlashPrism && g.isFlv(r) && g.isSupportFlv() ? o = new f(a, i) : v.IS_MOBILE || !i.useFlashPrism && !g.isRTMP(r) ? i.vid && !i.source ? o = i.authInfo ? new u(a, i) : i.playauth || i.accessKeyId && i.accessKeySecret ? new c(a, i) : new d(a, i) : g.isDash(r) && g.isSupportMSE() ? o = new y(a, i) : g.isHls(r) ? g.canPlayHls() ? o = g.isSupportHls() && (g.isUsedHlsPluginOnMobile() || g.isSafariUsedHlsPlugin(i.useHlsPluginForSafari)) ? new h(a, i) : new s(a, i) : g.isSupportHls() ? o = new h(a, i) : v.os.pc ? i.userH5Prism || i.useH5Prism || (o = new l(a, i)) : o = new s(a, i) : o = (v.os.pc, new s(a, i)) : o = new l(a, i), o)
    }
  }, {
    "../lang/index": 17,
    "../lib/dom": 24,
  ...
  50: [function (e, t, i) {
    ...
    t.exports.handle = function (e) {
      var t = this;
      e.paramData.notPlay || this._enteredProgressMarker || t.play(), this._enteredProgressMarker && t.one(r.Player.CanPlay, function () {
        t.pause()
    ...
    t.exports.handle = function (e) {
      ...
      if (t.waiting = !1, t._clearTimeout(), t.checkOnline()) {
        var i, r = "",
          ...
          o = n.error.message;
        r = "";
        if (n.error.code && (i = n.error.code, r = d.VideoErrorCode[n.error.code], o = i + " || " + o), t._options.isLive) t._options.liveRetry > t._liveRetryCount ? t._reloadAndPlayForM3u8() : (t._liveRetryCount = 0, t.trigger(c.Player.LiveStreamStop), t._liveErrorHandle = setTimeout(function () {
          var e = {
            mediaId: "ISLIVE",
            error_code: r,
          ...
          if (!t._vodRetryCount && navigator.onLine) {
            var a = t.getCurrentTime();
            return t._loadByUrlInner(t._options.source, a, !0), void(t._vodRetryCount = 1)
          }
          var s = p.get("Error_Play_Text"),
            l = !1;
          if (i < 4) {
            if (3 == i && t._firstDecodeError) {
              a = t.getCurrentTime() + 1;
              return t._loadByUrlInner(t._options.source, a, !0), void(t._firstDecodeError = !1)
            }
            s = d.VideoErrorCodeText[i]
          } else t._eventState == d.SUSPEND ? (s = p.get("Error_Load_Abort_Text"), r = d.ErrorCode.RequestDataError) : t._eventState == d.LOAD_START ? (s = p.get("Error_Network_Text"), 0 < t._options.source.indexOf("auth_key") && (s = s + "\uff0c" + p.get("Error_AuthKey_Text")), r = d.ErrorCode.StartLoadData) : t._eventState == d.LOADED_METADATA && (s = p.get("Error_Play_Text"), r = d.ErrorCode.PlayingError);
          s = s + "\uff0c" + p.get("Error_Retry_Text"), 1 < t._urls.length && t._retrySwitchUrlCount < 3 && -1 == t._options.source.indexOf(".mpd") && (t.switchUrl(), l = !0);
          var u = {
            mediaId: t._options.vid ? t._options.vid : "",
            error_code: r,
            error_msg: o
          };
          t.logError(u, !0), l || (u.display_msg = s, t.trigger(c.Player.Error, u))
        }
      }
    }
  }, {
  ...
  64: [function (e, t, i) {
    ...
    t.exports.handle = function (e) {
      var t = this;
      t.trigger(n.Private.H5_Loading_Hide), t.trigger(n.Private.Cover_Hide), t.trigger(n.Private.Info_Hide), t.waiting = !1, t._ended = !1, t._liveRetryCount = 0, t._vodRetryCount = 0, t._firstDecodeError = !0;
      var i = t.getCurrentTime();
      if (t._waitingReloadTime != i && (t._waitingTimeoutCount = 0), t._checkTimeoutHandle && (clearTimeout(t._checkTimeoutHandle), t._checkTimeoutHandle = null), t._waitingLoadedHandle && (clearTimeout(t._waitingLoadedHandle), t._waitingLoadedHandle = null), t._waitingTimeoutHandle && (clearTimeout(t._waitingTimeoutHandle), t._waitingTimeoutHandle = null, t._ccService && t._options.isLive)) {
        var r = t._ccService.getCurrentSubtitle();
        t._setDefaultCC = !0, r && t._ccService["switch"](r)
      }
      t.trigger(n.Private.AutoStreamHide), t.trigger(n.Player.Playing), t.trigger(n.Private.Play_Btn_Hide), t.trigger(n.Private.Error_Hide)
    }
  }, {
    "../../event/eventtype": 48
  }],
  65: [function (e, t, i) {
    ...
    t.exports.handle = function (e) {
      ...
      if (i.waiting && !i._TimeUpdateStamp && (i._TimeUpdateStamp = t), 0 != i.waiting && i._TimeUpdateStamp == t || (i.trigger(n.Private.H5_Loading_Hide), i.trigger(n.Private.AutoStreamHide), i._checkTimeoutHandle && clearTimeout(i._checkTimeoutHandle), i._waitingTimeoutHandle && clearTimeout(i._waitingTimeoutHandle), i._waitingLoadedHandle && clearTimeout(i._waitingLoadedHandle), i.waiting = !1), i._TimeUpdateStamp = t, !i._options.isLive) {
        ...
        r < t && !i.paused() ? (i.pause(), a.trigger(this.tag, n.Video.ManualEnded)) : r - t < .2 && 0 <= o.browser.version.indexOf("49.") && !i.paused() && (i.pause(), a.trigger(this.tag, n.Video.ManualEnded))
      }
  ...
  66: [function (e, t, i) {
    ...
    t.exports.handle = function (e) {
      ...
      if (!i._options.isLive) {
        var t = this.getCurrentTime(),
          r = this.getDuration();
        if (r - t < .2 || r < t) return i.pause(), i._ended = !0, void s.trigger(this.tag, o.Video.ManualEnded)
      }
      i.trigger(o.Private.H5_Loading_Show), i.waiting = !0;
      var n = function () {
        i._checkTimeoutHandle && clearTimeout(i._checkTimeoutHandle), i._waitingTimeoutHandle && clearTimeout(i._waitingTimeoutHandle), i._waitingLoadedHandle && clearTimeout(i._waitingLoadedHandle)
      };
      n(), i._TimeUpdateStamp = null, i._checkTimeoutHandle = setTimeout(function () {
        i.trigger(o.Private.AutoStreamShow)
      }, 1e3 * i._options.loadDataTimeout), i.trigger(o.Player.Waiting), i._waitingTimeoutHandle = setTimeout(function () {
        if (i.tag && i._options) {
          i.pause();
          var e = {
  ...
  67: [function (e, t, i) {
      ...
      w = o.extend({
        init: function (e, t) {
          if (this.tag = e, this.loaded = !1, this.played = !1, this.waiting = !1, this._urls = [], this._currentPlayIndex = 0, this._retrySwitchUrlCount = 0, this._isError = !1, this._isHls = !1, this._liveRetryCount = 0, this._vodRetryCount = 0, this._seeking = !1, this._serverRequestId = 0, this._waitingTimeoutCount = 0, this._waitingReloadTime = 0, this._created = !1, this._firstDecodeError = !0, this._enteredProgressMarker = !1, this._liveShiftSeekStartTime = 0, this._duration = 0, this.__disposed = !1, void 0 === t.skinLayout && (t.skinLayout = p.defaultH5Layout), o.call(this, this, t), this.addClass("prism-player"), t.plugins && a.each(t.plugins, function (e, t) {
              this[e](t)
            }, this), this._createService(), this.UI = {}, t.useNativeControls ? this.tag.setAttribute("controls", "controls") : this.UI = l, this.initChildren(), g.onAll(this), this._lifeCycleManager = new T(this), this._options.trackLog && (this._monitor = new u(this, {
              video_id: 0,
              album_id: 0,
            ...
            if (this.on(b.Private.ReadyState, function () {
              ...
              if (this.trigger(b.Private.PREPARE, "custom"), this._options.autoPlayDelay) {
                this._autoPlayDelay = new v(this);
                var r = this;
    ...
    w.prototype.initPlay = function (e) {
      ...
      !1 !== t && 0 !== t.length && (this.options({
        children: t
      }), o.prototype.initChildren.call(this)), this.UI.cover = _, this.addChild("cover", e), this.UI.playanimation = m, this.addChild("playanimation", e), this.UI.autoStreamSelector = S, this.addChild("autoStreamSelector", e), this.UI.progressMarker = E, this.addChild("progressMarker", e), this.trigger(b.Private.UiH5Ready)
    }, w.prototype.createEl = function () {
      var e = !1;
    ...
    }, w.prototype.setVideoAttrs = function () {
      ...
      h.adaptX5Play(this)
    }, w.prototype.checkOnline = function () {
      ...
      if (0 == navigator.onLine) {
        ...
        return e.display_msg = y.get("Error_Offline_Text"), this.trigger(b.Player.Error, e), !1
      }
      return !0
    }, w.prototype.id = function () {
      return this.el().id
    }, w.prototype.renderUI = function () {}, w.prototype.switchUrl = function () {
      if (0 != this._urls.length) {
        ...
        f.set(c.SelectedStreamLevel, e.definition, 365), this.trigger(b.Private.QualityChange, y.get("Quality_Change_Fail_Switch_Text"));
        this.getCurrentTime();
        this._options.source = e.Url, this.tag.setAttribute("src", this._options.source), this.tag.play()
      }
    }, w.prototype.setControls = function () {
      var e = this.options();
    ...
    }, w.prototype._initControlBar = function (e) {
      ...
      t._readyStateTimer && clearInterval(t._readyStateTimer), t._readyStateTimer = window.setInterval(function (e) {
        ...
        } else clearInterval(t._readyStateTimer)
      }, 100)
    }, w.prototype.getReadyTime = function () {
      return this.readyTime
    }, w.prototype.readyState = function () {
      return this.tag.readyState
    }, w.prototype.getError = function () {
      return this.tag.error
    }, w.prototype.getRecentOccuredEvent = function () {
      return this._eventState
    }, w.prototype.getSourceUrl = function () {
      return this._options ? this._options.source : ""
    }, w.prototype.getMonitorInfo = function () {
      return this._monitor ? this._monitor.opt : {}
    }, w.prototype.getCurrentQuality = function () {
      if (0 < this._urls.length) {
        var e = this._urls[this._currentPlayIndex];
        return {
          width: e.width,
      ...
      return ""
    }, w.prototype.setSpeed = function (e) {
      ...
      return this._isManualPlay = e || !1, this
    }, w.prototype.replay = function () {
      return this.seek(0), this.tag.play(), this
    }, w.prototype.pause = function (e) {
      return this.tag && this.tag.pause(), this._isManualPause = e || !1, this
    }, w.prototype.stop = function () {
      return this.tag.setAttribute("src", null), this
    }, w.prototype.paused = function () {
      if (this.tag) return !1 !== this.tag.paused
    }, w.prototype.getDuration = function () {
      var e = 0;
      return this.tag && (e = this._duration || this.tag.duration), e
    }, w.prototype.getCurrentTime = function () {
      ...
      return this
    }, w.prototype.firstNewUrlloadByUrl = function (e, t) {
      this._clearTimeout(), this._options.vid = 0, this._options.source = e, this._monitor && this._monitor.updateVideoInfo({
        video_id: 0,
        album_id: 0,
        source: e,
        from: this._options.from
      }), this.trigger(b.Private.ChangeURL), this.initPlay(), this._options.autoplay && this.trigger(b.Private.Cover_Hide), this._options.autoplay ? this.trigger(b.Player.Play) : this.trigger(b.Player.Pause), t || (t = 0), !t && 0 != t || isNaN(t) || this.seek(t)
    }, w.prototype._loadByUrlInner = function (e, t, i) {
      this.loadByUrl(e, t, i, !0)
    }, w.prototype.loadByUrl = function (e, t, i, r) {
      this._monitor && this._monitor.reset(), this._isError = !1, this._duration = 0, this._clearTimeout(), this.trigger(b.Private.Error_Hide), this._options.vid = 0, this._options.source = e, this._monitor && this._monitor.updateVideoInfo({
        video_id: 0,
        album_id: 0,
        source: e,
        from: this._options.from
      }), r || this.trigger(b.Private.ChangeURL), this._options._autoplay = i, this.initPlay(i), (this._options.autoplay || i) && this.trigger(b.Private.Cover_Hide), this._options.autoplay || i ? this.trigger(b.Player.Play) : this.trigger(b.Player.Pause);
      var n = this;
      this._options.isLive || s.one(this.tag, b.Video.CanPlay, function (e) {
        !t && 0 != t || isNaN(t) || n.seek(t)
      })
    }, w.prototype.dispose = function () {
      this.__disposed = !0, this.trigger(b.Private.Dispose), this.tag.pause(), g.offAll(this), this._monitor && (this._monitor.removeEvent(), this._monitor = null), this._autoPlayDelay && this._autoPlayDelay.dispose(), this._checkTimeoutHandle && clearTimeout(this._checkTimeoutHandle), this._waitingTimeoutHandle && clearTimeout(this._waitingTimeoutHandle), this._playingSlientPause && clearTimeout(this._playingSlientPause), this._waitingLoadedHandle && clearTimeout(this._waitingLoadedHandle), this._readyStateTimer && clearInterval(this._readyStateTimer), this._disposeService(), this._clearLiveErrorHandle(), this._el.innerHTML = "", this.destroy(), this.tag = null, this._options.recreatePlayer = null, this._options = null
    }, w.prototype.mute = function () {
    ...
    }, w.prototype._muteInner = function () {
      ...
      return this._image
    }, w.prototype.cancelImage = function () {
      this.tag && (this._image = "", this._setTransform(), this.log("IMAGE", {
        mirror: 0
      }))
    }, w.prototype.setCover = function (e) {
      var t = document.querySelector("#" + this.id() + " .prism-cover");
      t && e && (t.style.backgroundImage = "url(" + e + ")", this._options.cover = e, this.trigger(b.Private.Cover_Show))
    }, w.prototype._setTransform = function () {
    ...
    }, w.prototype._startPlay = function () {
    ...
    }, w.prototype._initPlayBehavior = function (e, t) {
      ...
      if (!p.validateSource(t)) {
        ...
        return i.display_msg = y.get("Error_Invalidate_Source"), this.trigger(b.Player.Error, i), !1
      }
      return void 0 === e && (e = !1), this._created || (this._created = !0, this.trigger(b.Private.Created)), this.loaded || this.trigger(b.Player.Init), this._options.autoplay || this._options._autoplay || this._options.preload || e ? (this._options._preload = !0, this._initLoad(t), (this._options.autoplay || this._options._autoplay) && this._startPlay()) : this.trigger(b.Private.Play_Btn_Show), !0
    }, w.prototype._isPreload = function () {
      return this._options.autoplay || this._options.preload || this._options._preload
    }, w.prototype._initLoad = function (e) {
      this.getMetaData(), e && (this._isPreload() && !r.IS_MOBILE ? this.trigger(b.Private.H5_Loading_Show) : (this.trigger(b.Private.H5_Loading_Hide), this.trigger(b.Private.Play_Btn_Show)), this.tag.setAttribute("src", e), this.loaded = !0)
    }, w.prototype._clearLiveErrorHandle = function () {
      this._liveErrorHandle && (clearTimeout(this._liveErrorHandle), this._liveErrorHandle = null)
    }, w.prototype._reloadAndPlayForM3u8 = function () {
    ...
    }, w.prototype._checkSupportVideoType = function () {
      if (!this.tag.canPlayType || !this._options.source || !r.IS_MOBILE) return "";
      var e = this._options.source,
        t = "";
      if (0 < e.indexOf("m3u8") ? "" != this.tag.canPlayType("application/x-mpegURL") || p.isSupportHls() || (t = y.get("Error_Not_Support_M3U8_Text")) : 0 < e.indexOf("mp4") ? "" == this.tag.canPlayType("video/mp4") && (t = y.get("Error_Not_Support_MP4_Text")) : (p.isRTMP(e) || p.isFlv(e)) && r.IS_MOBILE && (t = y.get("Error_Not_Support_Format_On_Mobile")), t) {
        var i = {
          mediaId: this._options.vid ? this._options.vid : "",
      ...
      return t
    }, w.prototype.getComponent = function (e) {
      return this._lifeCycleManager.getComponent(e)
    }, w.prototype.logError = function (e, t) {
    ...
    }, w.prototype.setSanpshotProperties = function (e, t, i) {
      ...
      this.tag.play = function () {
        if (!n._options.source) {
          ...
          return n._options.vid ? e.display_msg = y.get("Error_Vid_Empty_Source") : e.display_msg = y.get("Error_Empty_Source"), void n.trigger(b.Player.Error, e)
        }
        n.readyTime = (new Date).getTime();
        var t = r.apply(n.tag);
        void 0 !== t && t.then(function () {
          n.trigger(b.Player.AutoPlay, !0)
        })["catch"](function (e) {
          !n.tag || !n.tag.paused || n._isError || n._options._autoplay || n._switchLevel || (n.trigger(b.Private.Play_Btn_Show), n.trigger(b.Private.H5_Loading_Hide), n.trigger(b.Player.AutoPlayPrevented), n.trigger(b.Player.AutoPlay, !1), n._options.cover && n.trigger(b.Private.Cover_Show))
        });
    ...
    }, w.prototype._extraMultiSources = function () {
      var e = this._options.source;
    ...
    }, w.prototype._isEnabledAILabel = function () {
      return this._options.ai && this._options.ai.label
    }, w.prototype._createService = function () {
      if (x)
    ...
    }, w.prototype._disposeService = function () {
      if (x)
        for (var e = x.length, t = 0; t < e; t++) {
          var i = this[x[t].name];
          void 0 !== i && i.dispose && i.dispose()
        }
    }, w.prototype._executeReadyCallback = function () {
      try {
        this._options.autoplay || this._options.preload || (this.trigger(b.Private.H5_Loading_Hide), this.trigger(b.Private.Play_Btn_Show)), this._options.readyCallback(this)
      } catch (e) {
        console.log(e)
      }
    }, w.prototype._clearTimeout = function () {
    ...
    "../../monitor/monitor": 44,
    "../../ui/component": 100,
    "../../ui/component/cover": 106,
    "../../ui/component/play-animation": 112,
    "../../ui/component/progressmarker": 115,
    "../../ui/exports": 132,
    "../service/export": 93,
        ...
        if (e && s.isArray(e) && 0 < e.length)
          for (var i = 0; i < e.length; i++) {
            ...
            var n = new(Function.prototype.bind.apply(constr, args)),
              o = n[d.createEl];
            o && "function" == typeof o && o.call(n, t.el()), this.components.push({
              name: name,
              obj: n
            })
          }
    ...
    var l = function (e, t) {
        if (t) {
          var i, r = t.paramData,
            n = r.type,
            o = r.data;
          ((i = n) == c.Video.LoadStart || i == c.Video.LoadedData || i == c.Video.LoadedMetadata) && (n = d.loading), p(e, n);
  ...
  73: [function (e, t, i) {
    var d = e("../../lib/io"),
      ...
      f = e("../../lib/util"),
      y = e("../../lib/playerutil"),
      v = (e("../../lib/dom"), e("../../lang/index")),
      g = e("../base/event/eventtype"),
      _ = e("../saas/drm");
    t.exports.inject = function (e, t, i, r, a, n, o) {
      var s = r.source;
      if (n || (l = s, !e._drm && y.isDash(l))) {
        var l;
        t.prototype._checkDrmReady = function () {
          ...
          if (f.contentProtocolMixed(s)) {
            ...
            return t.display_msg = v.get("Request_Block_Text"), void this.trigger(g.Player.Error, t)
          }
          ...
          function i(i, t) {
            var r = !i._drm,
              n = function () {
                ...
                var e = {
                  drm: {
                    requestLicenseKey: _.requestLicenseKey(i),
                    servers: {}
                  }
                };
                h.DRMKeySystem[4] && (e.drm.servers[h.DRMKeySystem[5]] = "https://foo.bar/drm/widevine", e.drm.servers[h.DRMKeySystem[4]] = "https://foo.bar/drm/playready"), i._drm.configure(e), a && a(i._drm), r && i._executeReadyCallback(), i._drm.load(i._options.source).then(function () {
              ...
              o = function (e) {
                if (!e || i.__support && i.__support.drm[e]) n();
                else {
                  var t = {
                    mediaId: i._options.vid ? i._options.vid : "",
                    error_code: h.ErrorCode.EncrptyVideoNotSupport,
                    error_msg: v.get("Not_Support_DRM")
                  };
            ...
            var t = "aliplayer-drm-min.js",
              i = "https://" + p.domain + "/de/prismplayer/" + p.h5Version + "/drm/" + t;
            p.domain ? -1 < p.domain.indexOf("g-assets.daily") ? i = "http://" + p.domain + "/de/prismplayer/" + p.h5Version + "/drm/" + t : -1 < p.domain.indexOf("localhost") && (i = "http://" + p.domain + "/build/drm/" + t) : i = "de/prismplayer/" + p.h5Version + "/drm/" + t;
            var r = this;
            d.loadJS(i, function () {
  ...
  74: [function (e, t, i) {
    var r = e("../base/player"),
      ...
      o = r.extend({
        init: function (e, t) {
          n.inject(this, o, r.prototype, t, function (e) {}), t._native = !1, r.call(this, e, t)
        }
      });
    t.exports = o
  }, {
  ...
  75: [function (e, t, i) {
    var n = e("../../ui/component"),
      ...
      m = n.extend({
        init: function (e, t) {
          if (void 0 === t.skinLayout && (t.skinLayout = p.defaultFlashLayout), n.call(this, this, t), this._id = "prism-player-" + o.guid(), this.tag = e, this._el = this.tag, this._childrenUI = [f, y], this.initChildren(), this.id = this._id, window[this.id] = this, d.setCurrentLanguage(this._options.language, "flash", this._options.languageTexts), h.openInFile()) {
            var i = {
              mediaId: this._options.vid ? this._options.vid : "",
            ...
            if (this._options.vid && this._options.accessKeyId && this._options.securityToken && this._options.accessKeySecret) {
              ...
              _.getPlayAuth(this._options, function (e) {
                ...
                e.sri && (t.sri = e.sri), t.display_msg = e.display_msg, r.trigger(g.Private.Error_Show, t)
              }, "flash")
        ...
        _createPlayer: function () {
          if (this._options.autoPlayDelay) {
            var e = new r(this),
              t = this;
            e.handle(function () {
              t._options.autoplay = !0, t._initPlayer(), t._childrenUI.push(v), t.initChildren()
            })
          } else this._initPlayer(), this._childrenUI.push(v), this.initChildren()
        },
        _initPlayer: function () {
          var e = "//" + c.domain + "/de/prismplayer-flash/" + c.flashVersion + "/PrismPlayer.swf";
          c.domain ? -1 < c.domain.indexOf("localhost") && (e = "//" + c.domain + "/build/flash//PrismPlayer.swf") : e = "de/prismplayer-flash/" + c.flashVersion + "/PrismPlayer.swf";
    ...
    "../../lib/util": 40,
    "../../ui/component": 100,
    "../../ui/component/error-display": 107,
    "../../ui/component/info-display": 110,
    "../base/event/eventtype": 48,
    "../saas/ststoken": 86
  }],
  76: [function (e, t, i) {
    var u = e("../../lib/io"),
      ...
      f = e("../../lib/util"),
      c = e("../../lib/playerutil"),
      d = (e("../../lib/dom"), e("../../lib/ua")),
      y = e("../../lang/index"),
      v = e("../base/event/eventtype");
    e("../base/player");
    t.exports.inject = function (e, t, i, r, s, n) {
      var o = r.source;
      if (n || (a = o, !e._flv && c.isFlv(a))) {
        var a;
        e._Type = t, e._superType = i, e._superPt = i.prototype, e._disposed = !1, t.prototype._checkFlvReady = function () {
          ...
          if (this.trigger(v.Private.Cover_Hide), this._options.isLive && e) this._loadByUrlInner(this._options.source, 0, liveForceLoad);
          else {
            if (0 == this._seeking) {
              var t = 0;
          ...
          if (d.browser.safari && this.trigger(v.Private.Snapshot_Hide), f.contentProtocolMixed(o)) {
            var t = {
              mediaId: this._options.vid ? this._options.vid : "",
              error_code: h.ErrorCode.InvalidSourceURL,
              error_msg: "InvalidSourceURL"
            };
            return t.display_msg = y.get("Request_Block_Text"), void this.trigger(v.Player.Error, t)
          }
          ...
          function i(t, e) {
            ...
            for (var a in r ? (n.enableStashBuffer = t._options.enableStashBufferForFlv, stashInitialSize = t._options.stashInitialSizeForFlv, n.autoCleanupSourceBuffer = !1) : n.lazyLoadMaxDuration = 600, t._options.flvOption) "cors" == a || "hasAudio" == a || "withCredentials" == a || "hasVideo" == a || "type" == a ? o[a] = t._options.flvOption[a] : n[a] = t._options.flvOption[a];
            t._originalUrl = t._options.source, t._flv = flvjs.createPlayer(o, n), l(t, t._flv), t._flv.on(flvjs.Events.MEDIA_INFO, function (e) {
            ...
            i(that, e)
          }, 1e3) : (this.trigger(v.Private.H5_Loading_Show), function (e, t) {
            var i = "aliplayer-flv-min.js";
            t && (i = "aliplayer-flv.js");
            // var r = "https://" + p.domain + "/de/prismplayer/" + p.h5Version + "/flv/" + i;
            // p.domain ? -1 < p.domain.indexOf("g-assets.daily") ? r = "http://" + p.domain + "/de/prismplayer/" + p.h5Version + "/flv/" + i : -1 < p.domain.indexOf("localhost") && (r = "http://" + p.domain + "/build/flv/" + i) : r = "de/prismplayer/" + p.h5Version + "/flv/" + i;
            // console.log(r, p.domain, p.h5Version, '这是啥')
        ...
        var l = function (c, e) {
          ...
          e.on(flvjs.Events.ERROR, function (e, t, i) {
            var r = h.ErrorCode.OtherError,
              n = y.get("Error_Play_Text");
            if (t == flvjs.ErrorDetails.NETWORK_EXCEPTION) {
              var o = c.getOptions().source;
              !o || 0 != o.toLowerCase().indexOf("http://") && 0 != o.toLowerCase().indexOf("https://") ? (r = h.ErrorCode.InvalidSourceURL, n = y.get("Error_Invalidate_Source_Widthout_Protocal"), d = !0) : navigator.onLine ? (r = h.ErrorCode.RequestDataError, n = y.get("Maybe_Cors_Error")) : (r = h.ErrorCode.NetworkError, n = y.get("Error_Network_Text"))
            } else t == flvjs.ErrorDetails.NETWORK_STATUS_CODE_INVALID ? "404" == i.code ? (r = h.ErrorCode.NotFoundSourceURL, n = y.get("Error_Not_Found")) : "403" == i.code ? (r = h.ErrorCode.AuthKeyExpired, n = y.get("Error_AuthKey_Text"), d = !0) : (r = h.ErrorCode.NetworkError, n = y.get("Error_Network_Text")) : t == flvjs.ErrorDetails.NETWORK_TIMEOUT ? (r = h.ErrorCode.LoadingTimeout, n = y.get("Error_Waiting_Timeout_Text")) : t != flvjs.ErrorDetails.MEDIA_FORMAT_UNSUPPORTED && t != flvjs.ErrorDetails.MEDIA_CODEC_UNSUPPORTED || (r = h.ErrorCode.FormatNotSupport, n = y.get("Error_H5_Not_Support_Text"), d = !0);
            var a = function () {
              if (setTimeout(function () {
                  c.trigger(v.Private.Play_Btn_Hide)
                }), c.checkOnline()) {
                var e = {
                ...
                c.logError(e), e.display_msg = n, p.cityBrain && (c.flv = null), c.trigger(v.Player.Error, e)
              }
            };
            if (c._options && c._options.isLive && !d) {
              var s = c._options;
              if (s.liveRetry > c._liveRetryCount) {
                0 == c._liveRetryCount && c.trigger(v.Player.OnM3u8Retry);
                var l = s.liveRetryInterval + s.liveRetryStep * c._liveRetryCount;
                c._liveRetryCount++, f.sleep(1e3 * l), c._loadByUrlInner(s.source)
              } else c.trigger(v.Player.LiveStreamStop), c._liveErrorHandle = setTimeout(a, 500)
            } else {
              if (!c._vodRetryCount && navigator.onLine) {
                var u = c.getCurrentTime();
                return c._loadByUrlInner(c._options.source, u, !0), void(c._vodRetryCount = 1)
              }
              a()
            }
          })
  ...
  77: [function (e, t, i) {
    var r = e("../base/player"),
      ...
      o = r.extend({
        init: function (e, t) {
          n.inject(this, o, r, t, function (e) {}), t._native = !1, r.call(this, e, t)
        }
      });
    t.exports = o
  }, {
  ...
  78: [function (e, t, i) {
    ...
    t.exports.inject = function (e, t, i, r, o, n) {
      ...
      if (o || n || (l = a, u = s, !e._hls && y.isHls(l) && (!y.canPlayHls() || y.isSafariUsedHlsPlugin(u) || y.isUsedHlsPluginOnMobile()))) {
        var l, u;
        e._Type = t, e._superType = i, e._superPt = i.prototype, e._disposed = !1, t.prototype._checkHlsReady = function () {
        ...
        }, e._isHls = !0, e._hls = null, e._isLoadedHls = !1, t.prototype.play = function (e) {
          this._checkHlsReady(), this._isManualPlay = e || !1;
          if (this.trigger(_.Private.Cover_Hide), this._options.autoplay || this._options.preload || this._loadSourced || (this._loadSourced = !0, this._options._autoplay = !0, this._hls.loadSource(this._options.source)), this.tag.ended || this._ended) this.replay();
          ...
          return this._loadByUrlInner(this._options.source, 0, !0), this
        }, t.prototype.pause = function (e) {
          return this.tag && (this._checkHlsReady(), this.tag.pause(), this._hls.stopLoad()), this._isManualPause = e || !1, this
        }, t.prototype.stop = function () {
          ...
          var r = this;
          setTimeout(function () {
            r.trigger(_.Player.LevelSwitched), this._switchLevel = !1
          }, 1e3)
        }, t.prototype.initPlay = function (e) {
          if (f.contentProtocolMixed(a)) {
            ...
            return t.display_msg = g.get("Request_Block_Text"), void this.trigger(_.Player.Error, t)
          }
          ...
          this._isLoadedHls && "undefined" != typeof Hls ? i(this, e) : (this.trigger(_.Private.H5_Loading_Show), function (e, t, i) {
            var r = "aliplayer-hls-min.js";
            t && (r = "aliplayer-hls.js");
            var n = "https://" + p.domain + "/de/prismplayer/" + p.h5Version + "/hls/" + r;
            p.domain ? -1 < p.domain.indexOf("g-assets.daily") ? n = "http://" + p.domain + "/de/prismplayer/" + p.h5Version + "/hls/" + r : -1 < p.domain.indexOf("localhost") && (n = "http://" + p.domain + "/build/hls/" + r) : n = "de/prismplayer/" + p.h5Version + "/hls/" + r;
            var o = this;
            d.loadJS(n, function () {
              e.apply(o)
            })
        ...
        var c = function (u, e) {
          e.on(Hls.Events.ERROR, function (e, t) {
            if (u._options && t.details != Hls.ErrorDetails.FRAG_LOOP_LOADING_ERROR && 1 != u._seeking && (0 != t.fatal || t.type == Hls.ErrorTypes.NETWORK_ERROR)) {
              u._clearTimeout();
              ...
              if (t.details == Hls.ErrorDetails.MANIFEST_LOAD_ERROR) {
                n = !0;
                t.networkDetails;
                t.response ? "404" == t.response.code ? (i = h.ErrorCode.NotFoundSourceURL, r = g.get("Error_Not_Found")) : "403" == t.response.code ? (i = h.ErrorCode.AuthKeyExpired, r = g.get("Error_AuthKey_Text")) : "0" == t.response.code && navigator.onLine ? (i = h.ErrorCode.RequestDataError, r = r + "\uff0c" + g.get("Maybe_Cors_Error")) : r = g.get("Error_Load_M3U8_Failed_Text") : r = g.get("Error_Load_M3U8_Failed_Text")
              } else t.details == Hls.ErrorDetails.MANIFEST_LOAD_TIMEOUT ? (n = !0, r = g.get("Error_Load_M3U8_Timeout_Text")) : t.details == Hls.ErrorDetails.MANIFEST_PARSING_ERROR || t.details == Hls.ErrorDetails.MANIFEST_INCOMPATIBLE_CODECS_ERROR ? (n = !0, r = g.get("Error_M3U8_Decode_Text")) : t.type == Hls.ErrorTypes.NETWORK_ERROR ? (i = h.ErrorCode.NetworkError, r = g.get("Error_Network_Text")) : t.type != Hls.ErrorTypes.MUX_ERROR && t.type != Hls.ErrorTypes.MEDIA_ERROR || (i = h.ErrorCode.PlayDataDecode, r = g.get("Error_TX_Decode_Text"));
              r = r + "(" + t.details + ")";
              var o = function () {
                if (u.pause(), setTimeout(function () {
                    u.trigger(_.Private.Play_Btn_Hide)
                  }), u.checkOnline()) {
                  var e = {
                    mediaId: u._options.vid ? u._options.vid : "",
                    error_code: i,
                    error_msg: t.details
                  };
                  u.logError(e), e.display_msg = r, u.trigger(_.Player.Error, e)
                }
              };
              if (u._options && u._options.isLive) {
                var a = u._options;
                if (a.liveRetry > u._liveRetryCount) {
                  0 == u._liveRetryCount && u.trigger(_.Player.OnM3u8Retry);
                  var s = a.liveRetryInterval + a.liveRetryStep * u._liveRetryCount;
                  u._liveRetryCount++, f.sleep(1e3 * s), n && u._loadByUrlInner(u._options.source, 0, !0)
                } else u.trigger(_.Player.LiveStreamStop), u._liveErrorHandle = setTimeout(o, 500)
              } else {
                if (!u._vodRetryCount && navigator.onLine) {
                  var l = u.getCurrentTime();
                  return u._loadByUrlInner(u._options.source, l, !0), void(u._vodRetryCount = 1)
                }
                o()
              }
            }
    ...
    var l = e("../../lib/io"),
      ...
      f = function (e, r, n) {
        ...
        l.post(a, s, function (e) {
          ...
          } else n && n(p.createError("MPS\u83b7\u53d6License\u5931\u8d25"))
        }, function (e) {
          if (n) {
            var t = {
              Code: "",
      ...
      return l._options.vid && (l.__vid = l._options.vid),
        function (e, i) {
          ...
          if (r) {
            ...
            if (r.encryptionType == c.EncryptionType.Widevine) n.data = u.encode(e.message);
            else if (r.encryptionType == c.EncryptionType.PlayReady) {
              var o = u.unpackPlayReady(e.message);
  ...
  82: [function (e, t, i) {
    ...
    t.exports.getDataByAuthInfo = function (e, a, s, l) {
      ...
      var t = c.randomUUID(),
        ...
        n = "https://mts." + e.domainRegion + ".aliyuncs.com/?" + r;
      o.get(n, function (e) {
        if (e) {
          var t = JSON.parse(e),
          ...
          var o = function (e, t) {
            ...
            return 0 < n.length ? (f(n, t), n) : 0 < r.length ? (y(r, t), r) : 0 < i.length ? (y(i, t), i) : (y(o, t), o)
          }(i, a);
          s && s({
  ...
  84: [function (e, t, i) {
    var c = e("../base/player"),
      ...
      _ = c.extend({
        init: function (e, t) {
          this._authKeyExpiredHandle = new a(this), "mp3" == t.format ? (t.height = "auto", t.mediaType = "audio", c.prototype.createEl = r.prototype.createEl, r.call(this, e, t)) : (t._native = !1, c.call(this, e, t))
        }
      });
    _.prototype.loadData = function (e, t) {
    ...
    }, _.prototype._loadData = function (o, a) {
      var s = (new Date).getTime(),
        l = this;
      if (this._urls = [], this._currentPlayIndex = 0, this._retrySwitchUrlCount = 0, this._authKeyExpiredHandle.clearTick(), "" != o.format && "m3u8" != o.format || 1 != this._options.encryptType) o.rand = n.randomUUID();
      else {
        var u = _sce_r_skjhfnck();
        o.rand = _sce_lgtcaygl(u)
      }
      this.trigger(g.Private.H5_Loading_Show), this.service.getDataByAuthInfo(o, this._options.qualitySort, function (e) {
        if (l.log("COMPLETEFETCHDATA", {
          ...
          Message: y.get("Error_Vod_URL_Is_Empty_Text") + (o.format ? "(format:" + o.format + ")" : "")
        }, "");
        else {
          l.log("COMPLETEFETCHDATA", {
            cost: (new Date).getTime() - s,
            mi: JSON.stringify(e.urls)
          }), l._urls = e.urls, l._currentPlayIndex = v.findSelectedStreamLevel(l._urls, o.defaultDefinition);
          var t = e.urls[l._currentPlayIndex],
            i = t.Url;
          if (l._options.source = i, l.encType = "", l.trigger(g.Private.PREPARE, t.definition), l.UI.cover && e.coverUrl && !l._options.cover && l.setCover(e.coverUrl), v.isHls(i)) {
            var r = "";
            if (t.encryptionType == d.EncryptionType.Private) {
              l.encType = t.encryptionType;
              var n = v.checkSecuritSupport();
              if (n) return void l._mtsError_message(l, {
            ...
            p.inject(l, _, c, l._options, r)
          } else v.isFlv(i) ? h.inject(l, _, c, l._options) : v.isDash(i) ? f.inject(l, _, c, l._options) : l._player._executeReadyCallback();
          l._authKeyExpiredHandle.tick(d.AuthKeyRefreshExpired), l.trigger(g.Private.SourceLoaded, t), l.initPlay(a), l.trigger(g.Private.ChangeURL), e.thumbnailUrl && l._thumbnailService.get(e.thumbnailUrl)
        }
      }, function (e) {
        l._mtsError_message(l, e, "")
      })
    }, _.prototype._changeStream = function (e, t) {
      this._urls.length > e && (this.loadByUrl(this._urls[e].Url, this.getCurrentTime()), this._currentPlayIndex = e, this.trigger(g.Private.QualityChange, t || y.get("Quality_Change_Fail_Switch_Text")))
    }, _.prototype._getLowerQualityLevel = function () {
      ...
      t.sri && (l.sri = t.sri), r.logError(l), l.display_msg = a || y.get("Error_Vod_Fetch_Urls_Text"), r.trigger("error", l), console.log("PrismPlayer Error: " + i + "! error_msg :" + o + ";")
    }, t.exports = _
  }, {
    "../../config": 11,
    "../../lang/index": 17,
  ...
  85: [function (e, c, t) {
    ...
    c.exports.randomUUID = function () {
      ...
      var o = r.sort(),
        ...
        s = o.length;
      for (n = 0; n < s; n++) {
        var l = c.exports.AliyunEncodeURI(o[n]),
          u = c.exports.AliyunEncodeURI(e[o[n]]);
        "" == a ? a = l + t + u : a += i + l + t + u
      }
      return a
    }, c.exports.makeChangeSiga = function (e, t, i) {
      if (!e) throw new Error("PrismPlayer Error: vid should not be null!");
      return i || (i = "GET"), n.stringify(r(i + "&" + c.exports.AliyunEncodeURI("/") + "&" + c.exports.AliyunEncodeURI(c.exports.makeUTF8sort(e, "=", "&")), t + "&"))
  ...
  88: [function (e, t, i) {
    ...
    t.exports.getDataByAuthInfo = function (e, o, a, s) {
      ...
      e.authInfo && (i.AuthInfo = e.authInfo), e.outputType && (i.OutputType = e.outputType), e.playConfig && (i.PlayConfig = e.playConfig), e.reAuthInfo && (i.ReAuthInfo = e.reAuthInfo);
      ...
      l.get(n, function (e) {
        if (e) {
          ...
          var n = function (e, t) {
            for (var i = [], r = [], n = [], o = [], a = e.length - 1; 0 <= a; a--) {
              var s = e[a],
                l = (c = void 0, (c = {}).width = (u = s).Width, c.height = u.Height, c.definition = u.Definition, c.Url = u.PlayURL, c.format = u.Format, c.desc = p.QualityLevels[c.definition], c.encryptionType = p.VodEncryptionType[u.EncryptType], c.plaintext = u.Plaintext, c.rand = u.Rand, c.encrypt = u.Encrypt, c);
  ...
  89: [function (e, t, i) {
    var r = e("./saasplayer"),
      ...
      n = e("./vod"),
      u = e("./signature"),
      o = (e("./authkeyexpiredhandle"), e("./ststoken"), r.extend({
        init: function (e, t) {
    ...
    o.prototype.loadByVod = function (e) {
      var t = "",
        ...
        n = "",
        o = "";
      if (this._options.accessKeyId && this._options.accessKeySecret) t = this._options.accessKeyId, i = this._options.accessKeySecret, r = this._options.securityToken, n = this._options.region, this.log("STARTFETCHDATA", JSON.stringify({
        it: "sts",
        pa: {
          vid: this._options.vid
        }
        ...
        try {
          ...
          t = a.AccessKeyId, i = a.AccessKeySecret, r = a.SecurityToken, n = a.Region, o = a.AuthInfo
        } catch (e) {
          var s = {
    ...
    }, o.prototype._loadByVodBySTS = function (e, t, i, r, n, o) {
      var a = {
        vid: this._options.vid,
        accessId: e,
        accessSecret: t,
  ...
  90: [function (e, t, i) {
    ...
    }, a.prototype._startQueryAiSetting = function (e, u, c) {
      var t, d = this._player._options.ai;
      if (d.boxes) return (t = this)._aiSetting = t._player._options.ai.boxes, void(c && (c(), c = null));
      var p = this,
        i = o.parseUrl(e),
        h = i.segments,
        f = i.hostname,
        y = function () {
          p._queryStartDate = p._queryStartDate || u;
          ...
          g.log(JSON.stringify(n)), g.log(d.metaQueryUrl);
          var a, s, l;
          a = function (e) {
            if (g.log(e), e) {
              if (c && (c(), c = null), void 0 === e.Code && (e = JSON.parse(e)), !e.Code && e.Content) {
            ...
            o()
          }, "function" == typeof (l = d.meta).getMeta ? l.getMeta(n, a, s) : v.post(l.url, JSON.stringify(n), a, s)
        };
      y()
    ...
    "../../lib/url": 39,
    "../../lib/util": 40,
    "../../ui/component/ai/aicontainer": 101,
    "../../ui/component/ai/rect": 102,
    "../base/event/eventtype": 48
  }],
  91: [function (e, t, i) {
  ...
  92: [function (e, t, i) {
    ...
    a.prototype._adaptiveCueStype = function () {
      ...
      for (var t = [this._defaultTrack], i = l.get(u.SelectedCC), r = "", n = !1, o = 0; o < e; o++) {
    ...
    r.prototype.validate = function () {
      ...
      if (a.isHls(r)) t = r;
        ...
        var n = this._player._superType,
          o = this._player._Type;
        return this._player._options._autoplay = !0, l.inject(this._player, o, n, this._player._options, "", !0), i
      }
      return t
            ...
            if (0 < o) {
              for (var t = 0; t < u.progressMarkers.length; t++) {
                ...
                if (void 0 !== i.offset && "" !== i.offset) {
                  ...
                  var n = u.progressMarkers[t].offset / o;
                  r.style.left = 100 * n + "%", e.appendChild(r);
                  var a = function (e, t) {
                    return function () {
    ...
    var r = e("../lib/oo"),
      ...
      p = r.extend({
        init: function (e, t) {
          ...
          var r = e.id;
          "function" == typeof e.id && (r = e.id()), this._id = r + "_component_" + n.guid(), this._children = [], this._childIndex = {}, this._player.on(c.Private.UiH5Ready, function () {
    ...
    var r = e("../../component"),
      ...
      n = (e("../../../lib/event"), r.extend({
        ...
        updateLayout: function (e) {
          this._tid = e.tid;
          var t, i, r = this.el(),
            n = (s.getTransformName(r), document.querySelector("#" + this.id() + " .prism-ai-rect"));
          ...
          var o = this.updateLabels(e.attrs),
            a = document.querySelector("#" + this.id() + " .prism-ai-title");
          o ? (o = o, l.log("tid=" + e.tid + "|xmax=" + e.xmax + "|xmin=" + e.xmin + "|ymax=" + e.ymax + "|ymin=" + e.ymin), this.updateTitle(o), s.css(a, "display", "block")) : s.css(a, "display", "none")
        },
        ...
        updateLabels: function (e) {
          if (!e || 0 != e.length) {
            ...
            if (document.querySelector("#" + this.id() + " .prism-ai-labels").innerHTML = t.text, t.classValue) {
              var i = document.querySelector("#" + this.id() + " .prism-ai-rect-region");
              s.addClass(i, t.classValue)
            }
            return t.title
          }
        },
        ...
        hide: function () {
          s.css(this.el(), "opacity", "0")
        },
        show: function () {
          s.css(this.el(), "opacity", "1")
        },
        reset: function () {
      ...
      o = function (n, o) {
        if (o.displayAttrs, !n || 0 == n.length) return "";
        for (var a = [], s = "", l = "", u = 0; u < n.length; u++) Object.keys(n[u]).forEach(function (e) {
          var t = n[u][e],
            i = o.displayAttrs[e],
            r = o.getClass;
          !l && r && "function" == typeof r && (l = r(n[u], n)), e == o.displayAttrs.header ? s = t : "function" == typeof i ? a.push('<a href="javascript:void(0);" class="prism-ai-clickable" data-value=' + t + ">" + e + "</a>") : "text" == i && a.push("<p>" + t + "</p>")
        });
        return {
          text: a = a.join(""),
          title: s,
        ...
        bindEvent: function () {
          ...
          o.on(this.el(), "mouseover", function () {
            ...
            if (t._player.paused()) {
              ...
              (t._player.getDuration() <= e || t._player._ended) && t._player.seek(0), t._player.play(!0)
        ...
        _show: function (e, t) {
          ...
          if (o) {
            if (t && this._player._options.diagnosisButtonVisible) {
              t.vu ? n = decodeURIComponent(t.vu) : f.css(o, "display", "none");
              var a = "http://player.alicdn.com/detection.html?from=h5&vid=" + r + "&source=" + (n ? encodeURIComponent(n) : "") + "&uuid=" + t.uuid + "&lang=" + y.getCurrentLanguage();
              o && (o.href = a)
      ...
      s = r.extend({
        ...
        bindEvent: function () {
          ...
          this._player.on(n.Player.Play, function () {
            ...
            if (t._player.paused()) {
              var e = t._player.getCurrentTime();
              (t._player.getDuration() <= e || t._player._ended) && t._player.seek(0), t._player.play(!0), t.addClass("playing")
      ...
      p = r.extend({
        ...
        bindEvent: function () {
          ...
          // u.domain ? -1 < u.domain.indexOf("localhost") && (r = "//" + u.domain + "/build/skins/default/img/dragcursor.png") : r = "de/prismplayer/" + u.h5Version + "/skins/default/img/dragcursor.png",
           i.src = r, n.on(this.cursorNode, "mousedown", function (e) {
            t._onMouseDown(e)
          }), n.on(this.cursorNode, "touchstart", function (e) {
            t._onMouseDown(e)
        ...
        _onMouseClick: function (e) {
          ...
          if (t._canSeekable(i)) {
            ...
            this._mouseClickTimeHandle && clearTimeout(this._mouseClickTimeHandle), this._mouseClickTimeHandle = setTimeout(function () {
              ...
              }), t._player._hls && (t._player.pause(), t._player._hls.startLoad(i)), t._player.seek(i), t._player.trigger(d.Private.EndStart, {
                toTime: i
        ...
        _onTimeupdate: function (e) {
          this._inWaitingSeek || this._player._seeking || (this._updateProgressBar(this.playedNode, this._player.getCurrentTime()), this._updateCursorPosition(this._player.getCurrentTime()), this._player.trigger(d.Private.UpdateProgressBar, {
        ...
        _updateCursorPosition: function (e) {
          ...
          if (1 != this._player._switchSourcing && t) {
            var i = 1,
              ...
              n = 10 / r,
              o = e / t - n;
            0 != r && (i = 1 - n), o = o < 0 ? 0 : o, this.cursorNode && (i < o ? (a.css(this.cursorNode, "right", "0px"), a.css(this.cursorNode, "left", "auto")) : (a.css(this.cursorNode, "right", "auto"), a.css(this.cursorNode, "left", 100 * o + "%")))
          }
        },
        disposeUI: function () {
        ...
        bindEvent: function () {
          ...
          r._player.on(a.Private.MarkerTextShow, function (e) {
            ...
            if (r._player.trigger(i, e.paramData), t.progressMarker.isCustomized) r._player.trigger(a.Private.LifeCycleChanged, {
              ...
              r._thumbnailShowHanlde && (n.css(r.el(), "display", "none"), clearTimeout(r._thumbnailShowHanlde)), r._thumbnailShowHanlde = setTimeout(function () {
                if (document.querySelector("#" + r.id() + " p").innerText = t.progressMarker.text || "", t) {
                  n.css(r.el(), "display", "block");
                  var e = r._player.el().offsetWidth;
                  left = e * t.left, width = r.el().offsetWidth, left + width > e ? (n.css(r.el(), "right", "0px"), n.css(r.el(), "left", "auto")) : (left -= width / 2, left = left < 0 ? 0 : left, n.css(r.el(), "right", "auto"), n.css(r.el(), "left", left + "px"))
                }
              }, 30)
            }
            ...
            r._player.trigger(a.Player.MarkerDotOut), r._player.trigger(a.Private.LifeCycleChanged, {
              ...
              data: ""
            }), r._thumbnailShowHanlde && clearTimeout(r._thumbnailShowHanlde), n.css(r.el(), "display", "none")
          ...
          if (0 < t.length) {
            ...
            s.each(t, function (e, t) {
              if (e.desc) {
                ...
                t == n && (l.addClass(i, "current"), a._previousSelection = i), r.innerText = e.desc, i.appendChild(r), o.appendChild(i)
              }
            })
          }
          ...
          if (this._player._switchSourcing = !0, this._isMasterLevel) {
            ...
            for (var i = this._player._urls.length, r = this._player._currentPlayIndex, n = -1, o = 0; o < i; o++)
              if (this._player._urls[o].Url == e) {
                n = this._player._currentPlayIndex = o, u.set(c.SelectedStreamLevel, this._player._urls[o].definition, 365);
                break
              }
            if (r != n && -1 < n) {
      ...
      c = r.extend({
        ...
        bindEvent: function () {
          ...
          this._player.on(u.Private.CCStateChanged, function (e) {
            ...
            var r = "Off";
            "on" == t && (r = n._backCCText), n._player.trigger(u.Private.SelectorUpdateList, {
              type: "cc",
              text: r
            })
          })
      ...
      n = (e("../../../player/base/event/eventtype"), r.extend({
        ...
        generateList: function () {
          ...
          a.each(e, function (e, t) {
            ...
            r.innerText = e.text, e.text == u.get("Speed_1X_Text") && (s.addClass(i, "current"), o._previousSelection = i), i.appendChild(r), n.appendChild(i)
          })
        },
        execute: function (e) {
  ...
  125: [function (e, t, i) {
    var r = e("../component"),
      ...
      f = e("../../lib/util"),
      o = e("../../lang/index"),
      y = e("../../player/base/event/eventtype"),
      a = e("./util"),
      s = r.extend({
        init: function (e, t) {
        ...
        bindEvent: function () {
          ...
          this._player.on(y.Private.Snapshot_Hide, function () {
            ...
            h.trigger(y.Player.Snapshoting);
            ...
            "vertical" == s ? (a.translate(0, e.height), a.scale(1, -1)) : "horizon" == s && (a.translate(e.width, 0), a.scale(-1, 1)), a.drawImage(t, 0, 0, i, r), a.restore(), v(a, h._player.getOptions());
            var l = "",
              u = "";
            try {
            ...
            var c = "",
              d = "",
              p = "";
            l && (d = (c = l).substr(c.indexOf(",") + 1), p = f.toBinary(d)), h.trigger(y.Player.Snapshoted, {
              time: o,
              base64: c,
              binary: p,
              error: u
              ...
              if (e.innerText = t.formatTime, t) {
                ...
                if (i)
                  if (i.isBig) {
                    ...
                    var n = -1 * i.x + "px " + -1 * i.y + "px";
                    c.css(u.el(), "background-position", n)
                  } else {
                    var o = document.querySelector("#" + u.id() + " img");
                    r = u._player._thumbnailService.makeUrl(i.text), o.src != r && (o.src = r)
                  }
    ...
    var r = e("../component"),
      ...
      s = (e("./util"), e("../../lang/index"), r.extend({
        ...
        _getPosition: function (e) {
          ...
          return r < o - i && (o = e.clientY), (r - (o - i) + n) / (r = this.volumnRange.offsetHeight)
        },
        _offEvent: function () {
  ...
  132: [function (e, t, i) {
    ...
    "./component/big-play-button": 103,
    "./component/cc-button": 104,
    "./component/controlbar": 105,
    "./component/error-display": 107,
    "./component/fullscreen-button": 108,
    "./component/h5-loading": 109,
    "./component/info-display": 110,
    "./component/live-display": 111,
    "./component/play-button": 113,
    "./component/progress": 114,
    "./component/setting/button": 118,
    "./component/snapshot": 125,
    "./component/thumbnail": 126,
    "./component/time-display": 127,
    "./component/tooltip": 128,
