define([
  ...
  (s.transform = function(n, e, a) {
    ...
    (s.ORIGIN_XY_PLANE = a.freezeObject(new s(o.Cartesian3.UNIT_Z, 0))),
    (s.ORIGIN_YZ_PLANE = a.freezeObject(new s(o.Cartesian3.UNIT_X, 0))),
    (s.ORIGIN_ZX_PLANE = a.freezeObject(new s(o.Cartesian3.UNIT_Y, 0))),
    (n.Plane = s);
});
