define([
...
], function(e, v, t, G, u, r, P, k, C, w, b, A, c) {
  'use strict';
  function m(e, t, r) {
    (e = G.defaultValue(e, 0)),
      (t = G.defaultValue(t, 0)),
      (r = G.defaultValue(r, 0)),
  ...
  function h(e) {
        ...
        for (var t = e.length, r = 0; r < t; ++r) {
          ...
          v.defined(n.geometry)
            ...
            : v.defined(n.westHemisphereGeometry) &&
              ...
              (x(n.westHemisphereGeometry, r), x(n.eastHemisphereGeometry, r));
        }
      })(n),
      s)
    )
    ...
    for (f = c.length, t = 0; t < f; ++t) {
      ...
      if (a)
        for (m in l)
          l.hasOwnProperty(m) &&
            l[m].componentDatatype === k.ComponentDatatype.DOUBLE &&
            b.GeometryPipeline.encodeAttribute(r, m, m + '3DHigh', m + '3DLow');
      else
        for (m in l)
          if (l.hasOwnProperty(m) && l[m].componentDatatype === k.ComponentDatatype.DOUBLE) {
            var h = m + '3D',
              g = m + '2D';
            b.GeometryPipeline.projectTo2D(r, m, h, g, i),
              v.defined(r.boundingSphere) &&
                'position' === m &&
                (r.boundingSphereCV = P.BoundingSphere.fromVertices(
                  r.attributes.position2D.values
                )),
              b.GeometryPipeline.encodeAttribute(r, h, h + 'High', h + 'Low'),
  ...
  r.defineProperties(m.prototype, {
    componentDatatype: {
      get: function() {
  ...
  (l.combineGeometry = function(e) {
      ...
      (0 < (t = h(e)).length &&
        ...
        e.createPickOffsets &&
          (n = (function(e, t) {
            ...
            return (
              g(e, 'geometry', t, r),
              g(e, 'westHemisphereGeometry', t, r),
              g(e, 'eastHemisphereGeometry', t, r),
              r
            );
          })(o, t))),
      v.defined(o[0].attributes) &&
        v.defined(o[0].attributes.offset) &&
        ((i = new Array(a)), (s = !0)));
    for (var d = new Array(a), p = new Array(a), f = 0; f < a; ++f) {
      var u = o[f],
        c = u.geometry;
      v.defined(c) &&
        ((d[f] = c.boundingSphere),
        (p[f] = c.boundingSphereCV),
        s && (i[f] = u.geometry.offsetAttribute));
      var m = u.eastHemisphereGeometry,
        l = u.westHemisphereGeometry;
      v.defined(m) &&
        v.defined(l) &&
        (v.defined(m.boundingSphere) &&
          v.defined(l.boundingSphere) &&
          (d[f] = P.BoundingSphere.union(m.boundingSphere, l.boundingSphere)),
        v.defined(m.boundingSphereCV) &&
          v.defined(l.boundingSphereCV) &&
          (p[f] = P.BoundingSphere.union(m.boundingSphereCV, l.boundingSphereCV)));
    }
    return {
      geometries: t,
    ...
    (l.packCreateGeometryResults = function(e, t) {
      ...
      for (var s = 0; s < o; s++) {
        ...
        if (((r[a++] = p ? 1 : 0), p)) {
          (r[a++] = d.primitiveType),
            (r[a++] = d.geometryType),
            (r[a++] = G.defaultValue(d.offsetAttribute, -1));
          ...
          for (var l in c)
            c.hasOwnProperty(l) &&
              v.defined(c[l]) &&
              (m.push(l), v.defined(i[l]) || ((i[l] = n.length), n.push(l)));
          r[a++] = m.length;
    ...
    (l.unpackCreateGeometryResults = function(e) {
      for (
        ...
        if (1 === n[a++]) {
          ...
          if (0 < (p = n[a++])) {
            var S = f.length / u;
            for (h = A.IndexDatatype.createTypedArray(S, p), t = 0; t < p; t++) h[t] = n[a++];
          }
          i[o++] = new C.Geometry({
            primitiveType: c,
            geometryType: m,
    ...
    (l.unpackCombineGeometryParameters = function(e) {
      for (
        ...
        for (var a = l.unpackCreateGeometryResults(r[o]), s = a.length, d = 0; d < s; d++) {
          var p = a[d];
          (t[i].geometry = p), ++i;
        }
    ...
    (l.unpackCombineGeometryResults = function(e) {
      return {
        ...
        pickOffsets: e.pickOffsets,
        offsetInstanceExtend: e.offsetInstanceExtend,
        boundingSpheres: n(e.boundingSpheres),
        boundingSpheresCV: n(e.boundingSpheresCV),
      };
    }),
    (e.PrimitivePipeline = l);
});
