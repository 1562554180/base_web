...
], function(o, e, t, i, c, r, d, n, a, p, s, y, u, l, m, f, b, g, h, P, G, v, L, T, C, E, H, k) {
  'use strict';
  function w(e) {
    for (
      var t = e.length,
        r = new Float64Array(3 * t),
        n = b.IndexDatatype.createTypedArray(t, 2 * t),
        a = 0,
        o = 0,
        i = 0;
      i < t;
      ...
      var y = e[i];
      (r[a++] = y.x), (r[a++] = y.y), (r[a++] = y.z), (n[o++] = i), (n[o++] = (i + 1) % t);
    }
    var l = new u.GeometryAttributes({
    ...
    return new s.Geometry({ attributes: l, indices: n, primitiveType: s.PrimitiveType.LINES });
  }
  function A(e) {
    var t = (e = i.defaultValue(e, i.defaultValue.EMPTY_OBJECT)).polygonHierarchy;
    (this._polygonHierarchy = t),
      (this._workerName = 'createCoplanarPolygonOutlineGeometry'),
      (this.packedLength = k.PolygonGeometryLibrary.computeHierarchyPackedLength(t) + 1);
  }
  (A.fromPositions = function(e) {
    ...
    (A.pack = function(e, t, r) {
      return (
        ...
        (t[(r = k.PolygonGeometryLibrary.packPolygonHierarchy(e._polygonHierarchy, t, r))] =
          e.packedLength),
        t
      );
    });
  var I = { polygonHierarchy: {} };
  return (
    (A.unpack = function(e, t, r) {
      t = i.defaultValue(t, 0);
      var n = k.PolygonGeometryLibrary.unpackPolygonHierarchy(e, t);
      (t = n.startingIndex), delete n.startingIndex;
      var a = e[t];
      return o.defined(r) || (r = new A(I)), (r._polygonHierarchy = n), (r.packedLength = a), r;
    }),
    (A.createGeometry = function(e) {
      var t = e._polygonHierarchy,
        r = t.positions;
      if (
        !((r = G.arrayRemoveDuplicates(r, c.Cartesian3.equalsEpsilon, !0)).length < 3) &&
        T.CoplanarPolygonGeometryLibrary.validOutline(r)
      ) {
        var n = k.PolygonGeometryLibrary.polygonOutlinesFromHierarchy(t, !1);
        if (0 !== n.length) {
          for (var a = [], o = 0; o < n.length; o++) {
            var i = new P.GeometryInstance({ geometry: w(n[o]) });
            a.push(i);
          }
          var y = m.GeometryPipeline.combineInstances(a)[0],
            l = d.BoundingSphere.fromPoints(t.positions);
