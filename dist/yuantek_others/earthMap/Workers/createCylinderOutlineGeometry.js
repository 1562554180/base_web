...
], function(h, e, t, f, v, i, A, r, a, O, R, n, G, V, L, g) {
  'use strict';
  var C = new v.Cartesian2();
  function d(e) {
    var t = (e = f.defaultValue(e, f.defaultValue.EMPTY_OBJECT)).length,
      i = e.topRadius,
      r = e.bottomRadius,
      a = f.defaultValue(e.slices, 128),
      n = Math.max(f.defaultValue(e.numberOfVerticalLines, 16), 0);
    (this._length = t),
      (this._topRadius = i),
  ...
  return (
    (d.unpack = function(e, t, i) {
      ...
      return h.defined(i)
        ...
        : ((l.length = r),
          ...
          (l.bottomRadius = n),
          (l.slices = o),
          (l.numberOfVerticalLines = u),
          (l.offsetAttribute = -1 === s ? void 0 : s),
          new d(l));
    }),
    (d.createGeometry = function(e) {
      ...
      if (!(t <= 0 || i < 0 || r < 0 || (0 === i && 0 === r))) {
        var o,
          u = 2 * a,
          s = g.CylinderGeometryLibrary.computePositions(t, i, r, a, !1),
          f = 2 * a;
        if (0 < n) {
          var d = Math.min(n, a);
        ...
        var l,
          b = V.IndexDatatype.createTypedArray(u, 2 * f),
          m = 0;
        for (l = 0; l < a - 1; l++)
          (b[m++] = l), (b[m++] = l + 1), (b[m++] = l + a), (b[m++] = l + 1 + a);
        if (((b[m++] = a - 1), (b[m++] = 0), (b[m++] = a + a - 1), (b[m++] = a), 0 < n))
          for (l = 0; l < a; l += o) (b[m++] = l), (b[m++] = l + a);
        var c = new G.GeometryAttributes();
        (c.position = new R.GeometryAttribute({
          ...
          (C.x = 0.5 * t),
          (C.y = Math.max(r, i));
        var p = new A.BoundingSphere(v.Cartesian3.ZERO, v.Cartesian2.magnitude(C));
        if (h.defined(e._offsetAttribute)) {
          t = s.length;
          var y = new Uint8Array(t / 3),
            _ = e._offsetAttribute === L.GeometryOffsetAttribute.NONE ? 0 : 1;
          L.arrayFill(y, _),
    ...
    function(e, t) {
      return h.defined(t) && (e = d.unpack(e, t)), d.createGeometry(e);
    }
  );
});
