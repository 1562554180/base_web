...
], function(n, e, t, o, p, r, c, a, i, y, s, m, f, u) {
  'use strict';
  function d(e) {
    e = o.defaultValue(e, o.defaultValue.EMPTY_OBJECT);
    var t = o.defaultValue(e.vertexFormat, u.VertexFormat.DEFAULT);
    (this._vertexFormat = t), (this._workerName = 'createPlaneGeometry');
  }
  (d.packedLength = u.VertexFormat.packedLength),
    (d.pack = function(e, t, r) {
      return (r = o.defaultValue(r, 0)), u.VertexFormat.pack(e._vertexFormat, t, r), t;
    });
  var b = new u.VertexFormat(),
    l = { vertexFormat: b };
  d.unpack = function(e, t, r) {
    t = o.defaultValue(t, 0);
    var a = u.VertexFormat.unpack(e, t, b);
    return n.defined(r)
      ? ((r._vertexFormat = u.VertexFormat.clone(a, r._vertexFormat)), r)
      : new d(l);
  };
  var A = new p.Cartesian3(-0.5, -0.5, 0),
    F = new p.Cartesian3(0.5, 0.5, 0);
  return (
    (d.createGeometry = function(e) {
      ...
      return new s.Geometry({
        ...
        boundingSphere: new c.BoundingSphere(p.Cartesian3.ZERO, Math.sqrt(2)),
      });
    }),
    function(e, t) {
